let ru = {
  ...
  "Code Panel Notify": "Изменение кода непосредственно может нарушить функциональность макета или приложения. Редактировать только если вы знаете, что делаете!",
  "Clear Editor": "Чистый редактор",
  "Clear Editor Notify": "Вы уверены, что хотите очистить редактор? Весь прогресс будет потерян!",
  "Nothing to edit": "Отредактировать нечего!",
  "Shapes": "Формы",
  "Delete The Shape": "Удалить форму",
  "Add shapes": "Добавьте формы между макетами и настройте!",
  "Preview unavailable": "Предварительный просмотр компонента недоступен для компонента",
