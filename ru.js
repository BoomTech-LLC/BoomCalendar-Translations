let ru = {
  ...
  "You can move your mouse outside the seatmap while dragging - the selection will still apply when you release.": "Вы можете перемещать курсор мыши за пределы области схемы рассадки во время перетаскивания — выделенная область сохранит свои значения после того, как вы отпустите кнопку мыши.",
  "Tip:": "Кончик:",
  "Use the +/- buttons to zoom in and out": "Используйте кнопки +/- для увеличения и уменьшения масштаба.",
  "Click and drag the background to pan around the venue": "Перетащите фон, чтобы перемещаться по залу.",
  "Pan & Zoom": "Панорамирование и масштабирование",
  "Capacity is shared across all seatmaps for the same event": "Вместимость распределяется между всеми местами на одном и том же мероприятии.",
  "Use the - button to remove tickets from your selection": "Используйте кнопку «-», чтобы удалить билеты из вашей подборки.",
  "Use the + button to add tickets to your selection": "Используйте кнопку «+», чтобы добавить билеты в свой выбор.",
  "Standing areas show the number of tickets remaining": "На местах для стоячих мест отображается количество оставшихся билетов.",
  "Standing Areas": "Места для стояния",
  "Remove keyboard focus from seats": "Уберите фокус клавиатуры с сидений.",
  "Clear Focus": "Четкая фокусировка",
  "Toggle the focused seat": "Переключить выделенное место",
  "Select / Deselect Seat": "Выбрать/Отменить выбор места",
  "Move between available seats": "Перемещайтесь между свободными местами",
  "Navigate Seats": "Перемещение по сиденьям",
  "Use your keyboard to navigate and select seats without a mouse:": "Используйте клавиатуру для навигации и выбора мест без мыши:",
  "Keyboard Navigation": "Навигация с помощью клавиатуры",
  "Click an empty area to deselect all seats": "Щелкните по пустому месту, чтобы снять выделение со всех мест.",
  "Drag across multiple seats to toggle-select them": "Перетащите курсор по нескольким сиденьям, чтобы выбрать их.",
  "Click a selected seat again to deselect it": "Чтобы снять выделение с выбранного места, щелкните по нему еще раз.",
  "Click a seat to select it": "Нажмите на место, чтобы выбрать его.",
  "Selecting Seats": "Выбор мест",
  "How to Select Seats": "Как выбрать места",
  "How to Use": "Как использовать",
  "Pay": "Платить",
  "Book": "Книга",
  "This promo code has already been used": "Этот промокод уже использован.",
  "This promo code is not yet active": "Этот промокод пока неактивен.",
  "This promo code has expired": "Срок действия этого промокода истек.",
  "Invalid promo code": "Недействительный промокод",
  "Credit / Debit Card": "Кредитная/дебетовая карта",
  "Fast & secure checkout": "Быстрая и безопасная оплата",
  "Secure payment via Wix": "Безопасная оплата через Wix",
  "Pay at the venue": "Оплата на месте проведения мероприятия.",
  "Registration": "Регистрация",
  "Attendee Information": "Информация для участников",
  "Your information is secure and will only be used for event registration": "Ваши данные защищены и будут использованы только для регистрации на мероприятие.",
  "Your information is secure and will only be used for ticket delivery": "Ваши данные защищены и будут использованы только для доставки билетов.",
  "Register": "Регистрация",
  "Event is fully booked": "Все места на мероприятие забронированы.",
  "To Event": "К мероприятию",
  "Guest Details": "Информация о госте",
  "Because it was a Draft": "Потому что это был черновик",
  "You can't see your event": "Вы не можете увидеть своё мероприятие.",
  "The event is currently happening. If you believe this is an error, please contact the event organizer.": "Мероприятие в данный момент проходит. Если вы считаете, что это ошибка, пожалуйста, свяжитесь с организатором мероприятия.",
  "Registration is closed because this event has already started.": "Регистрация закрыта, так как мероприятие уже началось.",
  "Event In Progress": "Мероприятие в процессе",
  "The event organizer is still preparing this event. Please check back later or contact the organizer for more information.": "Организатор мероприятия всё ещё находится в процессе подготовки. Пожалуйста, зайдите позже или свяжитесь с организатором для получения дополнительной информации.",
  "Event": "Событие",
  "This event is currently in draft mode and not available for registration yet.": "В настоящее время это мероприятие находится в стадии разработки и регистрация на него еще недоступна.",
  "This event is currently in draft mode and not yet available for viewing.": "Данное мероприятие в настоящее время находится в стадии черновика и пока недоступно для просмотра.",
  "Event Not Published": "Событие не опубликовано",
  "Draft Mode": "Режим черновика",
  "Back": "Назад",
  "Go": "Идти",
  "Could not find requested resource": "Не удалось найти запрошенный ресурс.",
  ...
  "Your information is secure and will only be used for ticket delivery": "Ваши данные защищены и будут использованы только для доставки билетов.",
  "per ticket": "за билет",
  "Select tickets above to continue": "Выберите билеты выше, чтобы продолжить.",
  "Select seats above to continue": "Выберите места выше, чтобы продолжить.",
  "Select Tickets": "Выберите билеты",
  "Gallery": "Галерея",
  "Secure checkout": "Безопасная оплата",
  "About This Event": "Об этом мероприятии",
  "Available Spots": "Свободные места",
  "TICKET TYPES": "ТИПЫ БИЛЕТОВ",
  "TICKET TYPE": "ТИП БИЛЕТА",
  "Sync": "Синхронизация",
  "Connected": "Подключено",
  "Removes the connection to your Google account. Previously imported events will remain on your calendar.": "Удаляет привязку к вашему аккаунту Google. Ранее импортированные события останутся в вашем календаре.",
  "A wider range means more events to load. If your calendar feels slow, try narrowing the range to match the view you use most (e.g. monthly view needs a shorter range than yearly).": "Более широкий диапазон означает больше событий для загрузки. Если ваш календарь работает медленно, попробуйте сузить диапазон, чтобы он соответствовал наиболее часто используемому вами режиму просмотра (например, для ежемесячного просмотра требуется более короткий диапазон, чем для годового).",
  "Sync Date Range": "Диапазон дат синхронизации",
  "Sync categories": "Категории синхронизации",
  "Hide event description": "Скрыть описание события",
  "Hide private events": "Скрыть личные события",
  "No synchronized calendars yet. Select a calendar above and click Sync to start.": "Пока нет синхронизированных календарей. Выберите календарь выше и нажмите «Синхронизировать», чтобы начать.",
  "Fetches current events so you can add them one by one.": "Получает информацию о текущих событиях, чтобы вы могли добавлять их по одному.",
  "Keeps events continuously updated in real time.": "Обеспечивает непрерывное обновление информации о событиях в режиме реального времени.",
  ...
  "Cross Event Limit": "Лимит перекрестных событий",
  "Show events limit": "Показать лимит событий",
  "Show tooltip/popup": "Показать подсказку/всплывающее окно",
  "Bold Monthly Dividers": "Жирные ежемесячные разделители",
  "Scroll to see more events": "Прокрутите, чтобы увидеть больше событий",
  "Show additional date": "Показать дополнительную дату",
  ...
  "Ticket Tailor sync allows you to integrate your events and sessions with your Boom Calendar.":
    "Синхронизация Ticket Tailor позволяет интегрировать ваши события и сеансы с календарем Boom.",
  "Show event time next to title. This setting is only applicable to the Monthly, Daily, and Weekly views.":
    "Показывать время события рядом с названием. Этот параметр применим только к представлениям «Ежемесячно», «Ежедневно» и «Еженедельно».",
  ...
  "You are about to change the details of your event. Once changed, your guest list will be lost.":
    "Вы собираетесь изменить детали вашего мероприятия. После изменения ваш список гостей будет утерян.",
  ...
  "script disappear":
    "Этого сценария не существует, пожалуйста, добавьте скрипт в свою Google Analytics!",
  "Reset Layouts Dimensions": "Сбросить макеты размеров",
  Clear: "Прозрачный",
  Undo: "Отменить",
  Redo: "Переделан",
  "Code Panel": "Кодовая панель",
  "Code Panel Notify":
    "Изменение кода непосредственно может нарушить функциональность макета или приложения. Редактировать только если вы знаете, что делаете!",
  "Clear Editor": "Чистый редактор",
  "Clear Editor Notify":
    "Вы уверены, что хотите очистить редактор? Весь прогресс будет потерян!",
  "Nothing to edit": "Отредактировать нечего!",
  Shapes: "Формы",
  "Delete The Shape": "Удалить форму",
  "Add shapes": "Добавьте формы между макетами и настройте!",
  "Preview unavailable":
    "Предварительный просмотр компонента недоступен для компонента",
  ...
  "Left Alignment": "Левое выравнивание",
  "Center Alignment": "Центральное выравнивание",
  "Right Alignment": "Правое выравнивание",
  "Text Decoration": "Текстовое украшение",
  Overline: "Обширный",
  "Line Through": "Пройти через",
  Underline: "Подчеркнуть",
  "Underline and Overline": "Подчеркнуть и обернуть",
  "Without Decoration": "Без украшения",
  Left: "Левый",
  Angle: "Угол",
  Distance: "Расстояние",
  Blur: "Размытие",
  Size: "Размер",
  "Edit individually": "Редактировать индивидуально",
  "Apply to all corners": "Применить ко всем углам",
  "Date Box Visual": "Оформление коробки с датой",
  "One Line": "Одна линия",
  "Show Icons": "Показать значки",
  ...
  "Personalize your editor to match your style and preferences, customize every detail in this settings tab !":
    "Персонализируйте свой редактор, чтобы соответствовать вашему стилю и предпочтениям, настраивайте каждую деталь на этой вкладке «Настройки»!",
  Divider: "Делитель",
  Ellipse: "Эллипс",
  Rhombus: "Ромб",
  "Heart": "Сердце",
  ...
  "Get Tickets Now": "Получить билеты сейчас",
  "Get Tickets": "Получить билеты",
  "Instant confirmation": "Мгновенное подтверждение",
  "No seats selected": "Места не выбраны",
  "No tickets available for this event.": "Билеты на это мероприятие недоступны.",
  "No tickets selected": "Билеты не выбраны",
  "Order Summary": "Сводка заказа",
  "Payment": "Оплата",
  "Please enter a valid email": "Пожалуйста, введите действительный email",
  "Please enter your name": "Пожалуйста, введите ваше имя",
  "Please select at least one seat": "Пожалуйста, выберите хотя бы одно место",
  "Register Now": "Зарегистрироваться",
  "Registration Complete": "Регистрация завершена",
  "Secure checkout": "Безопасная оплата",
  "Select Tickets": "Выбрать билеты",
  "Select Your Seats": "Выберите свои места",
  "Select seats above to continue": "Выберите места выше, чтобы продолжить",
  "Select tickets above to continue": "Выберите билеты выше, чтобы продолжить",
  ...
  "Total Amount": "Итого",
  "View your ticket": "Посмотреть ваш билет",
  "each": "каждый",
  "per ticket": "за билет",
  "seat": "место",
  "seats": "места",
