let ru = {
  ...
  "Notify the user when the registration is canceled": "Уведомить пользователя об отмене регистрации",
  "Cancellation email": "Письмо об отмене",
  "Send a reminder to the user one day prior to the event": "Отправьте напоминание пользователю за день до мероприятия",
  "Reminder email": "Напоминание по электронной почте",
  "Send an instant email to the user once registration is completed": "Отправьте мгновенное электронное письмо пользователю после завершения регистрации.",
  "Notification email": "Уведомление по электронной почте",
  "Reminder email about the event": "Напоминание по электронной почте о мероприятии",
  "Email notifications to users": "Уведомления по электронной почте для пользователей",
  "Click on the toggle buttons next to each field to add it to your registration form. If you want to make the field required, click on the asterisk (*).": "Нажмите на кнопки переключения рядом с каждым полем, чтобы добавить его в регистрационную форму. Если вы хотите сделать поле обязательным, нажмите на звездочку (*).",
  ...
  "Configure your registration form fields": "Настройте поля регистрационной формы",
  "Show guest limit": "Показать лимит гостей",
  "Enable Registration": "Включить регистрацию",
  "Click to activate registration on this event": "Нажмите, чтобы активировать регистрацию на это мероприятие",
  "Customize the general settings of registration": "Настройте общие параметры регистрации",
  "Enter URL": "Введите URL",
  "Page URL": "URL-адрес страницы",
  "Close registration when the event starts": "Закрыть регистрацию после начала мероприятия",
  ...
  "Open event registration landing page": "Открыть целевую страницу регистрации на мероприятие",
  "It must have taken you plenty of preparation to get ready for your event. Now is the time to sit back and relax till your guests gather around! As soon as a new registration is made, the information about your guest will appear here. Come back later to keep track of your event attendees.": "Должно быть, вам потребовалась серьезная подготовка к мероприятию. Сейчас самое время расслабиться и отдохнуть, пока ваши гости не соберутся вокруг! Как только будет произведена новая регистрация, здесь появится информация о вашем госте. Вернитесь позже, чтобы отслеживать участников вашего мероприятия.",
  "You have no guests at the moment.": "У вас сейчас нет гостей.",
  "List of people who are registered to your event": "Список людей, зарегистрированных на ваше мероприятие",
  ...
  "Do you really want to delete selected event? Once removed, cannot be undone": "Вы действительно хотите удалить выбранное событие? После удаления его нельзя отменить.",
  "There are no categories yet": "Категорий пока нет",
  "Making Changes to your synced calendar with the following links. Please review your changes carefully.": "Внесение изменений в синхронизированный календарь с помощью следующих ссылок. Пожалуйста, внимательно просмотрите внесенные изменения.",
  "occurrences": "явления",
