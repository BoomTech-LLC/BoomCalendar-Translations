let ru = {
  ...
  "Do you really want to delete selected user? Once removed, cannot be undone.": "Вы действительно хотите удалить выбранного пользователя? После удаления его невозможно отменить.",
  "Delete Guest": "Удалить гостя",
  "Invoice number": "Номер счета",
  "Status": "Положение дел",
  "Payment type": "Способ оплаты",
  "Select payment method to receive fees through tickets": "Выберите способ оплаты, чтобы получать комиссию через билеты",
  ...
  "Enable and configure your ticketing system": "Включите и настройте вашу систему продажи билетов",
