let th = {
  ...
  "You can move your mouse outside the seatmap while dragging - the selection will still apply when you release.": "คุณสามารถเลื่อนเมาส์ออกนอกขอบเขตของแผนผังที่นั่งขณะลากได้ การเลือกจะยังคงมีผลเมื่อคุณปล่อยเมาส์",
  "Tip:": "เคล็ดลับ:",
  "Use the +/- buttons to zoom in and out": "ใช้ปุ่ม +/- เพื่อซูมเข้าและซูมออก",
  "Click and drag the background to pan around the venue": "คลิกและลากพื้นหลังเพื่อเลื่อนดูสถานที่จัดงาน",
  "Pan & Zoom": "แพนและซูม",
  "Capacity is shared across all seatmaps for the same event": "ความจุของที่นั่งจะถูกแบ่งใช้ร่วมกันในทุกแผนผังที่นั่งสำหรับงานอีเวนต์เดียวกัน",
  "Use the - button to remove tickets from your selection": "ใช้ปุ่มลบ (-) เพื่อลบตั๋วออกจากรายการที่คุณเลือก",
  "Use the + button to add tickets to your selection": "ใช้ปุ่ม + เพื่อเพิ่มตั๋วลงในรายการที่คุณเลือก",
  "Standing areas show the number of tickets remaining": "พื้นที่ยืนชมแสดงจำนวนตั๋วที่เหลืออยู่",
  "Standing Areas": "พื้นที่ยืน",
  "Remove keyboard focus from seats": "ย้ายอุปกรณ์คีย์บอร์ดออกจากที่นั่ง",
  "Clear Focus": "โฟกัสที่ชัดเจน",
  "Toggle the focused seat": "สลับการตั้งค่าที่นั่งแบบโฟกัส",
  "Select / Deselect Seat": "เลือก/ยกเลิกการเลือกที่นั่ง",
  "Move between available seats": "สลับที่นั่งระหว่างที่นั่งว่าง",
  "Navigate Seats": "นำทางไปยังที่นั่ง",
  "Use your keyboard to navigate and select seats without a mouse:": "ใช้แป้นพิมพ์ในการเลือกที่นั่งโดยไม่ต้องใช้เมาส์:",
  "Keyboard Navigation": "การนำทางด้วยแป้นพิมพ์",
  "Click an empty area to deselect all seats": "คลิกพื้นที่ว่างเพื่อยกเลิกการเลือกที่นั่งทั้งหมด",
  "Drag across multiple seats to toggle-select them": "ลากเมาส์ข้ามที่นั่งหลายๆ ที่เพื่อเลือกสลับกัน",
  "Click a selected seat again to deselect it": "คลิกที่นั่งที่เลือกอีกครั้งเพื่อยกเลิกการเลือก",
  "Click a seat to select it": "คลิกที่ที่นั่งเพื่อเลือก",
  "Selecting Seats": "การเลือกที่นั่ง",
  "How to Select Seats": "วิธีการเลือกที่นั่ง",
  "How to Use": "วิธีการใช้งาน",
  "Pay": "จ่าย",
  "Book": "หนังสือ",
  "This promo code has already been used": "รหัสโปรโมชั่นนี้ถูกใช้ไปแล้ว",
  "This promo code is not yet active": "รหัสโปรโมชั่นนี้ยังไม่เปิดใช้งาน",
  "This promo code has expired": "รหัสโปรโมชั่นนี้หมดอายุแล้ว",
  "Invalid promo code": "รหัสโปรโมชั่นไม่ถูกต้อง",
  "Credit / Debit Card": "บัตรเครดิต/เดบิต",
  "Fast & secure checkout": "ชำระเงินรวดเร็วและปลอดภัย",
  "Secure payment via Wix": "ชำระเงินอย่างปลอดภัยผ่าน Wix",
  "Pay at the venue": "ชำระเงินที่สถานที่จัดงาน",
  "Registration": "การลงทะเบียน",
  "Attendee Information": "ข้อมูลผู้เข้าร่วมงาน",
  "Your information is secure and will only be used for event registration": "ข้อมูลของคุณจะได้รับการรักษาความปลอดภัยและจะถูกนำไปใช้เพื่อการลงทะเบียนเข้าร่วมงานเท่านั้น",
  "Your information is secure and will only be used for ticket delivery": "ข้อมูลของคุณจะได้รับการรักษาความปลอดภัยและจะถูกนำไปใช้เพื่อการจัดส่งตั๋วเท่านั้น",
  "Register": "ลงทะเบียน",
  "Event is fully booked": "กิจกรรมนี้เต็มแล้ว",
  "To Event": "ไปยังกิจกรรม",
  "Guest Details": "รายละเอียดผู้เข้าพัก",
  "Because it was a Draft": "เพราะมันเป็นร่าง",
  "You can't see your event": "คุณไม่สามารถดูอีเวนต์ของคุณได้",
  "The event is currently happening. If you believe this is an error, please contact the event organizer.": "กิจกรรมกำลังดำเนินอยู่ หากคุณคิดว่านี่เป็นข้อผิดพลาด โปรดติดต่อผู้จัดงาน",
  "Registration is closed because this event has already started.": "การลงทะเบียนปิดแล้ว เนื่องจากกิจกรรมนี้ได้เริ่มขึ้นแล้ว",
  "Event In Progress": "กิจกรรมกำลังดำเนินอยู่",
  "The event organizer is still preparing this event. Please check back later or contact the organizer for more information.": "ผู้จัดงานกำลังเตรียมงานอยู่ โปรดตรวจสอบอีกครั้งในภายหลังหรือติดต่อผู้จัดงานเพื่อขอข้อมูลเพิ่มเติม",
  "Event": "เหตุการณ์",
  "This event is currently in draft mode and not available for registration yet.": "กิจกรรมนี้ยังอยู่ในขั้นตอนร่างและยังไม่เปิดให้ลงทะเบียน",
  "This event is currently in draft mode and not yet available for viewing.": "กิจกรรมนี้อยู่ในโหมดร่างและยังไม่สามารถรับชมได้ในขณะนี้",
  "Event Not Published": "กิจกรรมยังไม่ได้รับการเผยแพร่",
  "Draft Mode": "โหมดร่าง",
  "Back": "กลับ",
  "Go": "ไป",
  "Could not find requested resource": "ไม่พบทรัพยากรที่ร้องขอ",
  "Not Found 404": "ไม่พบ 404",
  "Loading...": "กำลังโหลด...",
  "Loading": "กำลังโหลด",
  ...
  "Your information is secure and will only be used for ticket delivery": "ข้อมูลของคุณจะได้รับการรักษาความปลอดภัยและจะถูกนำไปใช้เพื่อการจัดส่งตั๋วเท่านั้น",
  "per ticket": "ต่อตั๋ว",
  "Select tickets above to continue": "เลือกตั๋วด้านบนเพื่อดำเนินการต่อ",
  "Select seats above to continue": "เลือกที่นั่งด้านบนเพื่อดำเนินการต่อ",
  "Select Tickets": "เลือกซื้อตั๋ว",
  "Gallery": "แกลเลอรี่",
  "Secure checkout": "การชำระเงินที่ปลอดภัย",
  "About This Event": "เกี่ยวกับกิจกรรมนี้",
  "Available Spots": "ตำแหน่งว่าง",
  ...
  "Sync Date Range": "ช่วงวันที่ซิงค์",
  "Sync categories": "ซิงค์หมวดหมู่",
  "Hide event description": "ซ่อนคำอธิบายกิจกรรม",
  "Hide private events": "ซ่อนกิจกรรมส่วนตัว",
  "No synchronized calendars yet. Select a calendar above and click Sync to start.": "ยังไม่มีการซิงค์ปฏิทินใดๆ เลือกปฏิทินด้านบนแล้วคลิก ซิงค์ เพื่อเริ่มต้น",
  "Fetches current events so you can add them one by one.": "ดึงข้อมูลเหตุการณ์ปัจจุบันเพื่อให้คุณสามารถเพิ่มทีละรายการได้",
  "Keeps events continuously updated in real time.": "อัปเดตเหตุการณ์อย่างต่อเนื่องแบบเรียลไทม์",
  ...
  "Cross Event Limit": "ขีดจำกัดเหตุการณ์ข้าม",
  "Show events limit": "แสดงการจำกัดกิจกรรม",
  "Show tooltip/popup": "แสดงคำแนะนำ/ป๊อปอัป",
  "Bold Monthly Dividers": "ตัวแบ่งรายเดือนที่เป็นตัวหนา",
  "Scroll to see more events": "เลื่อนเพื่อดูกิจกรรมเพิ่มเติม",
  "Show additional date": "แสดงวันที่เพิ่มเติม",
  ...
  "Ticket Tailor sync allows you to integrate your events and sessions with your Boom Calendar.":
    "การซิงค์ Ticket Tailor ช่วยให้คุณสามารถรวมกิจกรรมและเซสชันของคุณเข้ากับ Boom Calendar ของคุณได้",
  "Show event time next to title. This setting is only applicable to the Monthly, Daily, and Weekly views.":
    "แสดงเวลากิจกรรมถัดจากชื่อ การตั้งค่านี้ใช้ได้กับมุมมองรายเดือน รายวัน และรายสัปดาห์เท่านั้น",
  ...
  "You are about to change the details of your event. Once changed, your guest list will be lost.":
    "คุณกำลังจะเปลี่ยนแปลงรายละเอียดกิจกรรมของคุณ เมื่อเปลี่ยนแปลงแล้ว รายชื่อแขกของคุณจะหายไป",
  ...
  "Do you really want to delete selected user? Once removed, cannot be undone.":
    "คุณต้องการลบผู้ใช้ที่เลือกจริง ๆ หรือไม่? เมื่อลบออกแล้วไม่สามารถยกเลิกได้",
  "Delete Guest": "ลบแขก",
  "Invoice number": "เลขใบสั่งของ",
  Status: "สถานะ",
  "Payment type": "ประเภทการชำระเงิน",
  "Select payment method to receive fees through tickets":
    "เลือกวิธีการชำระเงินเพื่อรับค่าธรรมเนียมผ่านตั๋ว",
  "Add Code": "เพิ่มรหัส",
  ...
  "Enable and configure your ticketing system":
    "เปิดใช้งานและกำหนดค่าระบบตั๋วของคุณ",
  ...
  "Click on the toggle buttons next to each field to add it to your registration form. If you want to make the field required, click on the asterisk (*).":
    "คลิกที่ปุ่มสลับที่อยู่ติดกับแต่ละฟิลด์เพื่อเพิ่มลงในแบบฟอร์มลงทะเบียนของคุณ หากคุณต้องการกำหนดให้ฟิลด์ต้องระบุ ให้คลิกที่เครื่องหมายดอกจัน (*)",
  ...
  "Configure your registration form fields":
    "กำหนดค่าฟิลด์แบบฟอร์มการลงทะเบียนของคุณ",
  ...
  "Click to activate registration on this event":
    "คลิกเพื่อเปิดใช้งานการลงทะเบียนในกิจกรรมนี้",
  "Customize the general settings of registration":
    "ปรับแต่งการตั้งค่าทั่วไปของการลงทะเบียน",
  "Enter URL": "ป้อน URL",
  "Page URL": "URL ของหน้า",
  "Close registration when the event starts":
    "ปิดการลงทะเบียนเมื่อกิจกรรมเริ่มต้น",
  ...
  "Open event registration landing page":
    "เปิดหน้า Landing Page ของการลงทะเบียนกิจกรรม",
  "It must have taken you plenty of preparation to get ready for your event. Now is the time to sit back and relax till your guests gather around! As soon as a new registration is made, the information about your guest will appear here. Come back later to keep track of your event attendees.":
    "คุณจะต้องเตรียมตัวให้พร้อมสำหรับงานของคุณมากมาย ตอนนี้เป็นเวลาที่จะนั่งพักผ่อนจนกว่าแขกของคุณจะรวมตัวกัน! ทันทีที่มีการลงทะเบียนใหม่ ข้อมูลเกี่ยวกับแขกของคุณจะปรากฏที่นี่ กลับมาอีกครั้งในภายหลังเพื่อติดตามผู้เข้าร่วมกิจกรรมของคุณ",
  "You have no guests at the moment.": "คุณไม่มีแขกในขณะนี้",
  "List of people who are registered to your event":
    "รายชื่อผู้ที่ลงทะเบียนเข้าร่วมกิจกรรมของคุณ",
  "Guest List": "รายชื่อแขก",
  "This is a recurring event! Any changes made to this event, will be applied to all repetitions.":
    "นี่เป็นเหตุการณ์ที่เกิดซ้ำ! การเปลี่ยนแปลงใดๆ ที่เกิดขึ้นในกิจกรรมนี้จะมีผลกับการเกิดซ้ำทั้งหมด",
  ...
  "Do you really want to delete selected category? Once removed, cannot be undone.":
    "คุณต้องการลบหมวดหมู่ที่เลือกจริง ๆ หรือไม่? เมื่อลบออกแล้วไม่สามารถยกเลิกได้",
  OK: "ตกลง",
  Exclude: "ไม่รวม",
  ...
  "Do you really want to delete selected event? Once removed, cannot be undone":
    "คุณต้องการลบกิจกรรมที่เลือกจริง ๆ หรือไม่? เมื่อลบออกแล้วไม่สามารถยกเลิกได้",
  ...
  "Making Changes to your synced calendar with the following links. Please review your changes carefully.":
    "การเปลี่ยนแปลงปฏิทินที่ซิงค์ของคุณด้วยลิงก์ต่อไปนี้ โปรดตรวจสอบการเปลี่ยนแปลงของคุณอย่างรอบคอบ",
  ...
  "Show your Wix Bookings or Events on Calendar":
    "แสดงการจอง Wix หรือกิจกรรมของคุณในปฏิทิน",
  "Choose Auto for automatic display of all services and sessions on the calendar, or Manual for manual selection.":
    "เลือกอัตโนมัติสำหรับการแสดงผลอัตโนมัติของบริการและเซสชันทั้งหมดในปฏิทินหรือคู่มือสำหรับการเลือกด้วยตนเอง",
  ...
  "Choose Auto for automatic display of all events on the calendar, or Manual for manual selection.":
    "เลือกอัตโนมัติสำหรับการแสดงผลอัตโนมัติของกิจกรรมทั้งหมดในปฏิทินหรือคู่มือสำหรับการเลือกด้วยตนเอง",
  Auto: "รถยนต์",
  "Choose Auto for automatic display of all organizations and organizers on the calendar, or Manual for manual selection.":
    "เลือกอัตโนมัติสำหรับการแสดงอัตโนมัติขององค์กรและผู้จัดงานทั้งหมดในปฏิทินหรือคู่มือสำหรับการเลือกด้วยตนเอง",
  Manual: "คู่มือ",
  ...
  "Showcase the category filter at the top or at the bottom of the calendar. The settings applies to Agenda, Cross, Timeline and Card views only":
    "แสดงตัวกรองหมวดหมู่ที่ด้านบนหรือที่ด้านล่างของปฏิทิน การตั้งค่าใช้กับวาระการประชุมข้ามไทม์ไลน์และการ์ดเท่านั้น",
  ...
  "Once enabled, your calendar widget will be translated based on the website’s language. Please note that as long as calendar titles and descriptions are entered as text, they cannot be translated.":
    "เมื่อเปิดใช้งานวิดเจ็ตปฏิทินของคุณจะถูกแปลตามภาษาของเว็บไซต์ โปรดทราบว่าตราบใดที่ชื่อปฏิทินและคำอธิบายถูกป้อนเป็นข้อความพวกเขาไม่สามารถแปลได้",
  ...
  "script disappear":
    "สคริปต์นี้ไม่มีอยู่โปรดเพิ่มสคริปต์ใน Google Analytics ของคุณ!",
  "Reset Layouts Dimensions": "รีเซ็ตขนาดเค้าโครง",
  Clear: "ชัดเจน",
  Undo: "เลิกทำ",
  Redo: "ทำซ้ำ",
  "Code Panel": "แผงรหัส",
  "Code Panel Notify":
    "การปรับเปลี่ยนรหัสโดยตรงอาจทำลายฟังก์ชั่นเค้าโครงหรือแอพ แก้ไขเฉพาะเมื่อคุณรู้ว่าคุณกำลังทำอะไร!",
  "Clear Editor": "เคลียร์บรรณาธิการ",
  "Clear Editor Notify":
    "แน่ใจหรือว่าต้องการล้างโปรแกรมแก้ไข? ความคืบหน้าทั้งหมดจะหายไป!",
  "Nothing to edit": "ไม่มีอะไรจะแก้ไข!",
  Shapes: "รูปทรง",
  "Delete The Shape": "ลบรูปร่าง",
  "Add shapes": "เพิ่มรูปร่างระหว่างเลย์เอาต์และปรับแต่ง!",
  "Preview unavailable": "ตัวอย่างส่วนประกอบไม่สามารถใช้งานได้สำหรับส่วนประกอบ",
  ...
  "Left Alignment": "การจัดตำแหน่งซ้าย",
  "Center Alignment": "การจัดตำแหน่งศูนย์",
  "Right Alignment": "การจัดตำแหน่งที่ถูกต้อง",
  "Text Decoration": "การตกแต่งข้อความ",
  "Overline": "โอเวอร์ไลน์",
  "Line Through": "เข้าแถว",
  "Underline": "ขีดเส้นใต้",
  "Underline and Overline": "ขีดเส้นใต้",
  "Without Decoration": "โดยไม่ต้องตกแต่ง",
  "Left": "ซ้าย",
  "Angle": "มุม",
  "Distance": "ระยะทาง",
  "Blur": "เบลอ",
  "Size": "ขนาด",
  "Edit individually": "แก้ไขเป็นรายบุคคล",
  "Apply to all corners": "นำไปใช้กับทุกมุม",
  "Date Box Visual": "ภาพกล่องวันที่",
  "One Line": "หนึ่งบรรทัด",
  "Show Icons": "แสดงไอคอน",
  "Design Settings": "การตั้งค่าการออกแบบ",
  "Personalize your editor to match your style and preferences, customize every detail in this settings tab !": "ปรับแต่งบรรณาธิการของคุณให้ตรงกับสไตล์และการตั้งค่าของคุณปรับแต่งทุกรายละเอียดในแท็บการตั้งค่านี้!",
  "Divider": "ผู้แบ่งแยก",
  "Ellipse": "วงรี",
  ...
  "Free admission": "เข้าชมฟรี",
  "Get Tickets Now": "รับบัตรเลย",
  "Get Tickets": "รับบัตร",
  "Instant confirmation": "ยืนยันทันที",
  "No seats selected": "ไม่ได้เลือกที่นั่ง",
  "No tickets available for this event.": "ไม่มีบัตรสำหรับกิจกรรมนี้",
  "No tickets selected": "ไม่ได้เลือกบัตร",
  "Order Summary": "สรุปคำสั่งซื้อ",
  "Payment": "การชำระเงิน",
  "Please enter a valid email": "กรุณาใส่อีเมลที่ถูกต้อง",
  "Please enter your name": "กรุณาใส่ชื่อของคุณ",
  "Please select at least one seat": "กรุณาเลือกอย่างน้อยหนึ่งที่นั่ง",
  "Register Now": "ลงทะเบียนเลย",
  "Registration Complete": "ลงทะเบียนเสร็จสมบูรณ์",
  "Secure checkout": "ชำระเงินอย่างปลอดภัย",
  "Select Tickets": "เลือกบัตร",
  "Select Your Seats": "เลือกที่นั่งของคุณ",
  "Select seats above to continue": "เลือกที่นั่งด้านบนเพื่อดำเนินการต่อ",
  "Select tickets above to continue": "เลือกบัตรด้านบนเพื่อดำเนินการต่อ",
  "Selected Seats": "ที่นั่งที่เลือก",
  "Service Fee": "ค่าบริการ",
  "Subtotal": "ยอดรวมย่อย",
  "Total Amount": "ยอดรวมทั้งหมด",
  "View your ticket": "ดูบัตรของคุณ",
  "each": "แต่ละ",
  "per ticket": "ต่อบัตร",
  "seat": "ที่นั่ง",
  "seats": "ที่นั่ง",
