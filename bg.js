let bg = {
  ...
  "You can move your mouse outside the seatmap while dragging - the selection will still apply when you release.": "Можете да местите мишката извън картата на седалките, докато плъзгате - изборът ще продължи да е валиден, когато го отпуснете.",
  "Tip:": "Съвет:",
  "Use the +/- buttons to zoom in and out": "Използвайте бутоните +/- за увеличаване и намаляване на мащаба",
  "Click and drag the background to pan around the venue": "Кликнете и плъзнете фона, за да се придвижвате панорамно около мястото",
  "Pan & Zoom": "Панорамиране и мащабиране",
  "Capacity is shared across all seatmaps for the same event": "Капацитетът е споделен между всички карти на местата за едно и също събитие",
  "Use the - button to remove tickets from your selection": "Използвайте бутона -, за да премахнете билети от селекцията си",
  "Use the + button to add tickets to your selection": "Използвайте бутона +, за да добавите билети към избраните от вас",
  "Standing areas show the number of tickets remaining": "Зоните за правостоящи показват броя на оставащите билети",
  "Standing Areas": "Зони за правостоящи",
  "Remove keyboard focus from seats": "Премахване на фокуса на клавиатурата от местата",
  "Clear Focus": "Ясен фокус",
  "Toggle the focused seat": "Превключване на фокусираната седалка",
  "Select / Deselect Seat": "Избор / Отмяна на избора на място",
  "Move between available seats": "Придвижване между наличните места",
  "Navigate Seats": "Навигиране на местата",
  "Use your keyboard to navigate and select seats without a mouse:": "Използвайте клавиатурата си, за да навигирате и избирате места без мишка:",
  "Keyboard Navigation": "Навигация с клавиатура",
  "Click an empty area to deselect all seats": "Щракнете върху празно място, за да премахнете избора на всички места",
  "Drag across multiple seats to toggle-select them": "Плъзнете през няколко места, за да ги изберете или превключите",
  "Click a selected seat again to deselect it": "Щракнете отново върху избрано място, за да го отмените",
  "Click a seat to select it": "Кликнете върху място, за да го изберете",
  "Selecting Seats": "Избор на места",
  "How to Select Seats": "Как да изберете места",
  "How to Use": "Как да използвате",
  "Pay": "Плащане",
  "Book": "Книга",
  "This promo code has already been used": "Този промо код вече е използван",
  "This promo code is not yet active": "Този промо код все още не е активен",
  "This promo code has expired": "Този промоционален код е изтекъл",
  "Invalid promo code": "Невалиден промоционален код",
  "Credit / Debit Card": "Кредитна/дебитна карта",
  "Fast & secure checkout": "Бързо и сигурно плащане",
  "Secure payment via Wix": "Сигурно плащане чрез Wix",
  "Pay at the venue": "Плащане на място",
  "Registration": "Регистрация",
  "Attendee Information": "Информация за участниците",
  "Your information is secure and will only be used for event registration": "Вашата информация е защитена и ще бъде използвана само за регистрация за събитието",
  "Your information is secure and will only be used for ticket delivery": "Вашата информация е защитена и ще бъде използвана само за доставка на билети",
  "Register": "Регистрация",
  "Event is fully booked": "Събитието е напълно резервирано",
  "To Event": "Към събитието",
  "Guest Details": "Данни за госта",
  "Because it was a Draft": "Защото беше чернова",
  "You can't see your event": "Не можете да видите събитието си",
  "The event is currently happening. If you believe this is an error, please contact the event organizer.": "Събитието се провежда в момента. Ако смятате, че това е грешка, моля, свържете се с организатора на събитието.",
  "Registration is closed because this event has already started.": "Регистрацията е затворена, защото събитието вече е започнало.",
  "Event In Progress": "Събитие в ход",
  "The event organizer is still preparing this event. Please check back later or contact the organizer for more information.": "Организаторът на събитието все още го подготвя. Моля, проверете отново по-късно или се свържете с организатора за повече информация.",
  "Event": "Събитие",
  "This event is currently in draft mode and not available for registration yet.": "Това събитие е в процес на разработка и все още не е достъпно за регистрация.",
  "This event is currently in draft mode and not yet available for viewing.": "Това събитие в момента е в режим на чернова и все още не е достъпно за преглед.",
  "Event Not Published": "Събитието не е публикувано",
  "Draft Mode": "Режим на чернова",
  "Back": "Обратно",
  "Go": "Отиди",
  "Could not find requested resource": "Не можа да бъде намерен заявеният ресурс",
  "Not Found 404": "Не е намерено 404",
  "Loading...": "Зареждане...",
  "Loading": "Зареждане",
  ...
  "Your information is secure and will only be used for ticket delivery": "Вашата информация е защитена и ще бъде използвана само за доставка на билети",
  "per ticket": "на билет",
  "Select tickets above to continue": "Изберете билети по-горе, за да продължите",
  "Select seats above to continue": "Изберете места по-горе, за да продължите",
  "Select Tickets": "Изберете билети",
  "Gallery": "Галерия",
  "Secure checkout": "Сигурно плащане",
  "About This Event": "Относно това събитие",
  ...
  "Sync Date Range": "Синхронизиране на диапазона от дати",
  "Sync categories": "Синхронизиране на категории",
  "Hide event description": "Скриване на описанието на събитието",
  "Hide private events": "Скриване на частни събития",
  "No synchronized calendars yet. Select a calendar above and click Sync to start.": "Все още няма синхронизирани календари. Изберете календар по-горе и щракнете върху „Синхронизиране“, за да започнете.",
  "Fetches current events so you can add them one by one.": "Извлича текущи събития, за да можете да ги добавяте едно по едно.",
  "Keeps events continuously updated in real time.": "Поддържа събитията непрекъснато актуализирани в реално време.",
  ...
  "Cross Event Limit": "Лимит за кръстосано събитие",
  "Show events limit": "Показване на ограничението за събития",
  "Show tooltip/popup": "Показване на подсказка/изскачащ прозорец",
  "Bold Monthly Dividers": "Удебелени месечни разделители",
  "Scroll to see more events": "Превъртете, за да видите още събития",
  "Show additional date": "Показване на допълнителна дата",
  ...
  "Reset Layouts Dimensions": "Нулиране на размери на оформлението",
  "Clear": "Ясно",
  "Undo": "Отмяна",
  "Redo": "Redo",
  "Code Panel": "Кодов панел",
  "Code Panel Notify": "Промяната на кода директно може да прекъсне оформлението или функционалността на приложението. Редактирайте само ако знаете какво правите!",
  "Clear Editor": "Ясен редактор",
  "Clear Editor Notify": "Сигурни ли сте, че искате да изчистите редактора? Целият напредък ще бъде загубен!",
  "Nothing to edit": "Няма какво да се редактира!",
  "Shapes": "Форми",
  "Delete The Shape": "Изтрийте формата",
  "Add shapes": "Добавете форми между оформленията и персонализирайте!",
  "Preview unavailable": "Визуализация на компонентите недостъпни за компонента",
  ...
  "Select Font": "Изберете Font",
  "Font Weight": "Тегло на шрифта",
  "Font Size": "Размер на шрифта",
  "Text Alignment": "Подравняване на текст",
  "Left Alignment": "Лява подравняване",
  "Center Alignment": "Централно подравняване",
  "Right Alignment": "Право подравняване",
  "Text Decoration": "Декорация на текст",
  "Overline": "Овързване",
  "Line Through": "Ред",
  "Underline": "Подчертаване",
  "Underline and Overline": "Подчертайте и надничайте",
  "Without Decoration": "Без декорация",
  "Left": "Вляво",
  "Angle": "Ъгъл",
  "Distance": "Разстояние",
  "Blur": "Замъгляване",
  "Size": "Размер",
  "Edit individually": "Редактирайте поотделно",
  "Apply to all corners": "Прилагайте се във всички ъгли",
  "Date Box Visual": "Кутия за дата Визуалност",
  "One Line": "Един ред",
  "Show Icons": "Показване на икони",
  "Design Settings": "Настройки на дизайна",
  "Personalize your editor to match your style and preferences, customize every detail in this settings tab !": "Персонализирайте редактора си, за да съответства на вашия стил и предпочитания, персонализирайте всеки детайл в този раздел Настройки!",
  "Divider": "Разделител",
  "Ellipse": "Елипс",
  "Rhombus": "Ромб",
  "Heart": "Сърце",
  ...
  "Free admission": "Безплатен вход",
  "Get Tickets Now": "Вземете билети сега",
  "Get Tickets": "Вземете билети",
  "Instant confirmation": "Незабавно потвърждение",
  "No seats selected": "Няма избрани места",
  "No tickets available for this event.": "Няма налични билети за това събитие.",
  "No tickets selected": "Няма избрани билети",
  ...
  "Please select at least one seat": "Моля, изберете поне едно място",
  "Register Now": "Регистрирайте се сега",
  ...
  "Select seats above to continue": "Изберете места по-горе, за да продължите",
  "Select tickets above to continue": "Изберете билети по-горе, за да продължите",
  "Selected Seats": "Избрани места",
  "Service Fee": "Такса за услуга",
  "Subtotal": "Междинна сума",
  "Total Amount": "Обща сума",
  "View your ticket": "Вижте вашия билет",
  "each": "всеки",
  "per ticket": "на билет",
  "seat": "място",
  "seats": "места",
