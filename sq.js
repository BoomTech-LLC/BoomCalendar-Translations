let sq = {
  ...
  "You can move your mouse outside the seatmap while dragging - the selection will still apply when you release.": "Mund ta lëvizni miun jashtë hartës së sediljeve ndërsa zvarritni - përzgjedhja do të vazhdojë të zbatohet kur ta lëshoni.",
  "Tip:": "Këshillë:",
  "Use the +/- buttons to zoom in and out": "Përdorni butonat +/- për të zmadhuar dhe zvogëluar",
  "Click and drag the background to pan around the venue": "Klikoni dhe tërhiqni sfondin për të lëvizur nëpër vendngjarje",
  "Pan & Zoom": "Panoramë dhe Zmadhim",
  "Capacity is shared across all seatmaps for the same event": "Kapaciteti ndahet në të gjitha hartat e vendeve për të njëjtin event",
  "Use the - button to remove tickets from your selection": "Përdorni butonin - për të hequr biletat nga përzgjedhja juaj",
  "Use the + button to add tickets to your selection": "Përdorni butonin + për të shtuar bileta në përzgjedhjen tuaj",
  "Standing areas show the number of tickets remaining": "Zonat në këmbë tregojnë numrin e biletave të mbetura",
  "Standing Areas": "Zonat në këmbë",
  "Remove keyboard focus from seats": "Hiq fokusin e tastierës nga vendet",
  "Clear Focus": "Fokus i qartë",
  "Toggle the focused seat": "Aktivizo/çaktivizo vendin e fokusuar",
  "Select / Deselect Seat": "Zgjidh / Çzgjidh vendin",
  "Move between available seats": "Lëviz midis vendeve të disponueshme",
  "Navigate Seats": "Navigoni vendet",
  "Use your keyboard to navigate and select seats without a mouse:": "Përdorni tastierën tuaj për të lundruar dhe zgjedhur vendet pa maus:",
  "Keyboard Navigation": "Navigimi me tastierë",
  "Click an empty area to deselect all seats": "Klikoni një zonë bosh për të çzgjedhur të gjitha vendet",
  "Drag across multiple seats to toggle-select them": "Zvarrit nëpër disa vende për t'i zgjedhur dhe çaktivizuar ato",
  "Click a selected seat again to deselect it": "Klikoni përsëri një vend të zgjedhur për ta çzgjedhur atë",
  "Click a seat to select it": "Klikoni një vend për ta zgjedhur atë",
  "Selecting Seats": "Zgjedhja e vendeve",
  "How to Select Seats": "Si të zgjidhni vendet",
  "How to Use": "Si të përdoret",
  "Pay": "Paguaj",
  "Book": "Libër",
  "This promo code has already been used": "Ky kod promovues është përdorur tashmë",
  "This promo code is not yet active": "Ky kod promovues nuk është ende aktiv",
  "This promo code has expired": "Ky kod promocional ka skaduar",
  "Invalid promo code": "Kod promocional i pavlefshëm",
  "Credit / Debit Card": "Kartë Krediti / Debiti",
  "Fast & secure checkout": "Pagesë e shpejtë dhe e sigurt",
  "Secure payment via Wix": "Pagesë e sigurt përmes Wix",
  "Pay at the venue": "Paguaj në vendin e ngjarjes",
  "Registration": "Regjistrimi",
  "Attendee Information": "Informacion për pjesëmarrësit",
  "Your information is secure and will only be used for event registration": "Informacioni juaj është i sigurt dhe do të përdoret vetëm për regjistrimin në event",
  "Your information is secure and will only be used for ticket delivery": "Informacioni juaj është i sigurt dhe do të përdoret vetëm për dorëzimin e biletave",
  "Register": "Regjistrohu",
  "Event is fully booked": "Eventi është rezervuar plotësisht",
  "To Event": "Për në Ngjarje",
  "Guest Details": "Detajet e Vizitorit",
  "Because it was a Draft": "Sepse ishte një Draft",
  "You can't see your event": "Nuk mund ta shihni ngjarjen tuaj",
  "The event is currently happening. If you believe this is an error, please contact the event organizer.": "Eventi është duke u zhvilluar aktualisht. Nëse mendoni se ky është një gabim, ju lutemi kontaktoni organizatorin e eventit.",
  "Registration is closed because this event has already started.": "Regjistrimi është mbyllur sepse ky aktivitet ka filluar tashmë.",
  "Event In Progress": "Ngjarje në zhvillim e sipër",
  "The event organizer is still preparing this event. Please check back later or contact the organizer for more information.": "Organizatori i eventit është ende duke e përgatitur këtë ngjarje. Ju lutemi kontrolloni përsëri më vonë ose kontaktoni organizatorin për më shumë informacion.",
  "Event": "Ngjarje",
  "This event is currently in draft mode and not available for registration yet.": "Ky aktivitet është aktualisht në modalitetin draft dhe nuk është ende i disponueshëm për regjistrim.",
  "This event is currently in draft mode and not yet available for viewing.": "Ky aktivitet është aktualisht në modalitetin draft dhe nuk është ende i disponueshëm për t'u parë.",
  "Event Not Published": "Ngjarja nuk është publikuar",
  "Draft Mode": "Modaliteti i Draftit",
  "Back": "Mbrapa",
  "Go": "Shko",
  "Could not find requested resource": "Nuk mund të gjendej burimi i kërkuar",
  "Not Found 404": "Nuk u gjet 404",
  ...
  "Your information is secure and will only be used for event registration": "Informacioni juaj është i sigurt dhe do të përdoret vetëm për regjistrimin në event",
  "Your information is secure and will only be used for ticket delivery": "Informacioni juaj është i sigurt dhe do të përdoret vetëm për dorëzimin e biletave",
  "per ticket": "për biletë",
  "Select tickets above to continue": "Zgjidhni biletat më sipër për të vazhduar",
  "Select seats above to continue": "Zgjidhni vendet më sipër për të vazhduar",
  "Select Tickets": "Zgjidhni Biletat",
  "Gallery": "Galeria",
  "Secure checkout": "Arkë e sigurt",
  "About This Event": "Rreth kësaj ngjarjeje",
  "Available Spots": "Vende të lira",
  "TICKET TYPES": "LLOJET E BILETËS",
  "TICKET TYPE": "LLOJI I BILETËS",
  "Sync": "Sinkronizim",
  "Connected": "I lidhur",
  ...
  "Sync Date Range": "Diapazoni i datave të sinkronizimit",
  ...
  "Weather Forecast": "Parashikimi i motit",
  "Cross Event Limit": "Kufiri i ngjarjeve të kryqëzuara",
  "Show events limit": "Shfaq kufirin e ngjarjeve",
  "Show tooltip/popup": "Shfaq këshillën e veglave / dritaren kërcyese",
  "Bold Monthly Dividers": "Ndarëse të guximshme mujore",
  "Scroll to see more events": "Lëvizni për të parë më shumë ngjarje",
  "Show additional date": "Shfaq datën shtesë",
  ...
  "Reset Layouts Dimensions": "Rivendosni dimensionet e paraqitjeve",
  "Clear": "I qartë",
  "Undo": "Zhbllokoj",
  "Redo": "Ribëj",
  "Code Panel": "Panel me kod",
  "Code Panel Notify": "Modifikimi i kodit drejtpërdrejt mund të thyejë paraqitjen ose funksionalitetin e aplikacionit. Redaktoni vetëm nëse e dini se çfarë po bëni!",
  "Clear Editor": "Redaktor i qartë",
  "Clear Editor Notify": "A jeni i sigurt që doni të pastroni redaktorin? E gjithë përparimi do të humbet!",
  "Nothing to edit": "Nuk ka asgjë për të redaktuar!",
  "Shapes": "Forma",
  "Delete The Shape": "Fshi formën",
  "Add shapes": "Shtoni forma midis paraqitjeve dhe rregulloni!",
  "Preview unavailable": "Paraqitja e komponentit e padisponueshme për komponentin",
  ...
  "Height": "Lartësi",
  "Font Family": "FAMILJE FONT",
  "Select Font": "Zgjidhni Font",
  "Font Weight": "Pesha e shkronjave",
  "Font Size": "Madhësia e shkronjave",
  "Text Alignment": "Përafrim i tekstit",
  "Left Alignment": "Shtrirja e majtë",
  "Center Alignment": "Shtrirje e qendrës",
  "Right Alignment": "Shtrirja e duhur",
  "Text Decoration": "Dekorimi i tekstit",
  "Overline": "I tepërt",
  "Line Through": "Rreshtohem",
  "Underline": "Nënvizoj",
  "Underline and Overline": "Nënvizoni dhe mbikëqyr",
  "Without Decoration": "Pa dekorim",
  "Left": "Majtas",
  "Angle": "Kënd",
  "Distance": "Distancë",
  "Blur": "Mjegullim",
  "Size": "Madhësi",
  "Edit individually": "Redakto individualisht",
  "Apply to all corners": "Aplikoni në të gjitha qoshet",
  "Date Box Visual": "Kutia e datës vizuale",
  "One Line": "Një rresht",
  "Show Icons": "Tregojnë ikona",
  "Design Settings": "Cilësimet e projektimit",
  "Personalize your editor to match your style and preferences, customize every detail in this settings tab !": "Personalizoni redaktorin tuaj që të përputhet me stilin dhe preferencat tuaja, rregulloni çdo detaj në këtë skedë Cilësimet!",
  "Divider": "Ndarës",
  "Ellipse": "Elips",
  "Rhombus": "Romb",
  "Heart": "Zemër",
