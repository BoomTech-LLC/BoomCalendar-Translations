let lv = {
  ...
  "You can move your mouse outside the seatmap while dragging - the selection will still apply when you release.": "Velkot peli, varat to pārvietot ārpus sēdvietu kartes — atlase joprojām paliks spēkā pēc atlaišanas.",
  "Tip:": "Padoms:",
  "Use the +/- buttons to zoom in and out": "Izmantojiet pogas +/-, lai tuvinātu un tālinātu",
  "Click and drag the background to pan around the venue": "Noklikšķiniet un velciet fonu, lai pārvietotos pa norises vietu",
  "Pan & Zoom": "Panoramēt un tuvināt",
  "Capacity is shared across all seatmaps for the same event": "Ietilpība tiek koplietota visās sēdvietu kartēs vienam un tam pašam pasākumam.",
  "Use the - button to remove tickets from your selection": "Lai noņemtu biļetes no atlases, izmantojiet pogu -.",
  "Use the + button to add tickets to your selection": "Izmantojiet pogu +, lai pievienotu biļetes savai izvēlei",
  "Standing areas show the number of tickets remaining": "Stāvvietu zonās tiek parādīts atlikušo biļešu skaits",
  "Standing Areas": "Stāvvietas",
  "Remove keyboard focus from seats": "Noņemt tastatūras fokusu no sēdvietām",
  "Clear Focus": "Skaidrs fokuss",
  "Toggle the focused seat": "Pārslēgt fokusēto sēdvietu",
  "Select / Deselect Seat": "Atlasīt/Atcelt sēdvietu",
  "Move between available seats": "Pārvietoties starp pieejamajām sēdvietām",
  "Navigate Seats": "Navigācija sēdvietās",
  "Use your keyboard to navigate and select seats without a mouse:": "Izmantojiet tastatūru, lai pārvietotos un atlasītu sēdvietas bez peles:",
  "Keyboard Navigation": "Tastatūras navigācija",
  "Click an empty area to deselect all seats": "Noklikšķiniet tukšā apgabalā, lai noņemtu atlasi no visām sēdvietām",
  "Drag across multiple seats to toggle-select them": "Velciet pāri vairākām sēdvietām, lai tās pārslēgtu uz citu atlasi.",
  "Click a selected seat again to deselect it": "Noklikšķiniet uz atlasītās sēdvietas vēlreiz, lai noņemtu tās atlasi",
  "Click a seat to select it": "Noklikšķiniet uz sēdvietas, lai to atlasītu",
  "Selecting Seats": "Sēdvietu izvēle",
  "How to Select Seats": "Kā izvēlēties sēdvietas",
  "How to Use": "Kā lietot",
  "Pay": "Maksāt",
  "Book": "Grāmata",
  "This promo code has already been used": "Šis reklāmas kods jau ir izmantots",
  "This promo code is not yet active": "Šis reklāmas kods vēl nav aktīvs",
  "This promo code has expired": "Šī reklāmas koda derīguma termiņš ir beidzies.",
  "Invalid promo code": "Nederīgs reklāmas kods",
  "Credit / Debit Card": "Kredītkarte/debetkarte",
  "Fast & secure checkout": "Ātra un droša norēķināšanās",
  "Secure payment via Wix": "Drošs maksājums, izmantojot Wix",
  "Pay at the venue": "Maksājiet norises vietā",
  "Registration": "Reģistrācija",
  "Attendee Information": "Dalībnieka informācija",
  "Your information is secure and will only be used for event registration": "Jūsu informācija ir drošībā un tiks izmantota tikai pasākuma reģistrācijai",
  "Your information is secure and will only be used for ticket delivery": "Jūsu informācija ir drošībā un tiks izmantota tikai biļešu piegādei",
  "Register": "Reģistrēties",
  "Event is fully booked": "Pasākums ir pilnībā rezervēts",
  "To Event": "Uz pasākumu",
  "Guest Details": "Viesu informācija",
  "Because it was a Draft": "Jo tas bija melnraksts",
  "You can't see your event": "Jūs nevarat redzēt savu pasākumu",
  "The event is currently happening. If you believe this is an error, please contact the event organizer.": "Pasākums pašlaik notiek. Ja uzskatāt, ka šī ir kļūda, lūdzu, sazinieties ar pasākuma organizatoru.",
  "Registration is closed because this event has already started.": "Reģistrācija ir slēgta, jo šis pasākums jau ir sācies.",
  "Event In Progress": "Notiek pasākums",
  "The event organizer is still preparing this event. Please check back later or contact the organizer for more information.": "Pasākuma organizators joprojām gatavo šo pasākumu. Lūdzu, pārbaudiet vēlāk vai sazinieties ar organizatoru, lai iegūtu plašāku informāciju.",
  "Event": "Pasākums",
  "This event is currently in draft mode and not available for registration yet.": "Šis pasākums pašlaik ir melnraksta režīmā un vēl nav pieejams reģistrācijai.",
  "This event is currently in draft mode and not yet available for viewing.": "Šis pasākums pašlaik ir melnraksta režīmā un vēl nav pieejams apskatei.",
  "Event Not Published": "Pasākums nav publicēts",
  "Draft Mode": "Melnraksta režīms",
  "Back": "Atpakaļ",
  "Go": "Ej",
  "Could not find requested resource": "Nevarēja atrast pieprasīto resursu",
  "Not Found 404": "Nav atrasts 404",
  ...
  "Your information is secure and will only be used for event registration": "Jūsu informācija ir drošībā un tiks izmantota tikai pasākuma reģistrācijai",
  "Your information is secure and will only be used for ticket delivery": "Jūsu informācija ir drošībā un tiks izmantota tikai biļešu piegādei",
  "per ticket": "par biļeti",
  "Select tickets above to continue": "Lai turpinātu, atlasiet biļetes iepriekš",
  "Select seats above to continue": "Lai turpinātu, atlasiet sēdvietas iepriekš",
  "Select Tickets": "Izvēlieties biļetes",
  "Gallery": "Galerija",
  "Secure checkout": "Droša norēķināšanās",
  ...
  "Sync Date Range": "Sinhronizācijas datumu diapazons",
  "Sync categories": "Sinhronizēt kategorijas",
  "Hide event description": "Slēpt notikuma aprakstu",
  "Hide private events": "Slēpt privātus notikumus",
  "No synchronized calendars yet. Select a calendar above and click Sync to start.": "Vēl nav sinhronizētu kalendāru. Atlasiet kalendāru iepriekš un noklikšķiniet uz Sinhronizēt, lai sāktu.",
  "Fetches current events so you can add them one by one.": "Ielādē aktuālos notikumus, lai jūs varētu tos pievienot pa vienam.",
  "Keeps events continuously updated in real time.": "Nepārtraukti atjaunina notikumus reāllaikā.",
  ...
  "Show events limit": "Rādīt notikumu ierobežojumu",
  "Show tooltip/popup": "Rādīt rīka padomu/uznirstošo logu",
  "Bold Monthly Dividers": "Drosmīgi ikmēneša dalītāji",
  "Scroll to see more events": "Ritiniet, lai redzētu citus notikumus",
  "Show additional date": "Rādīt papildu datumu",
  ...
  "Reset Layouts Dimensions": "Atiestatīt izkārtojumu izmēri",
  "Clear": "Noskaidrot",
  "Undo": "Atsaukt",
  "Redo": "Pārtaisīt",
  "Code Panel": "Kodeksa panelis",
  "Code Panel Notify": "Koda modificēšana tieši var sabojāt izkārtojumu vai lietotnes funkcionalitāti. Rediģēt tikai tad, ja zināt, ko jūs darāt!",
  "Clear Editor": "Caurspīdīgs redaktors",
  "Clear Editor Notify": "Vai esat pārliecināts, ka vēlaties notīrīt redaktoru? Viss progress tiks zaudēts!",
  "Nothing to edit": "Nav ko rediģēt!",
  "Shapes": "Formas",
  "Delete The Shape": "Izdzēsiet formu",
  "Add shapes": "Pievienojiet formas starp izkārtojumiem un pielāgojiet!",
  "Preview unavailable": "Komponentu priekšskatījums nav pieejams komponentam",
  ...
  "Select Font": "Atlasiet fontu",
  "Font Weight": "Fonta svars",
  "Font Size": "Fonta lielums",
  "Text Alignment": "Teksta izlīdzināšana",
  "Left Alignment": "Kreisā izlīdzināšana",
  "Center Alignment": "Centra izlīdzināšana",
  "Right Alignment": "Pareiza izlīdzināšana",
  "Text Decoration": "Teksta dekorēšana",
  "Overline": "Pārmērīga līnija",
  "Line Through": "Iziet cauri",
  "Underline": "Pasvītrot",
  "Underline and Overline": "Pasvītrojums un pārmērīga līnija",
  "Without Decoration": "Bez dekorēšanas",
  "Left": "Atstāts",
  "Angle": "Leņķis",
  "Distance": "Attālums",
  "Blur": "Aizmiglot",
  "Size": "Lielums",
  "Edit individually": "Rediģēt individuāli",
  "Apply to all corners": "Attiecas uz visiem stūriem",
  "Date Box Visual": "Datuma kaste vizuālā",
  "One Line": "Viena līnija",
  "Show Icons": "Parādīt ikonas",
  "Design Settings": "Dizaina iestatījumi",
  "Personalize your editor to match your style and preferences, customize every detail in this settings tab !": "Personalizējiet savu redaktoru, lai tas atbilstu jūsu stilam un vēlmēm, pielāgojiet visas detaļas cilnē Iestatījumi!",
  "Divider": "Dalītājs",
  "Ellipse": "Elipse",
  "Rhombus": "Rombs",
  "Heart": "Sirds",
  ...
  "Free admission": "Bezmaksas ieeja",
  "Get Tickets Now": "Iegūt biļetes tagad",
  "Get Tickets": "Iegūt biļetes",
  "Instant confirmation": "Tūlītējs apstiprinājums",
  "No seats selected": "Nav izvēlētas vietas",
  "No tickets available for this event.": "Šim pasākumam nav pieejamu biļešu.",
  "No tickets selected": "Nav izvēlētas biļetes",
  "Order Summary": "Pasūtījuma kopsavilkums",
  "Payment": "Maksājums",
  "Please enter a valid email": "Lūdzu, ievadiet derīgu e-pastu",
  "Please enter your name": "Lūdzu, ievadiet savu vārdu",
  "Please select at least one seat": "Lūdzu, izvēlieties vismaz vienu vietu",
  "Register Now": "Reģistrēties tagad",
  "Registration Complete": "Reģistrācija pabeigta",
  "Secure checkout": "Droša norēķināšanās",
  "Select Tickets": "Izvēlēties biļetes",
  "Select Your Seats": "Izvēlieties savas vietas",
  "Select seats above to continue": "Izvēlieties vietas augstāk, lai turpinātu",
  "Select tickets above to continue": "Izvēlieties biļetes augstāk, lai turpinātu",
  "Selected Seats": "Izvēlētās vietas",
  "Service Fee": "Pakalpojuma maksa",
  "Subtotal": "Starpsumma",
  "Total Amount": "Kopējā summa",
  "View your ticket": "Skatīt savu biļeti",
  "each": "katrs",
  "per ticket": "par biļeti",
  "seat": "vieta",
  "seats": "vietas",
