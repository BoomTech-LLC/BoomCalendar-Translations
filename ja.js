let ja = {
  ...
  "You can move your mouse outside the seatmap while dragging - the selection will still apply when you release.": "座席マップの外側にマウスカーソルを移動させながらドラッグしても、マウスを離すと選択範囲は維持されます。",
  "Tip:": "ヒント：",
  "Use the +/- buttons to zoom in and out": "+/- ボタンを使用してズームイン/ズームアウトします。",
  "Click and drag the background to pan around the venue": "背景をクリックしてドラッグすると、会場内を移動できます。",
  "Pan & Zoom": "パン＆ズーム",
  "Capacity is shared across all seatmaps for the same event": "同じイベントのすべての座席表で収容人数は共有されます。",
  "Use the - button to remove tickets from your selection": "「-」ボタンを使用して、選択からチケットを削除します。",
  "Use the + button to add tickets to your selection": "+ボタンを使用して、選択にチケットを追加します。",
  "Standing areas show the number of tickets remaining": "立ち見エリアには残りのチケット枚数が表示されます",
  "Standing Areas": "立ち見エリア",
  "Remove keyboard focus from seats": "座席からキーボードフォーカスを外す",
  "Clear Focus": "明確な焦点",
  "Toggle the focused seat": "フォーカスされた座席を切り替える",
  "Select / Deselect Seat": "座席を選択／選択解除する",
  "Move between available seats": "空いている席の間を移動します",
  "Navigate Seats": "座席案内",
  "Use your keyboard to navigate and select seats without a mouse:": "マウスを使わずにキーボードで座席を移動・選択できます。",
  "Keyboard Navigation": "キーボードナビゲーション",
  "Click an empty area to deselect all seats": "空いているエリアをクリックすると、すべての座席の選択が解除されます。",
  "Drag across multiple seats to toggle-select them": "複数の座席をドラッグして選択を切り替えます",
  "Click a selected seat again to deselect it": "選択した座席をもう一度クリックすると、選択が解除されます。",
  "Click a seat to select it": "座席をクリックして選択してください",
  "Selecting Seats": "座席の選択",
  "How to Select Seats": "座席の選び方",
  "How to Use": "使用方法",
  "Pay": "支払う",
  "Book": "本",
  "This promo code has already been used": "このプロモーションコードは既に使用されています",
  "This promo code is not yet active": "このプロモーションコードはまだ有効になっていません",
  "This promo code has expired": "このプロモーションコードは期限切れです",
  "Invalid promo code": "無効なプロモーションコード",
  "Credit / Debit Card": "クレジットカード／デビットカード",
  "Fast & secure checkout": "迅速かつ安全なチェックアウト",
  "Secure payment via Wix": "Wixによる安全な支払い",
  "Pay at the venue": "会場でお支払いください",
  "Registration": "登録",
  "Attendee Information": "参加者情報",
  "Your information is secure and will only be used for event registration": "お客様の情報は安全に保護され、イベント登録のみに使用されます。",
  "Your information is secure and will only be used for ticket delivery": "お客様の情報は安全に保護され、チケットの配送にのみ使用されます。",
  "Register": "登録する",
  "Event is fully booked": "イベントは満席です",
  "To Event": "イベントへ",
  "Guest Details": "ゲストの詳細",
  "Because it was a Draft": "ドラフトだったから",
  "You can't see your event": "イベントが表示されない",
  "The event is currently happening. If you believe this is an error, please contact the event organizer.": "イベントは現在開催中です。もしこれが誤りであると思われる場合は、イベント主催者にご連絡ください。",
  "Registration is closed because this event has already started.": "このイベントは既に開始されているため、登録受付は終了しました。",
  "Event In Progress": "イベント開催中",
  "The event organizer is still preparing this event. Please check back later or contact the organizer for more information.": "イベント主催者は現在準備中です。後日改めてご確認ください。または、詳細については主催者までお問い合わせください。",
  "Event": "イベント",
  "This event is currently in draft mode and not available for registration yet.": "このイベントは現在準備段階であり、まだ登録は受け付けておりません。",
  "This event is currently in draft mode and not yet available for viewing.": "このイベントは現在ドラフト段階であり、まだ閲覧できません。",
  "Event Not Published": "イベントは公開されていません",
  "Draft Mode": "ドラフトモード",
  "Back": "戻る",
  "Go": "行く",
  "Could not find requested resource": "要求されたリソースが見つかりませんでした。",
  "Not Found 404": "見つかりません 404",
  "Loading...": "読み込み中…",
  "Loading": "ロード中",
  ...
  "Your information is secure and will only be used for event registration": "お客様の情報は安全に保護され、イベント登録のみに使用されます。",
  "Your information is secure and will only be used for ticket delivery": "お客様の情報は安全に保護され、チケットの配送にのみ使用されます。",
  "per ticket": "チケット1枚あたり",
  "Select tickets above to continue": "続行するには、上のチケットを選択してください。",
  "Select seats above to continue": "続行するには、上の座席を選択してください。",
  "Select Tickets": "チケットを選択",
  "Gallery": "ギャラリー",
  "Secure checkout": "安全なチェックアウト",
  "About This Event": "このイベントについて",
  "Available Spots": "空き状況",
  ...
  "Sync Date Range": "同期日付範囲",
  "Sync categories": "同期カテゴリ",
  "Hide event description": "イベントの説明を非表示",
  "Hide private events": "プライベートイベントを非表示にする",
  "No synchronized calendars yet. Select a calendar above and click Sync to start.": "まだ同期されたカレンダーはありません。上記のカレンダーを選択し、「同期」をクリックして開始してください。",
  "Fetches current events so you can add them one by one.": "現在のイベントを取得して、1 つずつ追加できるようにします。",
  "Keeps events continuously updated in real time.": "イベントをリアルタイムで継続的に更新します。",
  "Your Api Key": "APIキー",
  "Fahrenheit": "華氏",
  "Celsius": "摂氏",
  "Select the city from the suggestions": "候補から都市を選択してください",
  "Weather Forecast": "天気予報",
  "Cross Event Limit": "クロスイベント制限",
  "Show events limit": "イベント制限を表示",
  "Show tooltip/popup": "ツールチップ/ポップアップを表示",
  "Bold Monthly Dividers": "太字の月間区切り",
  "Scroll to see more events": "スクロールして他のイベントを見る",
  "Show additional date": "追加日付を表示",
  "Custom Link": "カスタムリンク",
  ...
  "Reset Layouts Dimensions": "レイアウトの寸法をリセットします",
  "Clear": "クリア",
  "Undo": "元に戻します",
  "Redo": "やり直します",
  "Code Panel": "コードパネル",
  "Code Panel Notify": "コードを直接変更すると、レイアウトまたはアプリ機能が破損する場合があります。自分が何をしているのかを知っている場合にのみ編集してください！",
  "Clear Editor": "クリアエディター",
  "Clear Editor Notify": "編集者をクリアしたいですか？すべての進歩は失われます！",
  "Nothing to edit": "編集するものは何もありません！",
  "Shapes": "形",
  "Delete The Shape": "形状を削除します",
  "Add shapes": "レイアウトとカスタマイズの間に形状を追加してください！",
  "Preview unavailable": "コンポーネントプレビューはコンポーネントでは利用できません",
  ...
  "Select Font": "フォントを選択します",
  "Font Weight": "フォント重量",
  "Font Size": "フォントサイズ",
  "Text Alignment": "テキストアライメント",
  "Left Alignment": "左アライメント",
  "Center Alignment": "センターアライメント",
  "Right Alignment": "右アライメント",
  "Text Decoration": "テキスト装飾",
  "Overline": "オーバーライン",
  "Line Through": "並んでいます",
  "Underline": "下線",
  "Underline and Overline": "下線とオーバーライン",
  "Without Decoration": "装飾なし",
  "Left": "左",
  "Angle": "角度",
  "Distance": "距離",
  "Blur": "ぼやけ",
  "Size": "サイズ",
  "Edit individually": "個別に編集します",
  "Apply to all corners": "すべてのコーナーに適用します",
  "Date Box Visual": "日付ボックスビジュアル",
  "One Line": "1行",
  "Show Icons": "アイコンを表示します",
  "Design Settings": "設計設定",
  "Personalize your editor to match your style and preferences, customize every detail in this settings tab !": "あなたのスタイルと好みに合わせて編集者をパーソナライズし、この設定タブのすべての詳細をカスタマイズしてください！",
  "Divider": "仕切り",
  "Ellipse": "楕円",
  "Rhombus": "菱形",
  "Heart": "心臓",
  ...
  "Free admission": "入場無料",
  "Get Tickets Now": "今すぐチケットを取得",
  "Get Tickets": "チケットを取得",
  "Instant confirmation": "即時確認",
  "No seats selected": "座席が選択されていません",
  "No tickets available for this event.": "このイベントのチケットはありません。",
  "No tickets selected": "チケットが選択されていません",
  "Order Summary": "注文概要",
  "Payment": "支払い",
  "Please enter a valid email": "有効なメールアドレスを入力してください",
  "Please enter your name": "お名前を入力してください",
  "Please select at least one seat": "少なくとも1つの座席を選択してください",
  "Register Now": "今すぐ登録",
  "Registration Complete": "登録完了",
  "Secure checkout": "安全な決済",
  "Select Tickets": "チケットを選択",
  "Select Your Seats": "座席を選択",
  "Select seats above to continue": "続行するには上記で座席を選択してください",
  "Select tickets above to continue": "続行するには上記でチケットを選択してください",
  "Selected Seats": "選択された座席",
  "Service Fee": "サービス料",
  "Subtotal": "小計",
  "Total Amount": "合計金額",
  "View your ticket": "チケットを表示",
  "each": "各",
  "per ticket": "チケットあたり",
  "seat": "席",
  "seats": "席",
