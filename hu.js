let hu = {
  ...
  "You can move your mouse outside the seatmap while dragging - the selection will still apply when you release.": "Húzás közben az egérmutatót a helytérképen kívülre is mozgathatod - a kijelölés a húzás után is érvényben marad.",
  "Tip:": "Tipp:",
  "Use the +/- buttons to zoom in and out": "A +/- gombokkal nagyíthat és kicsinyíthet",
  "Click and drag the background to pan around the venue": "Kattintson és húzza a hátteret a helyszín mozgatásához",
  "Pan & Zoom": "Pásztázás és zoomolás",
  "Capacity is shared across all seatmaps for the same event": "A kapacitás ugyanazon esemény összes ülésrendjében megoszlik.",
  "Use the - button to remove tickets from your selection": "A - gombbal távolíthatja el a jegyeket a kiválasztásból",
  "Use the + button to add tickets to your selection": "A + gombbal adhatsz hozzá jegyeket a kiválasztásodhoz",
  "Standing areas show the number of tickets remaining": "Az állóhelyek mutatják a fennmaradó jegyek számát",
  "Standing Areas": "Állóhelyek",
  "Remove keyboard focus from seats": "Billentyűzetfókusz eltávolítása az ülésekről",
  "Clear Focus": "Tiszta fókusz",
  "Toggle the focused seat": "Fókuszált ülés be-/kikapcsolása",
  "Select / Deselect Seat": "Ülés kiválasztása / kijelölés törlése",
  "Move between available seats": "Mozgás a rendelkezésre álló ülőhelyek között",
  "Navigate Seats": "Navigálás az ülések között",
  "Use your keyboard to navigate and select seats without a mouse:": "Egér nélkül, billentyűzettel navigálhatsz és kiválaszthatod a helyeket:",
  "Keyboard Navigation": "Billentyűzetnavigáció",
  "Click an empty area to deselect all seats": "Kattintson egy üres területre az összes ülés kijelölésének megszüntetéséhez",
  "Drag across multiple seats to toggle-select them": "Húzd át az egérmutatót több ülésen a kiválasztásuk ki-/bekapcsolásához",
  "Click a selected seat again to deselect it": "Kattintson ismét a kiválasztott ülésre a kijelölés megszüntetéséhez",
  "Click a seat to select it": "Kattintson egy ülésre a kiválasztásához",
  "Selecting Seats": "Ülések kiválasztása",
  "How to Select Seats": "Hogyan válasszunk üléseket",
  "How to Use": "Használati útmutató",
  "Pay": "Fizetés",
  "Book": "Könyv",
  "This promo code has already been used": "Ezt a promóciós kódot már felhasználták",
  "This promo code is not yet active": "Ez a promóciós kód még nem aktív",
  "This promo code has expired": "Ez a promóciós kód lejárt",
  "Invalid promo code": "Érvénytelen promóciós kód",
  "Credit / Debit Card": "Hitel-/betéti kártya",
  "Fast & secure checkout": "Gyors és biztonságos fizetés",
  "Secure payment via Wix": "Biztonságos fizetés Wix-en keresztül",
  "Pay at the venue": "Fizetés a helyszínen",
  "Registration": "Bejegyzés",
  "Attendee Information": "Résztvevői információk",
  "Your information is secure and will only be used for event registration": "Az adataid biztonságban vannak, és csak az esemény regisztrációjához használjuk fel.",
  "Your information is secure and will only be used for ticket delivery": "Az adatai biztonságban vannak, és csak a jegyek kézbesítésére használjuk fel.",
  "Register": "Nyilvántartás",
  "Event is fully booked": "Az esemény betelt",
  "To Event": "Eseményre",
  "Guest Details": "Vendég adatai",
  "Because it was a Draft": "Mert az egy vázlat volt",
  "You can't see your event": "Nem látod az eseményedet",
  "The event is currently happening. If you believe this is an error, please contact the event organizer.": "Az esemény jelenleg folyamatban van. Ha úgy gondolja, hogy ez egy hiba, kérjük, vegye fel a kapcsolatot az esemény szervezőjével.",
  "Registration is closed because this event has already started.": "A regisztráció lezárult, mert ez az esemény már elkezdődött.",
  "Event In Progress": "Esemény folyamatban",
  "The event organizer is still preparing this event. Please check back later or contact the organizer for more information.": "A rendezvény szervezője még mindig az esemény előkészítésén dolgozik. Kérjük, látogasson vissza később, vagy vegye fel a kapcsolatot a szervezővel további információkért.",
  "Event": "Esemény",
  "This event is currently in draft mode and not available for registration yet.": "Ez az esemény jelenleg vázlat módban van, és még nem lehet rá regisztrálni.",
  "This event is currently in draft mode and not yet available for viewing.": "Ez az esemény jelenleg vázlat módban van, és még nem tekinthető meg.",
  "Event Not Published": "Esemény nincs közzétéve",
  "Draft Mode": "Vázlat mód",
  "Back": "Vissza",
  "Go": "Megy",
  "Could not find requested resource": "Nem található a kért erőforrás",
  ...
  "Your information is secure and will only be used for event registration": "Az adataid biztonságban vannak, és csak az esemény regisztrációjához használjuk fel.",
  "Your information is secure and will only be used for ticket delivery": "Az adatai biztonságban vannak, és csak a jegyek kézbesítésére használjuk fel.",
  "per ticket": "jegyenként",
  "Select tickets above to continue": "A folytatáshoz válassza ki a fenti jegyeket",
  "Select seats above to continue": "A folytatáshoz válassza ki a fenti helyeket",
  "Select Tickets": "Jegyek kiválasztása",
  "Gallery": "Galéria",
  "Secure checkout": "Biztonságos fizetés",
  ...
  "Sync Date Range": "Szinkronizálás dátumtartománya",
  "Sync categories": "Szinkronizálási kategóriák",
  "Hide event description": "Esemény leírásának elrejtése",
  "Hide private events": "Privát események elrejtése",
  "No synchronized calendars yet. Select a calendar above and click Sync to start.": "Még nincsenek szinkronizált naptárak. Válasszon ki egy naptárat a fentiekből, és kattintson a Szinkronizálás gombra a kezdéshez.",
  "Fetches current events so you can add them one by one.": "Lekéri az aktuális eseményeket, így egyesével hozzáadhatod őket.",
  "Keeps events continuously updated in real time.": "Folyamatosan, valós időben frissíti az eseményeket.",
  ...
  "Show events limit": "Eseménykorlát megjelenítése",
  "Show tooltip/popup": "Eszköztipp/előugró ablak megjelenítése",
  "Bold Monthly Dividers": "Merész havi osztók",
  "Scroll to see more events": "További események megtekintéséhez görgessen",
  "Show additional date": "További dátum megjelenítése",
  ...
  "Reset Layouts Dimensions": "Az elrendezések dimenzióinak visszaállítása",
  "Clear": "Világos",
  "Undo": "Visszavonul",
  "Redo": "Újra felújít",
  "Code Panel": "Kódpanel",
  "Code Panel Notify": "A kód közvetlen módosítása megszakíthatja az elrendezést vagy az alkalmazás funkciókat. Csak akkor szerkesztje, ha tudja, mit csinál!",
  "Clear Editor": "Tiszta szerkesztő",
  "Clear Editor Notify": "Biztos benne, hogy törölni akarja a szerkesztőt? Minden előrelépés elveszik!",
  "Nothing to edit": "Nincs mit szerkeszteni!",
  "Shapes": "Alakzatok",
  "Delete The Shape": "Törölje az alakot",
  "Add shapes": "Adjon hozzá formákat az elrendezések között, és testreszabja!",
  "Preview unavailable": "Az összetevők előnézete nem érhető el az összetevőkhöz",
  ...
  "Select Font": "Válassza ki a betűtípust",
  "Font Weight": "Betűtípus súlya",
  "Font Size": "Betűkészlet",
  "Text Alignment": "Szöveges igazítás",
  "Left Alignment": "Bal oldali igazítás",
  "Center Alignment": "Központi igazítás",
  "Right Alignment": "Jobb igazítás",
  "Text Decoration": "Szöveges dekoráció",
  "Overline": "Túlvonal",
  "Line Through": "Átvezet",
  "Underline": "Aláhúzás",
  "Underline and Overline": "Aláhúzás és túllépés",
  "Without Decoration": "Dekoráció nélkül",
  "Left": "Bal oldali",
  "Angle": "Szög",
  "Distance": "Távolság",
  "Blur": "Elhomályosít",
  "Size": "Méret",
  "Edit individually": "Szerkessze külön -külön",
  "Apply to all corners": "Alkalmazza az összes sarokba",
  "Date Box Visual": "Date Box Visual",
  "One Line": "Egy sor",
  "Show Icons": "Az ikonok megjelenítése",
  "Design Settings": "Tervezési beállítások",
  "Personalize your editor to match your style and preferences, customize every detail in this settings tab !": "Testreszabja a szerkesztőt, hogy megfeleljen a stílusának és preferenciáinak, testreszabhatja a Beállítások lapon minden részletet!",
  "Divider": "Osztó",
  "Ellipse": "Ellipszis",
  "Rhombus": "Rombusz",
  "Heart": "Szív",
  ...
  "Available Spots": "Elérhető helyek",
  "Event Details": "Esemény részletei",
  "Free admission": "Ingyenes belépés",
  "Get Tickets Now": "Jegyek vásárlása most",
  "Get Tickets": "Jegyek vásárlása",
  "Instant confirmation": "Azonnali megerősítés",
  "No seats selected": "Nincs kiválasztott hely",
  "No tickets available for this event.": "Erre az eseményre nem elérhetők jegyek.",
  "No tickets selected": "Nincs kiválasztott jegy",
  ...
  "Please select at least one seat": "Kérjük, válasszon legalább egy helyet",
  "Register Now": "Regisztráció most",
  "Registration Complete": "Regisztráció befejezve",
  "Secure checkout": "Biztonságos fizetés",
  "Select Tickets": "Jegyek kiválasztása",
  "Select Your Seats": "Válassza ki helyeit",
  "Select seats above to continue": "A folytatáshoz válasszon helyeket fent",
  "Select tickets above to continue": "A folytatáshoz válasszon jegyeket fent",
  "Selected Seats": "Kiválasztott helyek",
  "Service Fee": "Szolgáltatási díj",
  "Subtotal": "Részösszeg",
  "Total Amount": "Teljes összeg",
  "View your ticket": "Jegy megtekintése",
  "each": "darab",
  "per ticket": "jegyenként",
  "seat": "hely",
  "seats": "helyek",
