let uk = {
  "Ticket Tailor sync allows you to integrate your events and sessions with your Boom Calendar.": "Синхронізація Ticket Tailor дозволяє інтегрувати ваші події та сеанси з календарем Boom.",
  ...
  "Do you really want to delete selected user? Once removed, cannot be undone.": "Ви дійсно хочете видалити вибраного користувача? Після видалення цю дію неможливо скасувати.",
  "Delete Guest": "Видалити гостя",
  "Invoice number": "Номер накладної",
  "Status": "Статус",
  "Payment type": "Тип оплати",
  "Select payment method to receive fees through tickets": "Виберіть спосіб оплати, щоб отримати комісію через квитки",
  "Add Code": "Додати код",
  ...
  "Enable and configure your ticketing system": "Увімкніть і налаштуйте систему продажу квитків",
  ...
  "Notify the user when the registration is canceled": "Повідомити користувача про скасування реєстрації",
  "Cancellation email": "Електронна пошта про скасування",
  "Send a reminder to the user one day prior to the event": "Надіслати нагадування користувачеві за день до події",
  "Reminder email": "Електронна пошта з нагадуванням",
  "Send an instant email to the user once registration is completed": "Миттєво надішліть користувачеві електронний лист після завершення реєстрації",
  ...
  "Click on the toggle buttons next to each field to add it to your registration form. If you want to make the field required, click on the asterisk (*).": "Натисніть кнопки-перемикачі біля кожного поля, щоб додати його до реєстраційної форми. Якщо ви хочете зробити поле обов'язковим, натисніть на зірочку (*).",
  ...
  "Configure your registration form fields": "Налаштуйте поля реєстраційної форми",
  "Show guest limit": "Показати ліміт гостей",
  "Enable Registration": "Увімкнути реєстрацію",
  "Click to activate registration on this event": "Натисніть, щоб активувати реєстрацію на цю подію",
  "Customize the general settings of registration": "Налаштуйте загальні параметри реєстрації",
  "Enter URL": "Введіть URL",
  "Page URL": "URL сторінки",
  "Close registration when the event starts": "Закрийте реєстрацію після початку події",
  ...
  "Open event registration landing page": "Відкрити цільову сторінку реєстрації на подію",
  "It must have taken you plenty of preparation to get ready for your event. Now is the time to sit back and relax till your guests gather around! As soon as a new registration is made, the information about your guest will appear here. Come back later to keep track of your event attendees.": "Напевно, вам знадобилося багато часу, щоб підготуватися до вашої події. Настав час розслабитися, доки не зберуться гості! Як тільки буде зроблена нова реєстрація, тут з'явиться інформація про вашого гостя. Поверніться пізніше, щоб стежити за відвідувачами події.",
  "You have no guests at the moment.": "У вас зараз немає гостей.",
  "List of people who are registered to your event": "Список людей, які зареєстровані на вашу подію",
  ...
  "Do you really want to delete selected event? Once removed, cannot be undone": "Ви дійсно хочете видалити вибрану подію? Після видалення цю дію неможливо скасувати",
  "There are no categories yet": "Категорій ще немає",
  "Making Changes to your synced calendar with the following links. Please review your changes carefully.": "Внесення змін до синхронізованого календаря за допомогою наведених нижче посилань. Уважно перегляньте свої зміни.",
  "occurrences": "випадки",
