let uk = {
  ...
  "You can move your mouse outside the seatmap while dragging - the selection will still apply when you release.": "Ви можете переміщувати мишу за межі схеми сидінь під час перетягування — вибір все одно застосовуватиметься після відпускання.",
  "Tip:": "Порада:",
  "Use the +/- buttons to zoom in and out": "Використовуйте кнопки +/- для збільшення та зменшення масштабу",
  "Click and drag the background to pan around the venue": "Клацніть і перетягніть фон, щоб панорамувати місце проведення",
  "Pan & Zoom": "Панорамування та масштабування",
  "Capacity is shared across all seatmaps for the same event": "Місткість розподіляється між усіма схемами місць для однієї події",
  "Use the - button to remove tickets from your selection": "Використайте кнопку "-", щоб видалити квитки з вашого вибору",
  "Use the + button to add tickets to your selection": "Використайте кнопку +, щоб додати квитки до свого вибору",
  "Standing areas show the number of tickets remaining": "У місцях для стояння вказано кількість квитків, що залишилися",
  "Standing Areas": "Стоячі місця",
  "Remove keyboard focus from seats": "Видалити фокус клавіатури з місць",
  "Clear Focus": "Чіткий фокус",
  "Toggle the focused seat": "Перемикання фокусованого сидіння",
  "Select / Deselect Seat": "Вибрати / Скасувати вибір місця",
  "Move between available seats": "Переміщення між доступними місцями",
  "Navigate Seats": "Навігація по місцях",
  "Use your keyboard to navigate and select seats without a mouse:": "Використовуйте клавіатуру для навігації та вибору місць без миші:",
  "Keyboard Navigation": "Навігація клавіатурою",
  "Click an empty area to deselect all seats": "Клацніть порожню область, щоб скасувати вибір усіх місць",
  "Drag across multiple seats to toggle-select them": "Перетягніть по кількох місцях, щоб перемикати між ними",
  "Click a selected seat again to deselect it": "Знову клацніть вибране місце, щоб скасувати його вибір",
  "Click a seat to select it": "Натисніть на місце, щоб вибрати його",
  "Selecting Seats": "Вибір місць",
  "How to Select Seats": "Як вибрати місця",
  "How to Use": "Як використовувати",
  "Pay": "Оплата",
  "Book": "Книга",
  "This promo code has already been used": "Цей промокод вже використано",
  "This promo code is not yet active": "Цей промокод ще не активний",
  "This promo code has expired": "Термін дії цього промокоду закінчився",
  "Invalid promo code": "Недійсний промокод",
  "Credit / Debit Card": "Кредитна/дебетова картка",
  "Fast & secure checkout": "Швидка та безпечна оплата",
  "Secure payment via Wix": "Безпечний платіж через Wix",
  "Pay at the venue": "Оплата на місці проведення",
  "Registration": "Реєстрація",
  "Attendee Information": "Інформація про учасників",
  "Your information is secure and will only be used for event registration": "Ваша інформація захищена та буде використана лише для реєстрації на захід",
  "Your information is secure and will only be used for ticket delivery": "Ваша інформація захищена та буде використана лише для доставки квитків",
  "Register": "Зареєструватися",
  "Event is fully booked": "Захід повністю заброньований",
  "To Event": "До події",
  "Guest Details": "Відомості про гостя",
  "Because it was a Draft": "Тому що це був черновик",
  "You can't see your event": "Ви не бачите свою подію",
  "The event is currently happening. If you believe this is an error, please contact the event organizer.": "Подія зараз триває. Якщо ви вважаєте, що це помилка, зверніться до організатора заходу.",
  "Registration is closed because this event has already started.": "Реєстрацію закрито, оскільки цей захід вже розпочався.",
  "Event In Progress": "Подія триває",
  "The event organizer is still preparing this event. Please check back later or contact the organizer for more information.": "Організатор заходу все ще готує цю подію. Будь ласка, перевірте пізніше або зв’яжіться з організатором для отримання додаткової інформації.",
  "Event": "Подія",
  "This event is currently in draft mode and not available for registration yet.": "Ця подія наразі перебуває в режимі чернетки та ще недоступна для реєстрації.",
  "This event is currently in draft mode and not yet available for viewing.": "Ця подія наразі перебуває в режимі чернетки та ще недоступна для перегляду.",
  "Event Not Published": "Подія не опублікована",
  "Draft Mode": "Режим чернетки",
  "Back": "Назад",
  "Go": "Іти",
  "Could not find requested resource": "Не вдалося знайти запитуваний ресурс",
  "Not Found 404": "Не знайдено 404",
  ...
  "Your information is secure and will only be used for event registration": "Ваша інформація захищена та буде використана лише для реєстрації на захід",
  "Your information is secure and will only be used for ticket delivery": "Ваша інформація захищена та буде використана лише для доставки квитків",
  "per ticket": "за квиток",
  "Select tickets above to continue": "Виберіть квитки вище, щоб продовжити",
  "Select seats above to continue": "Виберіть місця вище, щоб продовжити",
  "Select Tickets": "Вибрати квитки",
  "Gallery": "Галерея",
  "Secure checkout": "Безпечна оплата",
  ...
  "Sync Date Range": "Діапазон дат синхронізації",
  "Sync categories": "Синхронізувати категорії",
  "Hide event description": "Приховати опис події",
  "Hide private events": "Приховати приватні події",
  "No synchronized calendars yet. Select a calendar above and click Sync to start.": "Синхронізованих календарів поки що немає. Виберіть календар вище та натисніть «Синхронізувати», щоб розпочати.",
  "Fetches current events so you can add them one by one.": "Отримує поточні події, щоб ви могли додавати їх одну за одною.",
  "Keeps events continuously updated in real time.": "Постійно оновлює інформацію про події в режимі реального часу.",
  ...
  "Cross Event Limit": "Перехресний ліміт подій",
  "Show events limit": "Показати ліміт подій",
  "Show tooltip/popup": "Показати підказку/спливаюче вікно",
  "Bold Monthly Dividers": "Жирний місячний дільник",
  "Scroll to see more events": "Прокрутіть, щоб побачити більше подій",
  "Show additional date": "Показати додаткову дату",
  ...
  "Reset Layouts Dimensions": "Скидання макетів розміри",
  "Clear": "Чіткий",
  "Undo": "Скасувати",
  "Redo": "Переробляти",
  "Code Panel": "Кодова панель",
  "Code Panel Notify": "Модифікація коду безпосередньо може зламати макет або функціональність програми. Редагувати лише, якщо ви знаєте, що робите!",
  "Clear Editor": "Чіткий редактор",
  "Clear Editor Notify": "Ви впевнені, що хочете очистити редактор? Весь прогрес буде втрачено!",
  "Nothing to edit": "Немає нічого редагувати!",
  "Shapes": "Форми",
  "Delete The Shape": "Видалити форму",
  "Add shapes": "Додайте форми між макетами та налаштувати!",
  "Preview unavailable": "Попередній перегляд компонентів недоступний для компонента",
  ...
  "Left Alignment": "Залиште вирівнювання",
  "Center Alignment": "Вирівнювання в центрі",
  "Right Alignment": "Праве вирівнювання",
  "Text Decoration": "Текстове оздоблення",
  "Overline": "Перевищувати",
  "Line Through": "Проводити",
  "Underline": "Підкреслювати",
  "Underline and Overline": "Підкреслювати та перевищувати",
  "Without Decoration": "Без прикрас",
  "Left": "Лівий",
  "Angle": "Кут",
  "Distance": "Відстань",
  "Blur": "Розмиття",
  "Size": "Розмір",
  "Edit individually": "Редагувати індивідуально",
  "Apply to all corners": "Застосовуйте до всіх куточків",
  "Date Box Visual": "Візуальна скринька побачень",
  "One Line": "Один рядок",
  "Show Icons": "Показати іконки",
  "Design Settings": "Налаштування дизайну",
  "Personalize your editor to match your style and preferences, customize every detail in this settings tab !": "Персоналізуйте свій редактор, щоб відповідати вашому стилю та налаштуванню, налаштуйте кожну деталь на цій вкладці Налаштування!",
  "Divider": "Роздільник",
  "Ellipse": "Еліпс",
  "Rhombus": "Ромб",
  "Heart": "Серце",
  ...
  "Available Spots": "Доступні місця",
  "Event Details": "Деталі події",
  "Free admission": "Безкоштовний вхід",
  "Get Tickets Now": "Отримати квитки зараз",
  "Get Tickets": "Отримати квитки",
  "Instant confirmation": "Миттєве підтвердження",
  "No seats selected": "Місця не вибрані",
  "No tickets available for this event.": "Квитки на цю подію недоступні.",
  "No tickets selected": "Квитки не вибрані",
  "Order Summary": "Підсумок замовлення",
  "Payment": "Оплата",
  "Please enter a valid email": "Введіть дійсну електронну адресу",
  "Please enter your name": "Введіть ваше ім'я",
  "Please select at least one seat": "Виберіть хоча б одне місце",
  "Register Now": "Зареєструватися зараз",
  "Registration Complete": "Реєстрація завершена",
  "Secure checkout": "Безпечна оплата",
  "Select Tickets": "Вибрати квитки",
  "Select Your Seats": "Виберіть свої місця",
  "Select seats above to continue": "Виберіть місця вище, щоб продовжити",
  "Select tickets above to continue": "Виберіть квитки вище, щоб продовжити",
  "Selected Seats": "Вибрані місця",
  "Service Fee": "Сервісний збір",
  "Subtotal": "Проміжний підсумок",
  "Total Amount": "Загальна сума",
  "View your ticket": "Переглянути ваш квиток",
  "each": "кожен",
  "per ticket": "за квиток",
  "seat": "місце",
  "seats": "місця",
