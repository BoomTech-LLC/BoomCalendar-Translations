let tr = {
  ...
  "You can move your mouse outside the seatmap while dragging - the selection will still apply when you release.": "Fareyi sürüklerken koltuk haritasının dışına da taşıyabilirsiniz; fareyi bıraktığınızda seçim yine de geçerli olacaktır.",
  "Tip:": "Uç:",
  "Use the +/- buttons to zoom in and out": "+/- düğmelerini kullanarak yakınlaştırıp uzaklaştırabilirsiniz.",
  "Click and drag the background to pan around the venue": "Arka planı tıklayıp sürükleyerek mekânın etrafında gezinin.",
  "Pan & Zoom": "Pan ve Yakınlaştırma",
  "Capacity is shared across all seatmaps for the same event": "Aynı etkinlik için tüm oturma planlarında kapasite paylaşılmaktadır.",
  "Use the - button to remove tickets from your selection": "Seçiminizden biletleri kaldırmak için "-" düğmesini kullanın.",
  "Use the + button to add tickets to your selection": "+ düğmesini kullanarak seçiminize bilet ekleyin.",
  "Standing areas show the number of tickets remaining": "Ayakta durma alanlarında kalan bilet sayısı gösterilmektedir.",
  "Standing Areas": "Ayakta Durma Alanları",
  "Remove keyboard focus from seats": "Koltuklardan klavye odağını kaldırın.",
  "Clear Focus": "Net Odak",
  "Toggle the focused seat": "Odaklanmış koltuğu açıp kapatın.",
  "Select / Deselect Seat": "Koltuk Seç / Seçimi Kaldır",
  "Move between available seats": "Mevcut koltuklar arasında geçiş yapın.",
  "Navigate Seats": "Koltuklarda Gezinme",
  "Use your keyboard to navigate and select seats without a mouse:": "Klavyenizi kullanarak fare kullanmadan koltuklar arasında gezinin ve seçim yapın:",
  "Keyboard Navigation": "Klavye ile Gezinme",
  "Click an empty area to deselect all seats": "Tüm koltukların seçimini kaldırmak için boş bir alana tıklayın.",
  "Drag across multiple seats to toggle-select them": "Birden fazla koltuğu sürükleyerek aralarında geçiş yapın ve seçim yapın.",
  "Click a selected seat again to deselect it": "Seçili koltuğun seçimini kaldırmak için tekrar tıklayın.",
  "Click a seat to select it": "Seçmek için bir koltuğa tıklayın.",
  "Selecting Seats": "Koltuk Seçimi",
  "How to Select Seats": "Koltuk Seçimi Nasıl Yapılır?",
  "How to Use": "Nasıl Kullanılır",
  "Pay": "Ödemek",
  "Book": "Kitap",
  "This promo code has already been used": "Bu promosyon kodu daha önce kullanıldı.",
  "This promo code is not yet active": "Bu promosyon kodu henüz aktif değil.",
  "This promo code has expired": "Bu promosyon kodunun süresi doldu.",
  "Invalid promo code": "Geçersiz promosyon kodu",
  "Credit / Debit Card": "Kredi / Banka Kartı",
  "Fast & secure checkout": "Hızlı ve güvenli ödeme",
  "Secure payment via Wix": "Wix üzerinden güvenli ödeme",
  "Pay at the venue": "Ödemeyi etkinlik alanında yapın.",
  "Registration": "Kayıt",
  "Attendee Information": "Katılımcı Bilgileri",
  "Your information is secure and will only be used for event registration": "Bilgileriniz güvendedir ve yalnızca etkinlik kaydı için kullanılacaktır.",
  "Your information is secure and will only be used for ticket delivery": "Bilgileriniz güvendedir ve yalnızca bilet teslimatı için kullanılacaktır.",
  "Register": "Kayıt olmak",
  "Event is fully booked": "Etkinlik tamamen dolu.",
  "To Event": "Etkinliğe",
  "Guest Details": "Konuk Bilgileri",
  "Because it was a Draft": "Çünkü bu bir taslaktı.",
  "You can't see your event": "Etkinliğinizi göremiyorsunuz.",
  "The event is currently happening. If you believe this is an error, please contact the event organizer.": "Etkinlik şu anda gerçekleşiyor. Bunun bir hata olduğunu düşünüyorsanız, lütfen etkinlik organizatörüyle iletişime geçin.",
  "Registration is closed because this event has already started.": "Etkinlik başladığı için kayıtlar kapanmıştır.",
  "Event In Progress": "Etkinlik Devam Ediyor",
  "The event organizer is still preparing this event. Please check back later or contact the organizer for more information.": "Etkinlik organizatörü henüz hazırlıklarını sürdürüyor. Lütfen daha sonra tekrar kontrol edin veya daha fazla bilgi için organizatörle iletişime geçin.",
  "Event": "Etkinlik",
  "This event is currently in draft mode and not available for registration yet.": "Bu etkinlik şu anda taslak aşamasındadır ve henüz kayıt için müsait değildir.",
  "This event is currently in draft mode and not yet available for viewing.": "Bu etkinlik şu anda taslak aşamasındadır ve henüz görüntülenmeye hazır değildir.",
  "Event Not Published": "Etkinlik Yayınlanmadı",
  "Draft Mode": "Taslak Modu",
  "Back": "Geri",
  "Go": "Gitmek",
  "Could not find requested resource": "İstenen kaynak bulunamadı.",
  ...
  "Select tickets above to continue": "Devam etmek için yukarıdaki biletleri seçin.",
  "Select seats above to continue": "Devam etmek için yukarıdan koltuk seçin.",
  "Select Tickets": "Bilet Seç",
  "Gallery": "Galeri",
  "Secure checkout": "Güvenli ödeme",
  "About This Event": "Bu Etkinlik Hakkında",
  "Available Spots": "Mevcut Yerler",
  "TICKET TYPES": "BİLET TÜRLERİ",
  "TICKET TYPE": "BİLET TÜRÜ",
  "Sync": "Senkronizasyon",
  "Connected": "Bağlı",
  ...
  "Sync Date Range": "Senkronizasyon Tarih Aralığı",
  "Sync categories": "Kategorileri senkronize et",
  "Hide event description": "Etkinlik açıklamasını gizle",
  "Hide private events": "Özel etkinlikleri gizle",
  "No synchronized calendars yet. Select a calendar above and click Sync to start.": "Henüz senkronize edilmiş takvim yok. Yukarıdan bir takvim seçin ve Senkronize Et'e tıklayarak başlatın.",
  "Fetches current events so you can add them one by one.": "Güncel etkinlikleri getirir, böylece bunları tek tek ekleyebilirsiniz.",
  "Keeps events continuously updated in real time.": "Olayları sürekli olarak gerçek zamanlı olarak güncel tutar.",
  ...
  "Cross Event Limit": "Çapraz Etkinlik Sınırı",
  "Show events limit": "Etkinlik sınırını göster",
  "Show tooltip/popup": "Araç ipucu/açılır pencereyi göster",
  "Bold Monthly Dividers": "Kalın Aylık Ayırıcılar",
  "Scroll to see more events": "Daha fazla etkinlik görmek için kaydırın",
  "Show additional date": "Ek tarihi göster",
  ...
  "Reset Layouts Dimensions": "Düzen Boyutlarını Sıfırla",
  "Clear": "Temizlemek",
  "Undo": "Geri almak",
  "Redo": "Yeniden yapmak",
  "Code Panel": "Kod paneli",
  "Code Panel Notify": "Kodu doğrudan değiştirmek, düzeni veya uygulama işlevini bozabilir. Yalnızca ne yaptığınızı biliyorsanız düzenleyin!",
  "Clear Editor": "Baş editör",
  "Clear Editor Notify": "Editörü temizlemek istediğinden emin misiniz? Tüm ilerlemeler kaybedilecek!",
  "Nothing to edit": "Düzenleyecek hiçbir şey yok!",
  "Shapes": "Şekiller",
  "Delete The Shape": "Şekli sil",
  "Add shapes": "Düzenler arasında şekiller ekleyin ve özelleştirin!",
  "Preview unavailable": "Bileşen önizleme bileşen için kullanılamıyor",
  ...
  "Text Alignment": "Metin uyumu",
  "Left Alignment": "Sol hizalama",
  "Center Alignment": "Merkez hizalama",
  "Right Alignment": "Doğru hizalama",
  "Text Decoration": "Metin dekorasyonu",
  "Overline": "Aşırı satır",
  "Line Through": "Sıraya girmek",
  "Underline": "Altını çizmek",
  "Underline and Overline": "Alt çizgi ve üst çizgiler",
  "Without Decoration": "Dekorasyon olmadan",
  "Left": "Sol",
  "Angle": "Açılış",
  "Distance": "Mesafe",
  "Blur": "Bulanıklık",
  "Size": "Boyut",
  "Edit individually": "Bireysel olarak düzenleyin",
  "Apply to all corners": "Tüm köşelere uygulayın",
  "Date Box Visual": "Tarih Kutusu Görsel",
  "One Line": "Tek satır",
  "Show Icons": "Simgeleri Göster",
  "Design Settings": "Tasarım Ayarları",
  "Personalize your editor to match your style and preferences, customize every detail in this settings tab !": "Düzenleyicinizi stil ve tercihlerinize uyacak şekilde kişiselleştirin, bu Ayarlar sekmesindeki her ayrıntıyı özelleştirin!",
  "Divider": "Bölücü",
  "Ellipse": "Elips",
  ...
  "Get Tickets Now": "Şimdi bilet al",
  "Get Tickets": "Bilet al",
  "Instant confirmation": "Anında onay",
  "No seats selected": "Koltuk seçilmedi",
  "No tickets available for this event.": "Bu etkinlik için bilet mevcut değil.",
  "No tickets selected": "Bilet seçilmedi",
  "Order Summary": "Sipariş özeti",
  "Payment": "Ödeme",
  "Please enter a valid email": "Lütfen geçerli bir e-posta girin",
  "Please enter your name": "Lütfen adınızı girin",
  "Please select at least one seat": "Lütfen en az bir koltuk seçin",
  ...
  "Select seats above to continue": "Devam etmek için yukarıdan koltuk seçin",
  "Select tickets above to continue": "Devam etmek için yukarıdan bilet seçin",
  "Selected Seats": "Seçilen koltuklar",
  "Service Fee": "Hizmet ücreti",
  "Subtotal": "Ara toplam",
  "Total Amount": "Toplam tutar",
  "View your ticket": "Biletinizi görüntüleyin",
  "each": "her biri",
  "per ticket": "bilet başına",
  "seat": "koltuk",
  "seats": "koltuklar",
