let tl = {
  ...
  "You can move your mouse outside the seatmap while dragging - the selection will still apply when you release.": "Maaari mong igalaw ang iyong mouse sa labas ng seatmap habang kinakaladkad - malalapat pa rin ang napili kapag binitawan mo na.",
  "Tip:": "Tip:",
  "Use the +/- buttons to zoom in and out": "Gamitin ang mga button na +/- para mag-zoom in at mag-zoom out",
  "Click and drag the background to pan around the venue": "I-click at i-drag ang background para mag-pan sa paligid ng lugar",
  "Pan & Zoom": "Pan at Zoom",
  "Capacity is shared across all seatmaps for the same event": "Ang kapasidad ay ibinabahagi sa lahat ng seatmap para sa iisang kaganapan",
  "Use the - button to remove tickets from your selection": "Gamitin ang buton na - para alisin ang mga tiket mula sa iyong napili",
  "Use the + button to add tickets to your selection": "Gamitin ang + button para magdagdag ng mga tiket sa iyong napili",
  "Standing areas show the number of tickets remaining": "Ang mga nakatayong lugar ay nagpapakita ng bilang ng mga tiket na natitira",
  "Standing Areas": "Mga Lugar na Nakatayo",
  "Remove keyboard focus from seats": "Alisin ang focus ng keyboard mula sa mga upuan",
  "Clear Focus": "Malinaw na Pokus",
  "Toggle the focused seat": "I-toggle ang naka-focus na upuan",
  "Select / Deselect Seat": "Piliin / Alisin sa Pagkapili ang Upuan",
  "Move between available seats": "Lumipat sa pagitan ng mga bakanteng upuan",
  "Navigate Seats": "Mag-navigate sa mga Upuan",
  "Use your keyboard to navigate and select seats without a mouse:": "Gamitin ang iyong keyboard para mag-navigate at pumili ng mga upuan nang walang mouse:",
  "Keyboard Navigation": "Nabigasyon sa Keyboard",
  "Click an empty area to deselect all seats": "Mag-click sa isang bakanteng lugar para alisin sa pagkakapili ang lahat ng upuan",
  "Drag across multiple seats to toggle-select them": "I-drag sa maraming upuan para i-toggle-select ang mga ito",
  "Click a selected seat again to deselect it": "I-click muli ang napiling upuan para alisin ito sa pagkakapili",
  "Click a seat to select it": "Mag-click ng upuan para piliin ito",
  "Selecting Seats": "Pagpili ng mga Upuan",
  "How to Select Seats": "Paano Pumili ng mga Upuan",
  "How to Use": "Paano Gamitin",
  "Pay": "Bayad",
  "Book": "Libro",
  "This promo code has already been used": "Nagamit na ang promo code na ito",
  "This promo code is not yet active": "Hindi pa aktibo ang promo code na ito",
  "This promo code has expired": "Nag-expire na ang promo code na ito",
  "Invalid promo code": "Hindi wastong promo code",
  "Credit / Debit Card": "Credit / Debit Card",
  "Fast & secure checkout": "Mabilis at ligtas na pag-checkout",
  "Secure payment via Wix": "Ligtas na pagbabayad gamit ang Wix",
  "Pay at the venue": "Magbayad sa lugar",
  "Registration": "Pagpaparehistro",
  "Attendee Information": "Impormasyon ng Dadalo",
  "Your information is secure and will only be used for event registration": "Ang iyong impormasyon ay ligtas at gagamitin lamang para sa pagpaparehistro ng kaganapan",
  "Your information is secure and will only be used for ticket delivery": "Ang iyong impormasyon ay ligtas at gagamitin lamang para sa paghahatid ng tiket",
  "Register": "Magrehistro",
  "Event is fully booked": "Puno na ang naka-book na kaganapan",
  "To Event": "Sa Kaganapan",
  "Guest Details": "Mga Detalye ng Bisita",
  "Because it was a Draft": "Dahil ito ay isang Draft",
  "You can't see your event": "Hindi mo makita ang iyong kaganapan",
  "The event is currently happening. If you believe this is an error, please contact the event organizer.": "Kasalukuyang nagaganap ang kaganapan. Kung sa tingin mo ay isang pagkakamali ito, mangyaring makipag-ugnayan sa tagapag-ayos ng kaganapan.",
  "Registration is closed because this event has already started.": "Sarado na ang pagpaparehistro dahil nagsimula na ang kaganapang ito.",
  "Event In Progress": "Kaganapang Isinasagawa",
  "The event organizer is still preparing this event. Please check back later or contact the organizer for more information.": "Inihahanda pa rin ng tagapag-organisa ng kaganapan ang kaganapang ito. Mangyaring bumalik muli mamaya o makipag-ugnayan sa tagapag-organisa para sa karagdagang impormasyon.",
  "Event": "Kaganapan",
  "This event is currently in draft mode and not available for registration yet.": "Ang kaganapang ito ay kasalukuyang nasa draft mode at hindi pa maaaring magparehistro.",
  "This event is currently in draft mode and not yet available for viewing.": "Ang kaganapang ito ay kasalukuyang nasa draft mode at hindi pa maaaring mapanood.",
  "Event Not Published": "Hindi Na-publish ang Kaganapan",
  "Draft Mode": "Paraan ng Pagbalangkas",
  "Back": "Balik",
  "Go": "Pumunta",
  "Could not find requested resource": "Hindi mahanap ang hiniling na mapagkukunan",
  "Not Found 404": "Hindi Natagpuan 404",
  "Loading...": "Naglo-load...",
  "Loading": "Naglo-load",
  ...
  "Your information is secure and will only be used for event registration": "Ang iyong impormasyon ay ligtas at gagamitin lamang para sa pagpaparehistro ng kaganapan",
  "Your information is secure and will only be used for ticket delivery": "Ang iyong impormasyon ay ligtas at gagamitin lamang para sa paghahatid ng tiket",
  "per ticket": "bawat tiket",
  "Select tickets above to continue": "Pumili ng mga tiket sa itaas para magpatuloy",
  "Select seats above to continue": "Pumili ng mga upuan sa itaas para magpatuloy",
  "Select Tickets": "Pumili ng mga Tiket",
  "Gallery": "Galeriya",
  "Secure checkout": "Ligtas na pag-checkout",
  "About This Event": "Tungkol sa Kaganapang Ito",
  "Available Spots": "Mga Magagamit na Lugar",
  "TICKET TYPES": "MGA URI NG TICKET",
  ...
  "Sync Date Range": "Saklaw ng Petsa ng Pag-sync",
  "Sync categories": "Mga kategorya ng pag-sync",
  "Hide event description": "Itago ang paglalarawan ng kaganapan",
  "Hide private events": "Itago ang mga pribadong kaganapan",
  "No synchronized calendars yet. Select a calendar above and click Sync to start.": "Wala pang naka-synchronize na mga kalendaryo. Pumili ng kalendaryo sa itaas at i-click ang I-sync para magsimula.",
  "Fetches current events so you can add them one by one.": "Kinukuha ang mga kasalukuyang kaganapan para maidagdag mo ang mga ito isa-isa.",
  "Keeps events continuously updated in real time.": "Pinapanatiling patuloy na na-update ang mga kaganapan sa totoong oras.",
  ...
  "Show events limit": "Ipakita ang limitasyon ng mga kaganapan",
  "Show tooltip/popup": "Ipakita ang tooltip/popup",
  "Bold Monthly Dividers": "Mga Matapang na Buwanang Divider",
  "Scroll to see more events": "Mag-scroll upang makakita ng higit pang mga kaganapan",
  "Show additional date": "Ipakita ang karagdagang petsa",
  ...
  "Reset Layouts Dimensions": "I -reset ang mga sukat ng layout",
  "Clear": "Malinaw",
  "Undo": "I -undo",
  "Redo": "Redo",
  "Code Panel": "Code Panel",
  "Code Panel Notify": "Ang pagbabago ng code nang direkta ay maaaring masira ang pag -andar ng layout o app. I -edit lamang kung alam mo kung ano ang iyong ginagawa!",
  "Clear Editor": "Malinaw na editor",
  "Clear Editor Notify": "Sigurado ka bang nais mong i -clear ang editor? Lahat ng pag -unlad ay mawawala!",
  "Nothing to edit": "Walang mai -edit!",
  "Shapes": "Mga hugis",
  "Delete The Shape": "Tanggalin ang hugis",
  "Add shapes": "Magdagdag ng mga hugis sa pagitan ng mga layout at ipasadya!",
  "Preview unavailable": "Component preview na hindi magagamit para sa sangkap",
  ...
  "Select Font": "Piliin ang font",
  "Font Weight": "Timbang ng font",
  "Font Size": "Laki ng font",
  "Text Alignment": "Pag -align ng teksto",
  "Left Alignment": "Kaliwa alignment",
  "Center Alignment": "Pag -align ng Center",
  "Right Alignment": "Tamang pagkakahanay",
  "Text Decoration": "Dekorasyon ng teksto",
  "Overline": "Overline",
  "Line Through": "Linya sa pamamagitan ng",
  "Underline": "Underline",
  "Underline and Overline": "Salungguhit at overline",
  "Without Decoration": "Nang walang dekorasyon",
  "Left": "Kaliwa",
  "Angle": "Anggulo",
  "Distance": "Malayo",
  "Blur": "Malabo",
  "Size": "Laki",
  "Edit individually": "I -edit nang paisa -isa",
  "Apply to all corners": "Mag -apply sa lahat ng sulok",
  "Date Box Visual": "Petsa ng Visual Visual",
  "One Line": "Isang linya",
  "Show Icons": "Ipakita ang mga icon",
  "Design Settings": "Mga Setting ng Disenyo",
  "Personalize your editor to match your style and preferences, customize every detail in this settings tab !": "Personalize ang iyong editor upang tumugma sa iyong estilo at kagustuhan, ipasadya ang bawat detalye sa tab na ito ng mga setting!",
  "Divider": "Divider",
  "Ellipse": "Ellipse",
  "Rhombus": "Rhombus",
  "Heart": "Puso",
