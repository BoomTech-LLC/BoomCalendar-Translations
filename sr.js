let sr = {
  ...
  "You can move your mouse outside the seatmap while dragging - the selection will still apply when you release.": "Можете померати миш ван мапе седишта док превлачите - избор ће и даље важити када отпустите.",
  "Tip:": "Савет:",
  "Use the +/- buttons to zoom in and out": "Користите дугмад +/- за увећање и умањење",
  "Click and drag the background to pan around the venue": "Кликните и превуците позадину да бисте се кретали по месту одржавања",
  "Pan & Zoom": "Померање и зумирање",
  "Capacity is shared across all seatmaps for the same event": "Капацитет се дели на све мапе седишта за исти догађај",
  "Use the - button to remove tickets from your selection": "Користите дугме - да бисте уклонили карте из вашег избора",
  "Use the + button to add tickets to your selection": "Користите дугме + да бисте додали карте у свој избор",
  "Standing areas show the number of tickets remaining": "Зоне за стајање приказују број преосталих карата",
  "Standing Areas": "Стајаћа места",
  "Remove keyboard focus from seats": "Уклони фокус тастатуре са седишта",
  "Clear Focus": "Јасан фокус",
  "Toggle the focused seat": "Укључи/искључи фокусирано седиште",
  "Select / Deselect Seat": "Изаберите / Поништите избор седишта",
  "Move between available seats": "Премештајте се између доступних седишта",
  "Navigate Seats": "Навигација по седиштима",
  "Use your keyboard to navigate and select seats without a mouse:": "Користите тастатуру за навигацију и избор седишта без миша:",
  "Keyboard Navigation": "Навигација тастатуром",
  "Click an empty area to deselect all seats": "Кликните на празно подручје да бисте поништили избор свих седишта",
  "Drag across multiple seats to toggle-select them": "Превуците преко више седишта да бисте их пребацили/избрали",
  "Click a selected seat again to deselect it": "Кликните поново на изабрано седиште да бисте га опозвали",
  "Click a seat to select it": "Кликните на седиште да бисте га изабрали",
  "Selecting Seats": "Избор седишта",
  "How to Select Seats": "Како одабрати седишта",
  "How to Use": "Како се користи",
  "Pay": "Плати",
  "Book": "Књига",
  "This promo code has already been used": "Овај промотивни код је већ искоришћен",
  "This promo code is not yet active": "Овај промотивни код још није активан",
  "This promo code has expired": "Овај промотивни код је истекао",
  "Invalid promo code": "Неважећи промотивни код",
  "Credit / Debit Card": "Кредитна/дебитна картица",
  "Fast & secure checkout": "Брза и безбедна наплата",
  "Secure payment via Wix": "Безбедно плаћање путем Wix-а",
  "Pay at the venue": "Плаћање на месту одржавања",
  "Registration": "Регистрација",
  "Attendee Information": "Информације о учесницима",
  "Your information is secure and will only be used for event registration": "Ваши подаци су безбедни и биће коришћени само за регистрацију на догађај",
  "Your information is secure and will only be used for ticket delivery": "Ваши подаци су безбедни и биће коришћени само за испоруку карата",
  "Register": "Региструј се",
  "Event is fully booked": "Догађај је потпуно резервисан",
  "To Event": "До догађаја",
  "Guest Details": "Подаци о госту",
  "Because it was a Draft": "Пошто је то био Нацрт",
  "You can't see your event": "Не можете да видите свој догађај",
  "The event is currently happening. If you believe this is an error, please contact the event organizer.": "Догађај је тренутно у току. Ако сматрате да је у питању грешка, контактирајте организатора догађаја.",
  "Registration is closed because this event has already started.": "Регистрација је затворена јер је овај догађај већ почео.",
  "Event In Progress": "Догађај у току",
  "The event organizer is still preparing this event. Please check back later or contact the organizer for more information.": "Организатор догађаја још увек припрема овај догађај. Молимо вас да поново проверите касније или контактирате организатора за више информација.",
  "Event": "Догађај",
  "This event is currently in draft mode and not available for registration yet.": "Овај догађај је тренутно у фази нацрта и још увек није доступан за регистрацију.",
  "This event is currently in draft mode and not yet available for viewing.": "Овај догађај је тренутно у нацрту и још увек није доступан за преглед.",
  "Event Not Published": "Догађај није објављен",
  "Draft Mode": "Нацртни режим",
  "Back": "Назад",
  "Go": "Иди",
  "Could not find requested resource": "Није могуће пронаћи тражени ресурс",
  "Not Found 404": "Није пронађено 404",
  "Loading...": "Учитавање...",
  "Loading": "Учитавање",
  ...
  "Your information is secure and will only be used for ticket delivery": "Ваши подаци су безбедни и биће коришћени само за испоруку карата",
  "per ticket": "по карти",
  "Select tickets above to continue": "Изаберите карте изнад да бисте наставили",
  "Select seats above to continue": "Изаберите седишта изнад да бисте наставили",
  "Select Tickets": "Изаберите карте",
  "Gallery": "Галерија",
  "Secure checkout": "Безбедна наплата",
  "About This Event": "О овом догађају",
  "Available Spots": "Доступна места",
  "TICKET TYPES": "ВРСТЕ КАРТИ",
  "TICKET TYPE": "ТИП КАРТЕ",
  "Sync": "Синхронизација",
  "Connected": "Повезано",
  "Removes the connection to your Google account. Previously imported events will remain on your calendar.": "Уклања везу са вашим Google налогом. Претходно увезени догађаји ће остати у вашем календару.",
  "A wider range means more events to load. If your calendar feels slow, try narrowing the range to match the view you use most (e.g. monthly view needs a shorter range than yearly).": "Шири опсег значи више догађаја за учитавање. Ако вам се календар чини спорим, покушајте да сузите опсег како би одговарао приказу који највише користите (нпр. месечни приказ захтева краћи опсег од годишњег).",
  "Sync Date Range": "Синхронизација периода",
  "Sync categories": "Синхронизуј категорије",
  "Hide event description": "Сакриј опис догађаја",
  "Hide private events": "Сакриј приватне догађаје",
  "No synchronized calendars yet. Select a calendar above and click Sync to start.": "Још увек нема синхронизованих календара. Изаберите календар изнад и кликните на Синхронизуј да бисте започели.",
  "Fetches current events so you can add them one by one.": "Преузима тренутне догађаје тако да их можете додавати један по један.",
  "Keeps events continuously updated in real time.": "Континуирано ажурира догађаје у реалном времену.",
  ...
  "Cross Event Limit": "Ограничење унакрсних догађаја",
  "Show events limit": "Прикажи ограничење догађаја",
  "Show tooltip/popup": "Прикажи опис алата/искачући прозор",
  "Bold Monthly Dividers": "Подебљани месечни разделници",
  "Scroll to see more events": "Померите се да видите још догађаја",
  "Show additional date": "Прикажи додатни датум",
  ...
  "Reset Layouts Dimensions": "Поништи димензије распореда",
  "Clear": "Чист",
  "Undo": "Поништити",
  "Redo": "Поново",
  "Code Panel": "Панел кода",
  "Code Panel Notify": "Модификовани код директно може да прекине функцију распореда или апликације. Уредите само ако знате шта радите!",
  "Clear Editor": "Јасан уредник",
  "Clear Editor Notify": "Јесте ли сигурни да желите да очистите уредника? Сав напредак ће се изгубити!",
  "Nothing to edit": "Не постоји ништа за уређивање!",
  "Shapes": "Облика",
  "Delete The Shape": "Избришите облик",
  "Add shapes": "Додајте облике између изгледа и прилагођавање!",
  "Preview unavailable": "Преглед компоненте Није доступно за компоненту",
  ...
  "Select Font": "Изаберите фонт",
  "Font Weight": "Тежина фонта",
  "Font Size": "Величина фонта",
  "Text Alignment": "Поравнавање текста",
  "Left Alignment": "Лево поравнање",
  "Center Alignment": "Усклађивање",
  "Right Alignment": "Право поравнање",
  "Text Decoration": "Декорација текста",
  "Overline": "Преплашити",
  "Line Through": "Пролазни",
  "Underline": "Подвући",
  "Underline and Overline": "Подвлачење и прекривање",
  "Without Decoration": "Без украса",
  "Left": "Лево",
  "Angle": "Угао",
  "Distance": "Растојање",
  "Blur": "Замутити",
  "Size": "Величина",
  "Edit individually": "Уредите појединачно",
  "Apply to all corners": "Пријавите се на све углове",
  "Date Box Visual": "Кутија за датум Висуал",
  "One Line": "Један ред",
  "Show Icons": "Прикажи иконе",
  "Design Settings": "Подешавања дизајна",
  "Personalize your editor to match your style and preferences, customize every detail in this settings tab !": "Персонализујте свој уредник да одговара вашем стилу и склоностима, прилагодите сваку детаљу у овој картици Подешавања!",
  "Divider": "Дељење",
  "Ellipse": "Елипса",
  "Rhombus": "Ромб",
  "Heart": "Срце",
