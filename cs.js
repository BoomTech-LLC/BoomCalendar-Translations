let cs = {
  ...
  "You can move your mouse outside the seatmap while dragging - the selection will still apply when you release.": "Během tažení můžete myší pohybovat mimo mapu sedadel – výběr zůstane platný i po uvolnění myši.",
  "Tip:": "Tip:",
  "Use the +/- buttons to zoom in and out": "Pro přiblížení a oddálení použijte tlačítka +/-",
  "Click and drag the background to pan around the venue": "Klikněte a přetáhněte pozadí pro posouvání po místě konání",
  "Pan & Zoom": "Posunout a přiblížit",
  "Capacity is shared across all seatmaps for the same event": "Kapacita je sdílena mezi všemi mapami sedadel pro stejnou akci",
  "Use the - button to remove tickets from your selection": "Pomocí tlačítka - odeberete vstupenky z výběru.",
  "Use the + button to add tickets to your selection": "Pomocí tlačítka + přidejte vstupenky do svého výběru",
  "Standing areas show the number of tickets remaining": "V místech k stání je uveden počet zbývajících vstupenek",
  "Standing Areas": "Prostory pro stání",
  "Remove keyboard focus from seats": "Odebrat fokus klávesnice ze sedadel",
  "Clear Focus": "Jasné zaostření",
  "Toggle the focused seat": "Přepnout zaostřené sedadlo",
  "Select / Deselect Seat": "Vybrat / Zrušit výběr sedadla",
  "Move between available seats": "Přecházení mezi dostupnými sedadly",
  "Navigate Seats": "Navigace sedadel",
  "Use your keyboard to navigate and select seats without a mouse:": "Pro navigaci a výběr sedadel bez myši použijte klávesnici:",
  "Keyboard Navigation": "Navigace na klávesnici",
  "Click an empty area to deselect all seats": "Kliknutím na prázdné místo zrušíte výběr všech sedadel.",
  "Drag across multiple seats to toggle-select them": "Přetažením přes více sedadel je můžete přepínat mezi jejich výběrem",
  "Click a selected seat again to deselect it": "Dalším kliknutím na vybrané sedadlo jeho výběr zrušíte.",
  "Click a seat to select it": "Kliknutím na sedadlo jej vyberete",
  "Selecting Seats": "Výběr sedadel",
  "How to Select Seats": "Jak vybrat sedadla",
  "How to Use": "Jak používat",
  "Pay": "Platit",
  "Book": "Rezervovat",
  "This promo code has already been used": "Tento promo kód již byl použit",
  "This promo code is not yet active": "Tento promo kód ještě není aktivní",
  "This promo code has expired": "Platnost tohoto promo kódu vypršela.",
  "Invalid promo code": "Neplatný promo kód",
  "Credit / Debit Card": "Kreditní / Debetní karta",
  "Fast & secure checkout": "Rychlá a bezpečná pokladna",
  "Secure payment via Wix": "Bezpečná platba přes Wix",
  "Pay at the venue": "Platba na místě konání",
  "Registration": "Registrace",
  "Attendee Information": "Informace pro účastníky",
  "Your information is secure and will only be used for event registration": "Vaše informace jsou v bezpečí a budou použity pouze k registraci na akci",
  "Your information is secure and will only be used for ticket delivery": "Vaše informace jsou v bezpečí a budou použity pouze k doručení vstupenek",
  "Register": "Rejstřík",
  "Event is fully booked": "Akce je plně rezervována",
  "To Event": "K události",
  "Guest Details": "Podrobnosti o hostovi",
  "Because it was a Draft": "Protože to byl návrh",
  "You can't see your event": "Nevidíte svou událost",
  "The event is currently happening. If you believe this is an error, please contact the event organizer.": "Akce právě probíhá. Pokud se domníváte, že se jedná o chybu, kontaktujte prosím organizátora akce.",
  "Registration is closed because this event has already started.": "Registrace je uzavřena, protože tato akce již začala.",
  "Event In Progress": "Probíhající událost",
  "The event organizer is still preparing this event. Please check back later or contact the organizer for more information.": "Organizátor akce tuto událost stále připravuje. Zkuste to prosím později nebo kontaktujte organizátora pro více informací.",
  "Event": "Událost",
  "This event is currently in draft mode and not available for registration yet.": "Tato událost je momentálně ve fázi návrhu a zatím na ni není možné se registrovat.",
  "This event is currently in draft mode and not yet available for viewing.": "Tato událost je momentálně ve fázi návrhu a zatím není k dispozici k prohlížení.",
  "Event Not Published": "Událost nebyla zveřejněna",
  "Draft Mode": "Režim konceptu",
  "Back": "Zadní",
  "Go": "Jít",
  "Could not find requested resource": "Nepodařilo se najít požadovaný zdroj",
  ...
  "Your information is secure and will only be used for event registration": "Vaše informace jsou v bezpečí a budou použity pouze k registraci na akci",
  "Your information is secure and will only be used for ticket delivery": "Vaše informace jsou v bezpečí a budou použity pouze k doručení vstupenek",
  "per ticket": "za lístek",
  "Select tickets above to continue": "Pro pokračování vyberte výše uvedené vstupenky",
  "Select seats above to continue": "Pro pokračování vyberte výše uvedená sedadla.",
  "Select Tickets": "Vyberte vstupenky",
  "Gallery": "Galerie",
  "Secure checkout": "Bezpečná pokladna",
  "About This Event": "O této události",
  "Available Spots": "Volná místa",
  "TICKET TYPES": "TYPY VSTUPENEK",
  "TICKET TYPE": "TYP VSTUPENKY",
  "Sync": "Synchronizace",
  "Connected": "Připojeno",
  ...
  "Sync Date Range": "Synchronizační období",
  "Sync categories": "Synchronizace kategorií",
  "Hide event description": "Skrýt popis události",
  "Hide private events": "Skrýt soukromé události",
  "No synchronized calendars yet. Select a calendar above and click Sync to start.": "Zatím nejsou synchronizovány žádné kalendáře. Vyberte kalendář výše a kliknutím na tlačítko Synchronizovat spusťte synchronizaci.",
  "Fetches current events so you can add them one by one.": "Načítá aktuální události, abyste je mohli přidávat jednu po druhé.",
  "Keeps events continuously updated in real time.": "Udržuje události průběžně aktualizované v reálném čase.",
  "Your Api Key": "Váš klíč Api",
  "Fahrenheit": "Fahrenheita",
  "Celsius": "Celsia",
  "Select the city from the suggestions": "Vyberte město z návrhů",
  "Weather Forecast": "Předpověď počasí",
  "Cross Event Limit": "Limit křížových událostí",
  "Show events limit": "Zobrazit limit událostí",
  "Show tooltip/popup": "Zobrazit popisek/vyskakovací okno",
  "Bold Monthly Dividers": "Tučné měsíční oddělovače",
  "Scroll to see more events": "Posouváním zobrazíte další události",
  "Show additional date": "Zobrazit další datum",
  ...
  "Reset Layouts Dimensions": "RESET LADEOUTS ROZDĚLENÍ",
  "Clear": "Jasný",
  "Undo": "Undo",
  "Redo": "Předělat",
  "Code Panel": "Kódový panel",
  "Code Panel Notify": "Přímo úprava kódu může porušit funkčnost rozvržení nebo aplikace. Upravit pouze pokud víte, co děláte!",
  "Clear Editor": "Clear Editor",
  "Clear Editor Notify": "Jste si jisti, že chcete vyčistit editor? Veškerý pokrok bude ztracen!",
  "Nothing to edit": "Není co upravit!",
  "Shapes": "Tvary",
  "Delete The Shape": "Smazat tvar",
  "Add shapes": "Přidejte tvary mezi rozvrženími a přizpůsobte!",
  "Preview unavailable": "Náhled komponenty není k dispozici pro komponentu",
  ...
  "Font Weight": "Hmotnost písma",
  "Font Size": "Velikost písma",
  "Text Alignment": "Zarovnání textu",
  "Left Alignment": "Levé zarovnání",
  "Center Alignment": "Zarovnání středu",
  "Right Alignment": "Správné zarovnání",
  "Text Decoration": "Textová dekorace",
  "Overline": "Nadline",
  "Line Through": "Line skrz",
  "Underline": "Zdůraznit",
  "Underline and Overline": "Podtrhnout a podtrhnout",
  "Without Decoration": "Bez dekorace",
  "Left": "Vlevo",
  "Angle": "Úhel",
  "Distance": "Vzdálenost",
  "Blur": "Rozmazat",
  "Size": "Velikost",
  "Edit individually": "Upravit individuálně",
  "Apply to all corners": "Aplikujte na všechny rohy",
  "Date Box Visual": "Vizuální pole pro datum",
  "One Line": "Jedna linie",
  "Show Icons": "Zobrazit ikony",
  "Design Settings": "Nastavení návrhu",
  "Personalize your editor to match your style and preferences, customize every detail in this settings tab !": "Přizpůsobte si editor tak, aby odpovídal vašemu stylu a preferencím, přizpůsobte každý detail na kartě Nastavení!",
  "Divider": "Dělič",
  "Ellipse": "Elipsa",
  "Rhombus": "Kosočtverec",
  "Heart": "Srdce",
  ...
  "Free admission": "Vstup zdarma",
  "Get Tickets Now": "Získat vstupenky",
  "Get Tickets": "Získat vstupenky",
  "Instant confirmation": "Okamžité potvrzení",
  "No seats selected": "Žádná místa nevybrána",
  "No tickets available for this event.": "Na tuto událost nejsou k dispozici žádné vstupenky.",
  "No tickets selected": "Žádné vstupenky nevybrány",
  ...
  "Please select at least one seat": "Vyberte prosím alespoň jedno místo",
  "Register Now": "Registrovat se",
  "Registration Complete": "Registrace dokončena",
  "Secure checkout": "Bezpečná platba",
  "Select Tickets": "Vybrat vstupenky",
  "Select Your Seats": "Vyberte si místa",
  "Select seats above to continue": "Pro pokračování vyberte místa výše",
  "Select tickets above to continue": "Pro pokračování vyberte vstupenky výše",
  "Selected Seats": "Vybraná místa",
  "Service Fee": "Servisní poplatek",
  "Subtotal": "Mezisoučet",
  "Total Amount": "Celková částka",
  "View your ticket": "Zobrazit vstupenku",
  "each": "každý",
  "per ticket": "za vstupenku",
  "seat": "místo",
  "seats": "místa",
  "selected": "vybráno",
  "ticket": "vstupenka",
