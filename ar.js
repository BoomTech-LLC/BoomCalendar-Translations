let ar = {
  ...
  "You can move your mouse outside the seatmap while dragging - the selection will still apply when you release.": "يمكنك تحريك مؤشر الماوس خارج خريطة المقاعد أثناء السحب - سيظل التحديد ساريًا عند الإفلات.",
  "Tip:": "نصيحة:",
  "Use the +/- buttons to zoom in and out": "استخدم زري +/- للتكبير والتصغير",
  "Click and drag the background to pan around the venue": "انقر واسحب الخلفية للتنقل حول المكان",
  "Pan & Zoom": "التحريك والتكبير",
  "Capacity is shared across all seatmaps for the same event": "يتم توزيع السعة على جميع خرائط المقاعد لنفس الحدث",
  "Use the - button to remove tickets from your selection": "استخدم زر "-" لإزالة التذاكر من اختيارك",
  "Use the + button to add tickets to your selection": "استخدم زر "+" لإضافة تذاكر إلى اختيارك",
  "Standing areas show the number of tickets remaining": "مناطق الوقوف توضح عدد التذاكر المتبقية",
  "Standing Areas": "مناطق الوقوف",
  "Remove keyboard focus from seats": "إزالة تركيز لوحة المفاتيح من المقاعد",
  "Clear Focus": "تركيز واضح",
  "Toggle the focused seat": "قم بتبديل وضع التركيز",
  "Select / Deselect Seat": "تحديد / إلغاء تحديد المقعد",
  "Move between available seats": "انتقل بين المقاعد المتاحة",
  "Navigate Seats": "تصفح المقاعد",
  "Use your keyboard to navigate and select seats without a mouse:": "استخدم لوحة المفاتيح للتنقل واختيار المقاعد بدون استخدام الماوس:",
  "Keyboard Navigation": "التنقل باستخدام لوحة المفاتيح",
  "Click an empty area to deselect all seats": "انقر على منطقة فارغة لإلغاء تحديد جميع المقاعد",
  "Drag across multiple seats to toggle-select them": "اسحب عبر عدة مقاعد لتحديدها بشكل مؤقت",
  "Click a selected seat again to deselect it": "انقر على المقعد المحدد مرة أخرى لإلغاء تحديده",
  "Click a seat to select it": "انقر على مقعد لتحديده",
  "Selecting Seats": "اختيار المقاعد",
  "How to Select Seats": "كيفية اختيار المقاعد",
  "How to Use": "كيفية الاستخدام",
  "Pay": "يدفع",
  "Book": "كتاب",
  "This promo code has already been used": "تم استخدام رمز الخصم هذا بالفعل",
  "This promo code is not yet active": "رمز الخصم هذا غير فعال بعد",
  "This promo code has expired": "انتهت صلاحية رمز الخصم هذا",
  "Invalid promo code": "رمز ترويجي غير صالح",
  "Credit / Debit Card": "بطاقة ائتمان / بطاقة خصم",
  "Fast & secure checkout": "عملية دفع سريعة وآمنة",
  "Secure payment via Wix": "دفع آمن عبر Wix",
  "Pay at the venue": "ادفع في مكان الفعالية",
  "Registration": "تسجيل",
  "Attendee Information": "معلومات الحضور",
  "Your information is secure and will only be used for event registration": "معلوماتك آمنة ولن تُستخدم إلا لتسجيل الحضور في الفعالية",
  "Your information is secure and will only be used for ticket delivery": "معلوماتك آمنة ولن تُستخدم إلا لتسليم التذاكر",
  "Register": "يسجل",
  "Event is fully booked": "تم حجز جميع تذاكر الفعالية",
  "To Event": "توهين",
  "Guest Details": "تفاصيل الضيف",
  "Because it was a Draft": "لأنه كان مسودة",
  "You can't see your event": "لا يمكنك رؤية الحدث الخاص بك",
  "The event is currently happening. If you believe this is an error, please contact the event organizer.": "الفعالية جارية حالياً. إذا كنت تعتقد أن هذا خطأ، يُرجى التواصل مع منظم الفعالية.",
  "Registration is closed because this event has already started.": "تم إغلاق التسجيل لأن هذا الحدث قد بدأ بالفعل.",
  "Event In Progress": "القسم قيد التنفيذ",
  "The event organizer is still preparing this event. Please check back later or contact the organizer for more information.": "لا يزال منظم الفعالية يعمل على تجهيزها. يرجى مراجعة الموقع لاحقًا أو التواصل مع المنظم لمزيد من المعلومات.",
  "Event": "حدث",
  "This event is currently in draft mode and not available for registration yet.": "هذا الحدث حاليًا في مرحلة المسودة وغير متاح للتسجيل بعد.",
  "This event is currently in draft mode and not yet available for viewing.": "هذا الحدث حاليًا في وضع المسودة ولم يُعرض بعد.",
  "Event Not Published": "الحدث غير منشور",
  "Draft Mode": "وضع المسودة",
  "Back": "خلف",
  "Go": "يذهب",
  "Could not find requested resource": "تعذر العثور على المورد المطلوب",
  "Not Found 404": "غير موجود 404",
  "Loading...": "تحميل...",
  "Loading": "تحميل",
  ...
  "Select tickets above to continue": "اختر التذاكر أعلاه للمتابعة",
  "Select seats above to continue": "اختر المقاعد أعلاه للمتابعة",
  "Select Tickets": "اختر التذاكر",
  "Gallery": "معرض",
  "Secure checkout": "عملية دفع آمنة",
  ...
  "Sync Date Range": "مزامنة نطاق التاريخ",
  ...
  "Cross Event Limit": "حد الحدث المتقاطع",
  "Show events limit": "إظهار حد الأحداث",
  "Show tooltip/popup": "إظهار تلميح الأدوات/النافذة المنبثقة",
  "Bold Monthly Dividers": "فواصل شهرية جريئة",
  "Scroll to see more events": "قم بالتمرير لرؤية المزيد من الأحداث",
  "Show additional date": "إظهار التاريخ الإضافي",
  ...
  "Reset Layouts Dimensions": "إعادة تعيين أبعاد التخطيطات",
  "Clear": "واضح",
  "Undo": "تراجع",
  "Redo": "إعادة",
  "Code Panel": "لوحة الكود",
  "Code Panel Notify": "قد يؤدي تعديل الكود مباشرة إلى كسر وظيفة التخطيط أو التطبيق. قم بتحرير فقط إذا كنت تعرف ما تفعله!",
  "Clear Editor": "محرر واضح",
  "Clear Editor Notify": "هل أنت متأكد من أنك تريد مسح المحرر؟ سيتم فقد كل التقدم!",
  "Nothing to edit": "لا يوجد شيء لتحريره!",
  "Shapes": "الأشكال",
  "Delete The Shape": "حذف الشكل",
  "Add shapes": "إضافة الأشكال بين التخطيطات والتخصيص!",
  "Preview unavailable": "معاينة المكون غير متوفرة للمكون",
  ...
  "Left Alignment": "محاذاة اليسار",
  "Center Alignment": "محاذاة المركز",
  "Right Alignment": "المحاذاة الصحيحة",
  "Text Decoration": "زخرفة النص",
  "Overline": "أجمل",
  "Line Through": "خط من خلال",
  "Underline": "تسطير",
  "Underline and Overline": "تسطير وأمر",
  "Without Decoration": "بدون زخرفة",
  "Left": "غادر",
  "Angle": "زاوية",
  "Distance": "مسافة",
  "Blur": "طمس",
  "Size": "مقاس",
  "Edit individually": "تحرير بشكل فردي",
  "Apply to all corners": "تنطبق على جميع الزوايا",
  "Date Box Visual": "مربع التاريخ المرئي",
  "One Line": "سطر واحد",
  ...
  "Get Tickets Now": "احصل على التذاكر الآن",
  "Get Tickets": "احصل على التذاكر",
  "Instant confirmation": "تأكيد فوري",
  "No seats selected": "لم يتم اختيار مقاعد",
  "No tickets available for this event.": "لا تتوفر تذاكر لهذا الحدث.",
