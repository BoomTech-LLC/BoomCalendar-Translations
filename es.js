let es = {
  "Missing guest ID": "Falta el ID del huésped",
  "Failed to fetch guest data": "No se pudieron obtener los datos del invitado.",
  "Failed to fetch tickets": "No se pudieron obtener los boletos",
  "Failed to load ticket data": "No se pudieron cargar los datos del ticket.",
  "Ticket already bought": "Entrada ya comprada",
  "Select Your Seats": "Seleccione sus asientos",
  "Ticket Details": "Detalles de la entrada",
  "Per-Ticket QR Codes": "Códigos QR por boleto",
  "each": "cada",
  "Service Fee": "Tarifa de servicio",
  "Subtotal": "Total parcial",
  "Email Address": "Dirección de correo electrónico",
  "Find your printable e-tickets attached to the confirmation email": "Encontrará sus entradas electrónicas imprimibles adjuntas al correo electrónico de confirmación.",
  "Thank you for your purchase!": "¡Gracias por su compra!",
  "You can move your mouse outside the seatmap while dragging - the selection will still apply when you release.": "Puedes mover el ratón fuera del mapa de asientos mientras lo arrastras; la selección seguirá aplicándose cuando lo sueltes.",
  "Tip:": "Consejo:",
  "Use the +/- buttons to zoom in and out": "Utilice los botones +/- para acercar y alejar la imagen.",
  "Click and drag the background to pan around the venue": "Haz clic y arrastra el fondo para desplazarte por el lugar.",
  "Pan & Zoom": "Desplazamiento y zoom",
  "Capacity is shared across all seatmaps for the same event": "La capacidad se comparte entre todos los planos de asientos para el mismo evento.",
  "Use the - button to remove tickets from your selection": "Utilice el botón - para eliminar entradas de su selección.",
  "Use the + button to add tickets to your selection": "Utilice el botón + para añadir entradas a su selección.",
  "Standing areas show the number of tickets remaining": "Las zonas de pie muestran el número de entradas restantes.",
  "Standing Areas": "Áreas para estar de pie",
  "Remove keyboard focus from seats": "Quitar el foco del teclado de los asientos",
  "Clear Focus": "Enfoque claro",
  "Toggle the focused seat": "Activar/desactivar el asiento enfocado",
  "Select / Deselect Seat": "Seleccionar/Deseleccionar asiento",
  "Move between available seats": "Muévase entre los asientos disponibles.",
  "Navigate Seats": "Navegar por los asientos",
  "Use your keyboard to navigate and select seats without a mouse:": "Utilice el teclado para navegar y seleccionar asientos sin necesidad de usar el ratón:",
  "Keyboard Navigation": "Navegación con teclado",
  "Click an empty area to deselect all seats": "Haz clic en un área vacía para deseleccionar todos los asientos.",
  "Drag across multiple seats to toggle-select them": "Arrastra el dedo sobre varios asientos para seleccionarlos o alternarlos.",
  "Click a selected seat again to deselect it": "Haz clic de nuevo en el asiento seleccionado para deseleccionarlo.",
  "Click a seat to select it": "Haz clic en un asiento para seleccionarlo.",
  "Selecting Seats": "Selección de asientos",
  "How to Select Seats": "Cómo seleccionar asientos",
  "How to Use": "Cómo usar",
  "Pay": "Pagar",
  "Book": "Libro",
  "This promo code has already been used": "Este código promocional ya ha sido utilizado.",
  "This promo code is not yet active": "Este código promocional aún no está activo.",
  "This promo code has expired": "Este código promocional ha caducado.",
  "Invalid promo code": "Código promocional no válido",
  "Credit / Debit Card": "Tarjeta de crédito/débito",
  "Fast & secure checkout": "Pago rápido y seguro",
  "Secure payment via Wix": "Pago seguro a través de Wix",
  "Pay at the venue": "Pagar en el lugar",
  "Registration": "Registro",
  "Attendee Information": "Información para los asistentes",
  "Your information is secure and will only be used for event registration": "Su información es segura y solo se utilizará para el registro del evento.",
  "Your information is secure and will only be used for ticket delivery": "Su información es segura y solo se utilizará para la entrega de entradas.",
  "Register": "Registro",
  "Event is fully booked": "El evento está completo.",
  "To Event": "Para el evento",
  "Guest Details": "Detalles del huésped",
  "Because it was a Draft": "Porque era un borrador",
  "You can't see your event": "No puedes ver tu evento.",
  "The event is currently happening. If you believe this is an error, please contact the event organizer.": "El evento está teniendo lugar en este momento. Si cree que se trata de un error, póngase en contacto con el organizador.",
  "Registration is closed because this event has already started.": "Las inscripciones están cerradas porque este evento ya ha comenzado.",
  "Event In Progress": "Evento en curso",
  "The event organizer is still preparing this event. Please check back later or contact the organizer for more information.": "El organizador aún está preparando el evento. Vuelva a consultar más tarde o póngase en contacto con el organizador para obtener más información.",
  "Event": "Evento",
  "This event is currently in draft mode and not available for registration yet.": "Este evento se encuentra actualmente en fase de borrador y aún no está disponible para su inscripción.",
  "This event is currently in draft mode and not yet available for viewing.": "Este evento se encuentra actualmente en fase de borrador y aún no está disponible para su visualización.",
  "Event Not Published": "Evento no publicado",
  "Draft Mode": "Modo borrador",
  "Back": "Atrás",
  "Go": "Ir",
  "Could not find requested resource": "No se pudo encontrar el recurso solicitado.",
  "Not Found 404": "No encontrado 404",
  "Loading...": "Cargando...",
  "Loading": "Cargando",
  ...
  "Select tickets above to continue": "Seleccione las entradas de arriba para continuar.",
  "Select seats above to continue": "Seleccione los asientos de arriba para continuar.",
  ...
  "Sync Date Range": "Sincronizar rango de fechas",
  "Sync categories": "Categorías de sincronización",
  "Hide event description": "Ocultar la descripción del evento",
  "Hide private events": "Ocultar eventos privados",
  "No synchronized calendars yet. Select a calendar above and click Sync to start.": "Aún no hay calendarios sincronizados. Selecciona un calendario arriba y haz clic en Sincronizar para empezar.",
  "Fetches current events so you can add them one by one.": "Obtiene eventos actuales para que puedas agregarlos uno por uno.",
  "Keeps events continuously updated in real time.": "Mantiene los eventos actualizados continuamente en tiempo real.",
  "Your Api Key": "Su clave API",
  "Fahrenheit": "Fahrenheit",
  "Celsius": "Celsius",
  "Select the city from the suggestions": "Seleccione la ciudad de las sugerencias",
  "Weather Forecast": "Pronóstico del tiempo",
  "Cross Event Limit": "Límite de eventos cruzados",
  "Show events limit": "Mostrar límite de eventos",
  "Show tooltip/popup": "Mostrar información sobre herramientas/ventana emergente",
  "Bold Monthly Dividers": "Divisores mensuales en negrita",
  "Scroll to see more events": "Desplácese para ver más eventos",
  "Show additional date": "Mostrar fecha adicional",
  ...
  "Select Categories to display events related to them, or manually choose specific events under Events":
    "Seleccione Categorías para mostrar eventos relacionados con ellas, o elija manualmente eventos específicos en Eventos",
  "Automatically approve events from these addresses":
    "Aprobar automáticamente eventos de estas direcciones",
  ...
  "Ticket Tailor sync allows you to integrate your events and sessions with your Boom Calendar.":
    "La sincronización de Ticket Tailor le permite integrar sus eventos y sesiones con su Boom Calendar.",
  "Show event time next to title. This setting is only applicable to the Monthly, Daily, and Weekly views.":
    "Mostrar la hora del evento junto al título. Esta configuración solo se aplica a las vistas Mensual, Diaria y Semanal.",
  ...
  "You are about to change the details of your event. Once changed, your guest list will be lost.":
    "Estás a punto de cambiar los detalles de tu evento. Una vez modificada, su lista de invitados se perderá.",
  ...
  "Do you really want to delete selected user? Once removed, cannot be undone.":
    "¿Realmente desea eliminar el usuario seleccionado? Una vez eliminado, no se puede deshacer.",
  "Delete Guest": "Eliminar invitado",
  "Invoice number": "Número de factura",
  Status: "Estado",
  "Payment type": "Tipo de pago",
  "Select payment method to receive fees through tickets":
    "Seleccione método de pago para recibir tarifas a través de boletos",
  ...
  "Participation tickets for your event":
    "Entradas de participación para tu evento.",
  ...
  "Enable and configure your ticketing system":
    "Habilite y configure su sistema de tickets",
  ...
  "Click on the toggle buttons next to each field to add it to your registration form. If you want to make the field required, click on the asterisk (*).":
    "Haga clic en los botones de alternancia al lado de cada campo para agregarlo a su formulario de registro. Si desea que el campo sea obligatorio, haga clic en el asterisco (*).",
  ...
  "Configure your registration form fields":
    "Configure los campos de su formulario de registro",
  ...
  "Click to activate registration on this event":
    "Haga clic para activar el registro en este evento.",
  "Customize the general settings of registration":
    "Personaliza la configuración general de registro.",
  "Enter URL": "Introducir URL",
  "Page URL": "URL de la página",
  "Close registration when the event starts":
    "Cerrar inscripción cuando comience el evento",
  ...
  "Open event registration landing page":
    "Abrir página de inicio de registro de eventos",
  ...
  "Do you really want to delete selected event? Once removed, cannot be undone":
    "¿Realmente desea eliminar el evento seleccionado? Una vez eliminado, no se puede deshacer",
  ...
  "Making Changes to your synced calendar with the following links. Please review your changes carefully.":
    "Realizar cambios en su calendario sincronizado con los siguientes enlaces. Por favor revise sus cambios cuidadosamente.",
  ...
  "This service is fully booked.":
    "Este servicio está completamente reservado.",
  "All sessions are fully booked.":
    "Todas las sesiones están completamente reservadas.",
  "Registration closed": "Registro cerrado",
  "Show your Wix Bookings or Events on Calendar":
    "Muestre sus reservas o eventos de Wix en el calendario",
  "Choose Auto for automatic display of all services and sessions on the calendar, or Manual for manual selection.":
    "Elija Auto para la visualización automática de todos los servicios y sesiones en el calendario, o manual para la selección manual.",
  ...
  "Choose Auto for automatic display of all events on the calendar, or Manual for manual selection.":
    "Elija Auto para la visualización automática de todos los eventos en el calendario, o manual para la selección manual.",
  Auto: "Auto",
  "Choose Auto for automatic display of all organizations and organizers on the calendar, or Manual for manual selection.":
    "Elija Auto para la visualización automática de todas las organizaciones y organizadores en el calendario, o manual para la selección manual.",
  Manual: "Manual",
  ...
  "Showcase the category filter at the top or at the bottom of the calendar. The settings applies to Agenda, Cross, Timeline and Card views only":
    "Muestre el filtro de categoría en la parte superior o en la parte inferior del calendario. La configuración se aplica solo a las vistas de agenda, cruz, línea de tiempo y tarjeta",
  ...
  "Once enabled, your calendar widget will be translated based on the website’s language. Please note that as long as calendar titles and descriptions are entered as text, they cannot be translated.":
    "Una vez habilitado, su widget de calendario se traducirá en función del idioma del sitio web. Tenga en cuenta que mientras los títulos y descripciones de calendario se ingresen como texto, no se pueden traducir.",
  ...
  "script disappear":
    "Este script no existe, ¡agregue el script en su análisis de Google!",
  "Reset Layouts Dimensions": "Restablecer Dimensiones de diseños",
  Clear: "Claro",
  Undo: "Deshacer",
  Redo: "Rehacer",
  "Code Panel": "Panel de código",
  "Code Panel Notify":
    "El código de modificación directamente puede romper el diseño o la funcionalidad de la aplicación. ¡Solo edite si sabes lo que estás haciendo!",
  "Clear Editor": "Editor claro",
  "Clear Editor Notify":
    "¿Estás seguro de que quieres borrar el editor? ¡Todo el progreso se perderá!",
  "Nothing to edit": "¡No hay nada para editar!",
  Shapes: "Formas",
  "Delete The Shape": "Eliminar la forma",
  "Add shapes": "¡Agregue formas entre diseños y personalice!",
  "Preview unavailable":
    "Vista previa del componente no disponible para componente",
  "component removed": "componente eliminado del editor.",
  "component duplicate": "Componente agregado, Nota: ¡Entrada duplicada!",
  "component added": "componente agregado con éxito al editor.",
  "Component Preview": "Vista previa de componentes",
  Height: "Altura",
  ...
  "Left Alignment": "Alineación de izquierda",
  ...
  "Line Through": "Atacar",
  Underline: "Subrayar",
  "Underline and Overline": "Subrayar y superar",
  "Without Decoration": "Sin decoración",
  Left: "Izquierda",
  Angle: "Ángulo",
  Distance: "Distancia",
  Blur: "Difuminar",
  ...
  "Apply to all corners": "Aplicar a todas las esquinas",
  "Date Box Visual": "Cajero de citas visual",
  "One Line": "Una línea",
  ...
  "Personalize your editor to match your style and preferences, customize every detail in this settings tab !":
    "Personalice su editor para que coincida con su estilo y preferencias, ¡personalice cada detalle en esta pestaña Configuración!",
  Divider: "Divisor",
  Ellipse: "Elipse",
  Rhombus: "Rombo",
  Heart: "Corazón",
  ...
  "Get Tickets Now": "Obtener entradas ahora",
  "Get Tickets": "Obtener entradas",
  "Instant confirmation": "Confirmación instantánea",
  "No seats selected": "No hay asientos seleccionados",
  "No tickets available for this event.": "No hay entradas disponibles para este evento.",
  "No tickets selected": "No hay entradas seleccionadas",
  "Order Summary": "Resumen del pedido",
  "Payment": "Pago",
  ...
  "Please select at least one seat": "Por favor seleccione al menos un asiento",
  "Register Now": "Regístrese ahora",
  "Registration Complete": "Registro completado",
  "Secure checkout": "Pago seguro",
  "Select Tickets": "Seleccionar entradas",
  "Select Your Seats": "Seleccione sus asientos",
  "Select seats above to continue": "Seleccione asientos arriba para continuar",
  "Select tickets above to continue": "Seleccione entradas arriba para continuar",
  "Selected Seats": "Asientos seleccionados",
  "Service Fee": "Tarifa de servicio",
  "Subtotal": "Subtotal",
  "Total Amount": "Cantidad total",
  "View your ticket": "Ver su entrada",
  "each": "cada uno",
  ...
  "Ticket Not Found": "Entrada No Encontrada",
  "Your Ticket": "Tu Entrada",
  "Loading your ticket...": "Cargando tu entrada...",
  "Show this QR code at the entrance or": "Muestra este código QR en la entrada o",
  "Show this QR code at the entrance.": "Muestra este código QR en la entrada.",
  "Download QR": "Descargar QR",
  "Individual Tickets": "Entradas Individuales",
  "QR Code for All Tickets": "Código QR para Todas las Entradas",
  "Scan this QR for all tickets": "Escanea este QR para todas las entradas",
  "Individual ticket": "Entrada individual",
  "All Tickets QR": "QR de Todas las Entradas",
  "ID": "ID",
  "Unable to load ticket information. Please check the URL and try again.": "No se pudo cargar la información del ticket. Por favor, verifica la URL e inténtalo de nuevo.",
};
export default es;
