let he = {
  ...
  "Do you really want to delete selected event? Once removed, cannot be undone": "האם אתה באמת רוצה למחוק את האירוע שנבחר? לאחר הסרה, לא ניתן לבטל",
  "There are no categories yet": "אין עדיין קטגוריות",
  "Making Changes to your synced calendar with the following links. Please review your changes carefully.": "ביצוע שינויים בלוח השנה המסונכרן שלך באמצעות הקישורים הבאים. אנא בדוק את השינויים שלך בקפידה.",
