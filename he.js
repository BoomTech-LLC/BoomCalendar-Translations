let he = {
  ...
  "Do you really want to delete selected user? Once removed, cannot be undone.": "האם אתה באמת רוצה למחוק את המשתמש שנבחר? לאחר הסרה, לא ניתן לבטל.",
  "Delete Guest": "מחק אורח",
  "Invoice number": "מספר חשבונית",
  "Status": "סטָטוּס",
  "Payment type": "סוג תשלום",
  "Select payment method to receive fees through tickets": "בחר אמצעי תשלום כדי לקבל עמלות באמצעות כרטיסים",
  "Add Code": "הוסף קוד",
  ...
  "Enable and configure your ticketing system": "הפעל והגדר את מערכת הכרטוס שלך",
