let he = {
  ...
  "Tip:": "עֵצָה:",
  "Use the +/- buttons to zoom in and out": "השתמשו בכפתורי +/- כדי להגדיל ולהקטין",
  "Click and drag the background to pan around the venue": "לחץ וגרור את הרקע כדי לנוע סביב המקום",
  "Pan & Zoom": "סיבוב וזום",
  "Capacity is shared across all seatmaps for the same event": "הקיבולת משותפת לכל מפות המושבים לאותו אירוע",
  "Use the - button to remove tickets from your selection": "השתמשו בלחצן - כדי להסיר כרטיסים מהבחירה שלכם",
  "Use the + button to add tickets to your selection": "השתמשו בלחצן + כדי להוסיף כרטיסים לבחירתכם",
  "Standing areas show the number of tickets remaining": "אזורי העמידה מציגים את מספר הכרטיסים שנותרו",
  "Standing Areas": "אזורי עמידה",
  "Remove keyboard focus from seats": "הסר את מיקוד המקלדת מהמושבים",
  "Clear Focus": "פוקוס ברור",
  "Toggle the focused seat": "הפעל את המושב הממוקד",
  "Select / Deselect Seat": "בחר / בטל בחירה במושב",
  "Move between available seats": "מעבר בין מושבים זמינים",
  "Navigate Seats": "ניווט מושבים",
  "Use your keyboard to navigate and select seats without a mouse:": "השתמשו במקלדת כדי לנווט ולבחור מושבים ללא עכבר:",
  "Keyboard Navigation": "ניווט במקלדת",
  "Click an empty area to deselect all seats": "לחץ על אזור ריק כדי לבטל את הבחירה בכל המושבים",
  "Drag across multiple seats to toggle-select them": "גרור על פני מספר מושבים כדי לבחור אותם",
  "Click a selected seat again to deselect it": "לחץ שוב על מושב שנבחר כדי לבטל את בחירתו",
  "Click a seat to select it": "לחץ על מושב כדי לבחור אותו",
  "Selecting Seats": "בחירת מושבים",
  "How to Select Seats": "כיצד לבחור מושבים",
  "How to Use": "כיצד להשתמש",
  "Pay": "לְשַׁלֵם",
  "Book": "סֵפֶר",
  "This promo code has already been used": "קוד קופון זה כבר נוצל",
  "This promo code is not yet active": "קוד קופון זה עדיין לא פעיל",
  "This promo code has expired": "קוד קופון זה פג תוקפו",
  "Invalid promo code": "קוד קידום מכירות לא תקין",
  "Credit / Debit Card": "כרטיס אשראי / חיוב",
  "Fast & secure checkout": "תשלום מהיר ומאובטח",
  "Secure payment via Wix": "תשלום מאובטח דרך Wix",
  "Pay at the venue": "תשלום במקום",
  "Registration": "הַרשָׁמָה",
  "Attendee Information": "מידע על המשתתפים",
  "Your information is secure and will only be used for event registration": "המידע שלך מאובטח וישמש אך ורק לצורך הרשמה לאירוע",
  "Your information is secure and will only be used for ticket delivery": "המידע שלך מאובטח וישמש אך ורק למשלוח כרטיסים",
  "Register": "לִרְשׁוֹם",
  "Event is fully booked": "האירוע מלא בתפוסה מלאה",
  "To Event": "לאירוע",
  "Guest Details": "פרטי האורח",
  "Because it was a Draft": "כי זו הייתה טיוטה",
  "You can't see your event": "אינך יכול לראות את האירוע שלך",
  "The event is currently happening. If you believe this is an error, please contact the event organizer.": "האירוע מתקיים כעת. אם אתה סבור שמדובר בטעות, אנא צור קשר עם מארגן האירוע.",
  "Registration is closed because this event has already started.": "ההרשמה סגורה מכיוון שהאירוע כבר התחיל.",
  "Event In Progress": "אירוע בעיצומו",
  "The event organizer is still preparing this event. Please check back later or contact the organizer for more information.": "מארגן האירוע עדיין מתכנן את האירוע. אנא בדקו שוב מאוחר יותר או צרו קשר עם המארגן לקבלת מידע נוסף.",
  "Event": "מִקרֶה",
  "This event is currently in draft mode and not available for registration yet.": "אירוע זה נמצא כעת במצב טיוטה ואינו זמין עדיין להרשמה.",
  "This event is currently in draft mode and not yet available for viewing.": "אירוע זה נמצא כעת במצב טיוטה ואינו זמין עדיין לצפייה.",
  "Event Not Published": "האירוע לא פורסם",
  "Draft Mode": "מצב טיוטה",
  "Back": "בְּחֲזָרָה",
  "Go": "לָלֶכֶת",
  "Could not find requested resource": "לא ניתן היה למצוא את המשאב המבוקש",
  ...
  "Sync Date Range": "טווח תאריכים לסנכרון",
  "Sync categories": "סנכרון קטגוריות",
  "Hide event description": "הסתר את תיאור האירוע",
  "Hide private events": "הסתר אירועים פרטיים",
  "No synchronized calendars yet. Select a calendar above and click Sync to start.": "אין עדיין יומנים מסונכרנים. בחר יומן למעלה ולחץ על סנכרן כדי להתחיל.",
  "Fetches current events so you can add them one by one.": "מאחזר אירועים עכשוויים כדי שתוכל להוסיף אותם אחד אחד.",
  "Keeps events continuously updated in real time.": "מעדכן אירועים באופן רציף בזמן אמת.",
