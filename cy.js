let cy = {
  ...
  "You can move your mouse outside the seatmap while dragging - the selection will still apply when you release.": "Gallwch symud eich llygoden y tu allan i'r map sedd wrth lusgo - bydd y dewis yn dal i fod yn berthnasol pan fyddwch chi'n rhyddhau.",
  "Tip:": "Awgrym:",
  "Use the +/- buttons to zoom in and out": "Defnyddiwch y botymau +/- i chwyddo i mewn ac allan",
  "Click and drag the background to pan around the venue": "Cliciwch a llusgwch y cefndir i symud o gwmpas y lleoliad",
  "Pan & Zoom": "Panio a Chwyddo",
  "Capacity is shared across all seatmaps for the same event": "Rhennir y capasiti ar draws pob map sedd ar gyfer yr un digwyddiad",
  "Use the - button to remove tickets from your selection": "Defnyddiwch y botwm - i gael gwared ar docynnau o'ch dewis",
  "Use the + button to add tickets to your selection": "Defnyddiwch y botwm + i ychwanegu tocynnau at eich dewis",
  "Standing areas show the number of tickets remaining": "Mae'r mannau sefyll yn dangos nifer y tocynnau sydd ar ôl",
  "Standing Areas": "Mannau Sefyll",
  "Remove keyboard focus from seats": "Tynnu ffocws y bysellfwrdd o'r seddi",
  "Clear Focus": "Ffocws Clir",
  "Toggle the focused seat": "Toglwch y sedd ffocws",
  "Select / Deselect Seat": "Dewis / Dad-ddewis Sedd",
  "Move between available seats": "Symud rhwng seddi sydd ar gael",
  "Navigate Seats": "Llywio Seddau",
  "Use your keyboard to navigate and select seats without a mouse:": "Defnyddiwch eich bysellfwrdd i lywio a dewis seddi heb lygoden:",
  "Keyboard Navigation": "Llywio Bysellfwrdd",
  "Click an empty area to deselect all seats": "Cliciwch ar ardal wag i ddad-ddewis pob sedd",
  "Drag across multiple seats to toggle-select them": "Llusgwch ar draws sawl sedd i'w dewis a'u togl-ddewis",
  "Click a selected seat again to deselect it": "Cliciwch ar sedd a ddewiswyd eto i'w dad-ddewis",
  "Click a seat to select it": "Cliciwch ar sedd i'w dewis",
  "Selecting Seats": "Dewis Seddau",
  "How to Select Seats": "Sut i Ddewis Seddau",
  "How to Use": "Sut i Ddefnyddio",
  "Pay": "Talu",
  "Book": "Llyfr",
  "This promo code has already been used": "Mae'r cod hyrwyddo hwn eisoes wedi'i ddefnyddio",
  "This promo code is not yet active": "Nid yw'r cod hyrwyddo hwn yn weithredol eto",
  "This promo code has expired": "Mae'r cod hyrwyddo hwn wedi dod i ben",
  "Invalid promo code": "Cod hyrwyddo annilys",
  "Credit / Debit Card": "Cerdyn Credyd / Debyd",
  "Fast & secure checkout": "Talu cyflym a diogel",
  "Secure payment via Wix": "Taliad diogel trwy Wix",
  "Pay at the venue": "Talu yn y lleoliad",
  "Registration": "Cofrestru",
  "Attendee Information": "Gwybodaeth i'r Mynychwyr",
  "Your information is secure and will only be used for event registration": "Mae eich gwybodaeth yn ddiogel a dim ond ar gyfer cofrestru ar gyfer digwyddiad y caiff ei defnyddio",
  "Your information is secure and will only be used for ticket delivery": "Mae eich gwybodaeth yn ddiogel a dim ond ar gyfer dosbarthu tocynnau y caiff ei defnyddio",
  "Register": "Cofrestru",
  "Event is fully booked": "Mae'r digwyddiad wedi'i archebu'n llawn",
  "To Event": "I'r Digwyddiad",
  "Guest Details": "Manylion Gwestai",
  "Because it was a Draft": "Oherwydd ei fod yn Ddrafft",
  "You can't see your event": "Ni allwch weld eich digwyddiad",
  "The event is currently happening. If you believe this is an error, please contact the event organizer.": "Mae'r digwyddiad yn digwydd ar hyn o bryd. Os ydych chi'n credu bod hwn yn gamgymeriad, cysylltwch â threfnydd y digwyddiad.",
  "Registration is closed because this event has already started.": "Mae'r cofrestru ar gau oherwydd bod y digwyddiad hwn eisoes wedi dechrau.",
  "Event In Progress": "Digwyddiad ar y Gweill",
  "The event organizer is still preparing this event. Please check back later or contact the organizer for more information.": "Mae trefnydd y digwyddiad yn dal i baratoi'r digwyddiad hwn. Gwiriwch yn ôl yn nes ymlaen neu cysylltwch â'r trefnydd am ragor o wybodaeth.",
  "Event": "Digwyddiad",
  "This event is currently in draft mode and not available for registration yet.": "Mae'r digwyddiad hwn ar ffurf drafft ar hyn o bryd ac nid yw ar gael i gofrestru arno eto.",
  "This event is currently in draft mode and not yet available for viewing.": "Mae'r digwyddiad hwn ar ffurf drafft ar hyn o bryd ac nid yw ar gael i'w weld eto.",
  "Event Not Published": "Digwyddiad Heb ei Gyhoeddi",
  "Draft Mode": "Modd Drafft",
  "Back": "Yn ôl",
  "Go": "Ewch",
  "Could not find requested resource": "Methwyd dod o hyd i'r adnodd gofynnol",
  "Not Found 404": "Heb ei Ganfod 404",
  "Loading...": "Yn llwytho...",
  "Loading": "Yn llwytho",
  ...
  "Your information is secure and will only be used for event registration": "Mae eich gwybodaeth yn ddiogel a dim ond ar gyfer cofrestru ar gyfer digwyddiad y caiff ei defnyddio",
  "Your information is secure and will only be used for ticket delivery": "Mae eich gwybodaeth yn ddiogel a dim ond ar gyfer dosbarthu tocynnau y caiff ei defnyddio",
  "per ticket": "fesul tocyn",
  "Select tickets above to continue": "Dewiswch docynnau uchod i barhau",
  "Select seats above to continue": "Dewiswch seddi uchod i barhau",
  "Select Tickets": "Dewiswch Docynnau",
  "Gallery": "Oriel",
  "Secure checkout": "Talu diogel",
  "About This Event": "Ynglŷn â'r Digwyddiad Hwn",
  "Available Spots": "Mannau Sydd Ar Gael",
  "TICKET TYPES": "MATHAU O DOCYNNAU",
  "TICKET TYPE": "MATH O DOCYN",
  "Sync": "Cysoni",
  ...
  "Sync Date Range": "Ystod Dyddiadau Cysoni",
  "Sync categories": "Cysoni categorïau",
  "Hide event description": "Cuddio disgrifiad y digwyddiad",
  "Hide private events": "Cuddio digwyddiadau preifat",
  "No synchronized calendars yet. Select a calendar above and click Sync to start.": "Dim calendrau wedi'u cydamseru eto. Dewiswch galendr uchod a chliciwch ar Gydamseru i ddechrau.",
  "Fetches current events so you can add them one by one.": "Yn nôl digwyddiadau cyfredol fel y gallwch eu hychwanegu fesul un.",
  "Keeps events continuously updated in real time.": "Yn diweddaru digwyddiadau'n barhaus mewn amser real.",
  "Your Api Key": "Eich Allwedd Api",
  "Fahrenheit": "Fahrenheit",
  "Celsius": "Celsius",
  "Select the city from the suggestions": "Dewiswch y ddinas o'r awgrymiadau",
  "Weather Forecast": "Rhagolygon Tywydd",
  "Cross Event Limit": "Terfyn Traws-Digwyddiad",
  "Show events limit": "Dangos terfyn digwyddiadau",
  "Show tooltip/popup": "Dangos cyngor offer/popup",
  "Bold Monthly Dividers": "Rhanwyr Misol Beiddgar",
  "Scroll to see more events": "Sgroliwch i weld mwy o ddigwyddiadau",
  "Show additional date": "Dangos dyddiad ychwanegol",
  ...
  "Reset Layouts Dimensions": "Ailosod dimensiynau cynlluniau",
  "Clear": "Gliria ’",
  "Undo": "Ddatodasoch",
  "Redo": "Ail -wnaf",
  "Code Panel": "Panel Cod",
  "Code Panel Notify": "Gall addasu cod yn uniongyrchol dorri'r cynllun neu ymarferoldeb app. Dim ond golygu os ydych chi'n gwybod beth rydych chi'n ei wneud!",
  "Clear Editor": "Golygydd clir",
  "Clear Editor Notify": "Ydych chi'n siŵr eich bod chi am glirio'r golygydd? Bydd yr holl gynnydd yn cael ei golli!",
  "Nothing to edit": "Nid oes unrhyw beth i'w olygu!",
  "Shapes": "Siapiau",
  "Delete The Shape": "Dileu'r siâp",
  "Add shapes": "Ychwanegwch siapiau rhwng cynlluniau ac addasu!",
  "Preview unavailable": "Rhagolwg Cydran Ddim ar gael ar gyfer Cydran",
  ...
  "Select Font": "Dewiswch ffont",
  "Font Weight": "Pwysau ffont",
  "Font Size": "Maint ffont",
  "Text Alignment": "Aliniad testun",
  "Left Alignment": "Aliniad chwith",
  "Center Alignment": "Aliniad canolfan",
  "Right Alignment": "Aliniad cywir",
  "Text Decoration": "Addurno Testun",
  "Overline": "Gor -linell",
  "Line Through": "Llinell drwodd",
  "Underline": "Danlinella",
  "Underline and Overline": "Tanlinellu a gor -linell",
  "Without Decoration": "Heb addurn",
  "Left": "Gadawaf",
  "Angle": "Pysgota",
  "Distance": "Bellaf",
  "Blur": "Aneglur",
  "Size": "Maint",
  "Edit individually": "Golygu'n unigol",
  "Apply to all corners": "Yn berthnasol i bob cornel",
  "Date Box Visual": "Blwch dyddiad gweledol",
  "One Line": "Un llinell",
  "Show Icons": "Dangos eiconau",
  "Design Settings": "Gosodiadau dylunio",
  "Personalize your editor to match your style and preferences, customize every detail in this settings tab !": "Personoli'ch golygydd i gyd -fynd â'ch steil a'ch dewisiadau, addaswch bob manylyn yn y tab Gosodiadau hwn!",
  "Divider": "Rannwr",
  "Ellipse": "Elips",
  "Rhombus": "Rhombws",
  "Heart": "Calon",
