let pt = {
  ...
  "Find your printable e-tickets attached to the confirmation email": "Encontre seus ingressos eletrônicos para impressão anexados ao e-mail de confirmação.",
  "Thank you for your purchase!": "Obrigado pela sua compra!",
  "You can move your mouse outside the seatmap while dragging - the selection will still apply when you release.": "Você pode mover o cursor do mouse para fora do mapa de assentos enquanto arrasta – a seleção permanecerá válida mesmo após soltar o botão.",
  "Tip:": "Dica:",
  "Use the +/- buttons to zoom in and out": "Use os botões +/- para aumentar e diminuir o zoom.",
  "Click and drag the background to pan around the venue": "Clique e arraste o plano de fundo para percorrer o local.",
  "Pan & Zoom": "Panorâmica e zoom",
  "Capacity is shared across all seatmaps for the same event": "A capacidade é compartilhada entre todos os mapas de assentos para o mesmo evento.",
  "Use the - button to remove tickets from your selection": "Use o botão - para remover ingressos da sua seleção.",
  "Use the + button to add tickets to your selection": "Use o botão + para adicionar ingressos à sua seleção.",
  "Standing areas show the number of tickets remaining": "As áreas para quem fica em pé mostram o número de ingressos restantes.",
  "Standing Areas": "Áreas para ficar em pé",
  "Remove keyboard focus from seats": "Remover o foco do teclado dos assentos",
  "Clear Focus": "Foco nítido",
  "Toggle the focused seat": "Alternar o assento focado",
  "Select / Deselect Seat": "Selecionar/Desmarcar Assento",
  "Move between available seats": "Desloque-se entre os assentos disponíveis.",
  "Navigate Seats": "Navegue pelos assentos",
  "Use your keyboard to navigate and select seats without a mouse:": "Use o teclado para navegar e selecionar assentos sem usar o mouse:",
  "Keyboard Navigation": "Navegação por teclado",
  "Click an empty area to deselect all seats": "Clique em uma área vazia para desmarcar todos os assentos.",
  "Drag across multiple seats to toggle-select them": "Arraste o dedo sobre vários assentos para selecioná-los ou alterná-los.",
  "Click a selected seat again to deselect it": "Clique novamente no assento selecionado para desmarcá-lo.",
  "Click a seat to select it": "Clique em um assento para selecioná-lo.",
  "Selecting Seats": "Selecionando assentos",
  "How to Select Seats": "Como selecionar assentos",
  "How to Use": "Como usar",
  "Pay": "Pagar",
  "Book": "Livro",
  "This promo code has already been used": "Este código promocional já foi utilizado.",
  "This promo code is not yet active": "Este código promocional ainda não está ativo.",
  "This promo code has expired": "Este código promocional expirou.",
  "Invalid promo code": "Código promocional inválido",
  "Credit / Debit Card": "Cartão de crédito/débito",
  "Fast & secure checkout": "Pagamento rápido e seguro",
  "Secure payment via Wix": "Pagamento seguro via Wix",
  "Pay at the venue": "Pague no local.",
  "Registration": "Inscrição",
  "Attendee Information": "Informações para os participantes",
  "Your information is secure and will only be used for event registration": "Suas informações estão seguras e serão usadas apenas para inscrição no evento.",
  "Your information is secure and will only be used for ticket delivery": "Suas informações estão seguras e serão usadas apenas para a entrega de ingressos.",
  "Register": "Cadastre-se",
  "Event is fully booked": "O evento está com lotação esgotada.",
  "To Event": "Para o evento",
  "Guest Details": "Detalhes do hóspede",
  "Because it was a Draft": "Porque era um rascunho",
  "You can't see your event": "Você não consegue ver seu evento.",
  "The event is currently happening. If you believe this is an error, please contact the event organizer.": "O evento está acontecendo neste momento. Se você acredita que isso é um erro, entre em contato com o organizador do evento.",
  "Registration is closed because this event has already started.": "As inscrições estão encerradas porque este evento já começou.",
  "Event In Progress": "Evento em andamento",
  "The event organizer is still preparing this event. Please check back later or contact the organizer for more information.": "O organizador do evento ainda está preparando o evento. Por favor, volte mais tarde ou entre em contato com o organizador para obter mais informações.",
  "Event": "Evento",
  "This event is currently in draft mode and not available for registration yet.": "Este evento está atualmente em fase de rascunho e as inscrições ainda não estão disponíveis.",
  "This event is currently in draft mode and not yet available for viewing.": "Este evento está atualmente em versão preliminar e ainda não está disponível para visualização.",
  "Event Not Published": "Evento não publicado",
  "Draft Mode": "Modo rascunho",
  "Back": "Voltar",
  "Go": "Ir",
  "Could not find requested resource": "Não foi possível encontrar o recurso solicitado.",
  "Not Found 404": "Não encontrado 404",
  "Loading...": "Carregando...",
  "Loading": "Carregando",
  ...
  "Select tickets above to continue": "Selecione os bilhetes acima para continuar.",
  "Select seats above to continue": "Selecione os assentos acima para continuar.",
  ...
  "TICKET TYPES": "TIPOS DE INGRESSOS",
  "TICKET TYPE": "TIPO DE BILHETE",
  "Sync": "Sincronizar",
  "Connected": "Conectado",
  "Removes the connection to your Google account. Previously imported events will remain on your calendar.": "Remove a conexão com sua conta do Google. Os eventos importados anteriormente permanecerão em seu calendário.",
  "A wider range means more events to load. If your calendar feels slow, try narrowing the range to match the view you use most (e.g. monthly view needs a shorter range than yearly).": "Um intervalo maior significa que mais eventos precisam ser carregados. Se o seu calendário estiver lento, tente reduzir o intervalo para corresponder à visualização que você usa com mais frequência (por exemplo, a visualização mensal precisa de um intervalo menor do que a anual).",
  "Sync Date Range": "Intervalo de datas de sincronização",
  "Sync categories": "Sincronizar categorias",
  "Hide event description": "Ocultar descrição do evento",
  "Hide private events": "Ocultar eventos privados",
  "No synchronized calendars yet. Select a calendar above and click Sync to start.": "Ainda não há calendários sincronizados. Selecione um calendário acima e clique em Sincronizar para começar.",
  "Fetches current events so you can add them one by one.": "Busca eventos atuais para que você possa adicioná-los um por um.",
  "Keeps events continuously updated in real time.": "Mantém os eventos atualizados continuamente em tempo real.",
  "Your Api Key": "Sua chave de API",
  "Fahrenheit": "Fahrenheit",
  "Celsius": "Celsius",
  "Select the city from the suggestions": "Selecione a cidade entre as sugestões",
  "Weather Forecast": "Previsão do tempo",
  "Cross Event Limit": "Limite de Eventos Cruzados",
  "Show events limit": "Mostrar limite de eventos",
  "Show tooltip/popup": "Mostrar dica de ferramenta/pop-up",
  "Bold Monthly Dividers": "Divisores mensais em negrito",
  "Scroll to see more events": "Role para ver mais eventos",
  "Show additional date": "Mostrar data adicional",
  ...
  "Reset Layouts Dimensions": "Redefinir as dimensões dos layouts",
  "Clear": "Claro",
  "Undo": "Desfazer",
  "Redo": "Refazer",
  "Code Panel": "Painel de código",
  "Code Panel Notify": "A modificação do código diretamente pode quebrar o layout ou a funcionalidade do aplicativo. Só edite se você souber o que está fazendo!",
  "Clear Editor": "Editor Clear",
  "Clear Editor Notify": "Tem certeza de que deseja limpar o editor? Todo o progresso será perdido!",
  "Nothing to edit": "Não há nada para editar!",
  "Shapes": "Formas",
  "Delete The Shape": "Exclua a forma",
  "Add shapes": "Adicione formas entre os layouts e personalize!",
  "Preview unavailable": "Visualização de componentes indisponível para componente",
  "component removed": "Componente removido do editor.",
  "component duplicate": "Componente Adicionado, Nota: Entrada duplicada!",
  "component added": "Componente adicionado com sucesso ao editor.",
  "Component Preview": "Visualização de componentes",
  "Height": "Altura",
  "Font Family": "Família de fontes",
  "Select Font": "Selecione Fonte",
  "Font Weight": "Peso da fonte",
  "Font Size": "Tamanho da fonte",
  "Text Alignment": "Alinhamento de texto",
  "Left Alignment": "Alinhamento à esquerda",
  "Center Alignment": "Alinhamento central",
  "Right Alignment": "Alinhamento à direita",
  "Text Decoration": "Decoração de texto",
  "Overline": "Overline",
  "Line Through": "Alinhe",
  "Underline": "Sublinhado",
  "Underline and Overline": "Sublinhado e exagerado",
  "Without Decoration": "Sem decoração",
  "Left": "Esquerda",
  "Angle": "Ângulo",
  "Distance": "Distância",
  "Blur": "Borrão",
  ...
  "Apply to all corners": "Aplique a todos os cantos",
  "Date Box Visual": "Visual da caixa de data",
  "One Line": "Uma linha",
  "Show Icons": "Mostrar ícones",
  "Design Settings": "Configurações de design",
  "Personalize your editor to match your style and preferences, customize every detail in this settings tab !": "Personalize seu editor para combinar com seu estilo e preferências, personalize todos os detalhes nesta guia Configurações!",
  "Divider": "Divisor",
  "Ellipse": "Elipse",
  "Rhombus": "RHombus",
  "Heart": "Coração",
  ...
  "Attendee Information": "Informações do participante",
  "To Event": "Para o evento",
  "A confirmation email has been sent to you": "Um e-mail de confirmação foi enviado para você",
  "Available Spots": "Vagas disponíveis",
  "Event Details": "Detalhes do evento",
  "Free admission": "Entrada gratuita",
  "Get Tickets Now": "Obter ingressos agora",
  "Get Tickets": "Obter ingressos",
  "Instant confirmation": "Confirmação instantânea",
  "No seats selected": "Nenhum assento selecionado",
  "No tickets available for this event.": "Nenhum ingresso disponível para este evento.",
  "No tickets selected": "Nenhum ingresso selecionado",
  "Order Summary": "Resumo do pedido",
  "Payment": "Pagamento",
  "Please enter a valid email": "Por favor, insira um e-mail válido",
  "Please enter your name": "Por favor, insira seu nome",
  "Please select at least one seat": "Por favor, selecione pelo menos um assento",
  ...
  "Select seats above to continue": "Selecione assentos acima para continuar",
  "Select tickets above to continue": "Selecione ingressos acima para continuar",
  "Selected Seats": "Assentos selecionados",
  "Service Fee": "Taxa de serviço",
  "Subtotal": "Subtotal",
  "Total Amount": "Valor total",
  "View your ticket": "Ver seu ingresso",
  "each": "cada",
  ...
  "Your Ticket": "Seu Ingresso",
  "Loading your ticket...": "Carregando seu ingresso...",
  "Show this QR code at the entrance or": "Mostre este código QR na entrada ou",
  "Show this QR code at the entrance.": "Mostre este código QR na entrada.",
  "Download QR": "Baixar QR",
  "Individual Tickets": "Ingressos Individuais",
  "QR Code for All Tickets": "Código QR para Todos os Ingressos",
  "Scan this QR for all tickets": "Escaneie este QR para todos os ingressos",
  "Individual ticket": "Ingresso individual",
  "All Tickets QR": "QR de Todos os Ingressos",
  "ID": "ID",
  "Unable to load ticket information. Please check the URL and try again.": "Não foi possível carregar as informações do ingresso. Verifique o URL e tente novamente.",
};
export default pt;
