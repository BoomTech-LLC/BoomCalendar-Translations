let de = {
  ...
  "Ticket Tailor sync allows you to integrate your events and sessions with your Boom Calendar.": "Mit der Ticket Tailor-Synchronisierung können Sie Ihre Veranstaltungen und Sitzungen in Ihren Boom-Kalender integrieren.",
  "Show event time next to title. This setting is only applicable to the Monthly, Daily, and Weekly views.": "Veranstaltungszeit neben dem Titel anzeigen. Diese Einstellung gilt nur für die Monats-, Tages- und Wochenansichten.",
  ...
  "Code Panel Notify": "Das direkte Ändern des Codes kann die Layout- oder App -Funktionalität unterbrechen. Bearbeiten Sie nur, wenn Sie wissen, was Sie tun!",
  "Clear Editor": "Klarer Herausgeber",
  "Clear Editor Notify": "Sind Sie sicher, dass Sie den Herausgeber löschen möchten? Alle Fortschritte werden verloren!",
  "Nothing to edit": "Es gibt nichts zu bearbeiten!",
  "Shapes": "Formen",
  "Delete The Shape": "Löschen Sie die Form",
  "Add shapes": "Fügen Sie Formen zwischen Layouts hinzu und passen Sie sie an!",
  "Preview unavailable": "Komponente Vorschau für die Komponente nicht verfügbar",
  ...
  "Personalize your editor to match your style and preferences, customize every detail in this settings tab !": "Personalisieren Sie Ihren Editor so, dass Sie Ihren Stil und Ihre Einstellungen entsprechen, und passen Sie jedes Detail in dieser Registerkarte dieser Einstellungen an!",
  "Divider": "Teiler",
  "Ellipse": "Ellipse",
  "Rhombus": "Rhombus",
  "Heart": "Herz",
