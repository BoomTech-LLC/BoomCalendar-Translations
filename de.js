let de = {
  ...
  "You can move your mouse outside the seatmap while dragging - the selection will still apply when you release.": "Sie können den Mauszeiger während des Ziehens außerhalb des Sitzplans bewegen – die Auswahl bleibt auch nach dem Loslassen erhalten.",
  "Tip:": "Tipp:",
  "Use the +/- buttons to zoom in and out": "Verwenden Sie die +/- Tasten zum Vergrößern und Verkleinern.",
  "Click and drag the background to pan around the venue": "Klicken und ziehen Sie den Hintergrund, um den Blick über den Veranstaltungsort zu schwenken.",
  "Pan & Zoom": "Schwenken und Zoomen",
  "Capacity is shared across all seatmaps for the same event": "Die Kapazität wird für alle Sitzpläne derselben Veranstaltung gemeinsam genutzt.",
  "Use the - button to remove tickets from your selection": "Verwenden Sie die Schaltfläche „-“, um Tickets aus Ihrer Auswahl zu entfernen.",
  "Use the + button to add tickets to your selection": "Verwenden Sie die Schaltfläche „+“, um Tickets zu Ihrer Auswahl hinzuzufügen.",
  "Standing areas show the number of tickets remaining": "Die Stehplatzbereiche zeigen die Anzahl der verbleibenden Tickets an.",
  "Standing Areas": "Stehbereiche",
  "Remove keyboard focus from seats": "Tastaturfokus von Sitzen entfernen",
  "Clear Focus": "Klarer Fokus",
  "Toggle the focused seat": "Fokussierten Sitz umschalten",
  "Select / Deselect Seat": "Sitzplatz auswählen / Auswahl aufheben",
  "Move between available seats": "Wechseln Sie zwischen verfügbaren Sitzplätzen.",
  "Navigate Seats": "Sitze navigieren",
  "Use your keyboard to navigate and select seats without a mouse:": "Nutzen Sie Ihre Tastatur, um zu navigieren und Sitzplätze auszuwählen, ohne eine Maus zu verwenden:",
  "Keyboard Navigation": "Tastaturnavigation",
  "Click an empty area to deselect all seats": "Klicken Sie auf eine leere Stelle, um alle Sitze abzuwählen.",
  "Drag across multiple seats to toggle-select them": "Ziehen Sie über mehrere Sitze, um diese auszuwählen.",
  "Click a selected seat again to deselect it": "Klicken Sie erneut auf einen ausgewählten Sitzplatz, um die Auswahl aufzuheben.",
  "Click a seat to select it": "Klicken Sie auf einen Sitzplatz, um ihn auszuwählen.",
  "Selecting Seats": "Sitzplätze auswählen",
  "How to Select Seats": "So wählen Sie Sitzplätze aus",
  "How to Use": "Anleitung zur Verwendung",
  "Pay": "Zahlen",
  "Book": "Buch",
  "This promo code has already been used": "Dieser Gutscheincode wurde bereits verwendet",
  "This promo code is not yet active": "Dieser Gutscheincode ist noch nicht aktiv.",
  "This promo code has expired": "Dieser Gutscheincode ist abgelaufen.",
  "Invalid promo code": "Ungültiger Gutscheincode",
  "Credit / Debit Card": "Kredit-/Debitkarte",
  "Fast & secure checkout": "Schneller und sicherer Checkout",
  "Secure payment via Wix": "Sichere Zahlung über Wix",
  "Pay at the venue": "Die Bezahlung erfolgt vor Ort.",
  "Registration": "Anmeldung",
  "Attendee Information": "Teilnehmerinformationen",
  "Your information is secure and will only be used for event registration": "Ihre Daten sind sicher und werden ausschließlich für die Veranstaltungsanmeldung verwendet.",
  "Your information is secure and will only be used for ticket delivery": "Ihre Daten sind sicher und werden ausschließlich für die Ticketzustellung verwendet.",
  "Register": "Registrieren",
  "Event is fully booked": "Die Veranstaltung ist ausgebucht",
  "To Event": "Zum Event",
  "Guest Details": "Gästedetails",
  "Because it was a Draft": "Weil es ein Entwurf war",
  "You can't see your event": "Du kannst deine Veranstaltung nicht sehen.",
  "The event is currently happening. If you believe this is an error, please contact the event organizer.": "Die Veranstaltung findet aktuell statt. Sollten Sie der Meinung sein, dass es sich um einen Fehler handelt, kontaktieren Sie bitte den Veranstalter.",
  "Registration is closed because this event has already started.": "Die Registrierung ist geschlossen, da diese Veranstaltung bereits begonnen hat.",
  "Event In Progress": "Veranstaltung läuft",
  "The event organizer is still preparing this event. Please check back later or contact the organizer for more information.": "Der Veranstalter arbeitet noch an den Vorbereitungen. Bitte schauen Sie später noch einmal vorbei oder kontaktieren Sie den Veranstalter für weitere Informationen.",
  "Event": "Ereignis",
  "This event is currently in draft mode and not available for registration yet.": "Diese Veranstaltung befindet sich derzeit im Entwurfsmodus und ist noch nicht zur Anmeldung verfügbar.",
  "This event is currently in draft mode and not yet available for viewing.": "Diese Veranstaltung befindet sich derzeit im Entwurfsmodus und ist noch nicht zur Ansicht verfügbar.",
  "Event Not Published": "Veranstaltung nicht veröffentlicht",
  ...
  "Select tickets above to continue": "Wählen Sie oben Tickets aus, um fortzufahren.",
  "Select seats above to continue": "Wählen Sie oben Sitzplätze aus, um fortzufahren.",
  ...
  "Sync Date Range": "Synchronisierungsdatumsbereich",
  "Sync categories": "Synchronisierungskategorien",
  "Hide event description": "Veranstaltungsbeschreibung ausblenden",
  "Hide private events": "Private Veranstaltungen ausblenden",
  "No synchronized calendars yet. Select a calendar above and click Sync to start.": "Es sind noch keine Kalender synchronisiert. Wählen Sie oben einen Kalender aus und klicken Sie auf „Synchronisieren“, um den Vorgang zu starten.",
  "Fetches current events so you can add them one by one.": "Ruft aktuelle Ereignisse ab, sodass Sie diese einzeln hinzufügen können.",
  "Keeps events continuously updated in real time.": "Hält Ereignisse kontinuierlich in Echtzeit auf dem neuesten Stand.",
  "Your Api Key": "Ihr API-Schlüssel",
  Fahrenheit: "Fahrenheit",
  Celsius: "Celsius",
  "Select the city from the suggestions":
    "Wählen Sie die Stadt aus den Vorschlägen aus",
  "Weather Forecast": "Wettervorhersage",
  "Cross Event Limit": "Ereignisübergreifendes Limit",
  "Show events limit": "Ereignislimit anzeigen",
  "Show tooltip/popup": "Tooltip/Popup anzeigen",
  "Bold Monthly Dividers": "Fettgedruckte Monatsteiler",
  "Scroll to see more events": "Scrollen Sie, um weitere Ereignisse anzuzeigen",
  "Show additional date": "Weiteres Datum anzeigen",
  ...
  Online: "Online",
  Physical: "Physisch",
  "Select Categories to display events related to them, or manually choose specific events under Events":
    "Wählen Sie „Kategorien“ aus, um damit verbundene Ereignisse anzuzeigen, oder wählen Sie unter „Ereignisse“ manuell bestimmte Ereignisse aus",
  "Automatically approve events from these addresses":
    "Ereignisse von diesen Adressen automatisch genehmigen",
  ...
  Ahead: "Voraus",
  Ago: "Vor",
  "Change the category": "Ändern Sie die Kategorie",
  "Ticket Tailor sync allows you to integrate your events and sessions with your Boom Calendar.":
    "Mit der Ticket Tailor-Synchronisierung können Sie Ihre Veranstaltungen und Sitzungen in Ihren Boom-Kalender integrieren.",
  "Show event time next to title. This setting is only applicable to the Monthly, Daily, and Weekly views.":
    "Veranstaltungszeit neben dem Titel anzeigen. Diese Einstellung gilt nur für die Monats-, Tages- und Wochenansichten.",
  "Show Staff Member": "Mitarbeiter anzeigen",
  "Show Price": "Preis anzeigen",
  "To Event Page": "Zur Veranstaltungsseite",
  Layout: "Layout",
  ...
  "You are about to change the details of your event. Once changed, your guest list will be lost.":
    "Sie sind dabei, die Details Ihrer Veranstaltung zu ändern. Nach der Änderung geht Ihre Gästeliste verloren.",
  ...
  "Venue detail": "Einzelheiten zum Veranstaltungsort",
  Reject: "Ablehnen",
  "See guest list": "Siehe Gästeliste",
  "Submit Date": "Abgabetermin",
  "Total guests": "Gesamtzahl der Gäste",
  "Do you really want to delete selected user? Once removed, cannot be undone.":
    "Möchten Sie den ausgewählten Benutzer wirklich löschen? Einmal entfernt, kann es nicht rückgängig gemacht werden.",
  "Delete Guest": "Gast löschen",
  "Invoice number": "Rechnungsnummer",
  Status: "Status",
  "Payment type": "Zahlungsart",
  "Select payment method to receive fees through tickets":
    "Wählen Sie die Zahlungsmethode aus, um Gebühren über Tickets zu erhalten",
  "Add Code": "Code hinzufügen",
  "Add End Time": "Endzeit hinzufügen",
  Discount: "Rabatt",
  "Promo codes for the sales": "Promo-Codes für den Verkauf",
  "Promo codes": "Promo-Codes",
  "Add Ticket": "Ticket hinzufügen",
  "Limit type": "Limittyp",
  Paid: "Bezahlt",
  "Participation tickets for your event":
    "Teilnahmekarten für Ihre Veranstaltung",
  "Show the ticket limit": "Zeigen Sie das Ticketlimit an",
  "Show limit": "Limit anzeigen",
  "Show the price on ticket": "Zeigen Sie den Preis auf dem Ticket an",
  "Enable and configure your ticketing system":
    "Aktivieren und konfigurieren Sie Ihr Ticketsystem",
  "Stop repeating here": "Hören Sie auf, es hier zu wiederholen",
  Limited: "Begrenzt",
  ...
  Texts: "Texte",
  "Modify the displayed texts": "Ändern Sie die angezeigten Texte",
  "Thank you message body": "Vielen Dank, Nachrichtentext",
  "Notify the user when the registration is canceled":
    "Benachrichtigen Sie den Benutzer, wenn die Registrierung storniert wird",
  "Cancellation email": "Stornierungs-E-Mail",
  "Send a reminder to the user one day prior to the event":
    "Senden Sie dem Benutzer einen Tag vor der Veranstaltung eine Erinnerung",
  "Reminder email": "Erinnerungsmail",
  "Send an instant email to the user once registration is completed":
    "Senden Sie dem Benutzer sofort eine E-Mail, sobald die Registrierung abgeschlossen ist",
  "Notification email": "Benachrichtigungsemail",
  "Reminder email about the event": "Erinnerungs-E-Mail zur Veranstaltung",
  "Email notifications to users": "E-Mail-Benachrichtigungen an Benutzer",
  "Click on the toggle buttons next to each field to add it to your registration form. If you want to make the field required, click on the asterisk (*).":
    "Klicken Sie auf die Umschaltflächen neben jedem Feld, um es Ihrem Registrierungsformular hinzuzufügen. Wenn Sie das Feld als Pflichtfeld festlegen möchten, klicken Sie auf das Sternchen (*).",
  "Form Fields": "Formularfelder",
  "Enter your form description": "Geben Sie Ihre Formularbeschreibung ein",
  "Form Title": "Formulartitel",
  "Enter your form title": "Geben Sie den Titel Ihres Formulars ein",
  "Form Details": "Formulardetails",
  "Configure your registration form fields":
    "Konfigurieren Sie die Felder Ihres Registrierungsformulars",
  "Show guest limit": "Gästelimit anzeigen",
  "Enable Registration": "Registrierung aktivieren",
  "Click to activate registration on this event":
    "Klicken Sie hier, um die Registrierung für diese Veranstaltung zu aktivieren",
  "Customize the general settings of registration":
    "Passen Sie die allgemeinen Einstellungen der Registrierung an",
  "Enter URL": "URL eingeben",
  "Page URL": "Seiten-URL",
  "Close registration when the event starts":
    "Schließen Sie die Registrierung ab, wenn die Veranstaltung beginnt",
  "Redirect to a different website": "Weiterleitung auf eine andere Website",
  "Where users can register": "Wo sich Benutzer registrieren können",
  "Open event registration landing page":
    "Öffnen Sie die Zielseite für die Veranstaltungsregistrierung",
  "It must have taken you plenty of preparation to get ready for your event. Now is the time to sit back and relax till your guests gather around! As soon as a new registration is made, the information about your guest will appear here. Come back later to keep track of your event attendees.":
    "Es muss Ihnen viel Vorbereitung gekostet haben, sich auf Ihre Veranstaltung vorzubereiten. Jetzt ist es an der Zeit, sich zurückzulehnen und zu entspannen, bis sich Ihre Gäste versammelt haben! Sobald eine Neuanmeldung erfolgt, erscheinen hier die Informationen zu Ihrem Gast. Kommen Sie später noch einmal vorbei, um den Überblick über Ihre Veranstaltungsteilnehmer zu behalten.",
  "You have no guests at the moment.": "Sie haben im Moment keine Gäste.",
  "List of people who are registered to your event":
    "Liste der Personen, die für Ihre Veranstaltung registriert sind",
  "Guest List": "Gästeliste",
  "This is a recurring event! Any changes made to this event, will be applied to all repetitions.":
    "Dies ist ein wiederkehrendes Ereignis! Alle an dieser Veranstaltung vorgenommenen Änderungen werden auf alle Wiederholungen angewendet.",
  "Repeated event": "Wiederholtes Ereignis",
  "Delete Category": "Kategorie löschen",
  "Do you really want to delete selected category? Once removed, cannot be undone.":
    "Möchten Sie die ausgewählte Kategorie wirklich löschen? Einmal entfernt, kann es nicht rückgängig gemacht werden.",
  OK: "OK",
  ...
  "Do you really want to delete selected event? Once removed, cannot be undone":
    "Möchten Sie das ausgewählte Ereignis wirklich löschen? Einmal entfernt, kann es nicht rückgängig gemacht werden",
  "There are no categories yet": "Es sind noch keine Kategorien vorhanden",
  "Making Changes to your synced calendar with the following links. Please review your changes carefully.":
    "Nehmen Sie über die folgenden Links Änderungen an Ihrem synchronisierten Kalender vor. Bitte überprüfen Sie Ihre Änderungen sorgfältig.",
  ...
  "Show your Wix Bookings or Events on Calendar":
    "Zeigen Sie Ihre Wix -Buchungen oder -veranstaltungen im Kalender an",
  "Choose Auto for automatic display of all services and sessions on the calendar, or Manual for manual selection.":
    "Wählen Sie Auto für die automatische Anzeige aller Dienste und Sitzungen im Kalender oder zur manuellen Auswahl.",
  ...
  "Choose Auto for automatic display of all events on the calendar, or Manual for manual selection.":
    "Wählen Sie Auto für die automatische Anzeige aller Ereignisse im Kalender oder zur manuellen Auswahl.",
  Auto: "Auto",
  "Choose Auto for automatic display of all organizations and organizers on the calendar, or Manual for manual selection.":
    "Wählen Sie Auto für die automatische Anzeige aller Organisationen und Organisatoren im Kalender oder zur manuellen Auswahl.",
  Manual: "Handbuch",
  "Sync method": "Synchronisierungsmethode",
  "Enable synchronization": "Synchronisation aktivieren",
  "Showcase the category filter at the top or at the bottom of the calendar. The settings applies to Agenda, Cross, Timeline and Card views only":
    "Präsentieren Sie den Kategoriefilter oben oder unten im Kalender. Die Einstellungen gelten nur für Agenda-, Kreuz-, Zeitleisten- und Kartenansichten",
  ...
  "Ticket Tailor sync allows you to integrate your events and sessions with your Boom Calendar":
    "Mit Ticket Tailor Sync können Sie Ihre Veranstaltungen und Sitzungen in Ihren Boomkalender integrieren",
  ...
  "script bound":
    "Dieses Skript ist bereits gebunden, bitte wählen Sie weitere Details aus!",
  "Choose account": "Wählen Sie Konto",
  "Choose resource": "Wählen Sie Ressource",
  Reconnect: "Wieder verbinden",
  "script disappear":
    "Dieses Skript existiert nicht. Bitte fügen Sie Skript in Ihre Google Analytics hinzu!",
  "Reset Layouts Dimensions": "Layouts zurücksetzen",
  Clear: "Klar",
  Undo: "Rückgängig machen",
  Redo: "Wiederholen",
  "Code Panel": "Codepanel",
  "Code Panel Notify":
    "Das direkte Ändern des Codes kann die Layout- oder App -Funktionalität unterbrechen. Bearbeiten Sie nur, wenn Sie wissen, was Sie tun!",
  "Clear Editor": "Klarer Herausgeber",
  "Clear Editor Notify":
    "Sind Sie sicher, dass Sie den Herausgeber löschen möchten? Alle Fortschritte werden verloren!",
  "Nothing to edit": "Es gibt nichts zu bearbeiten!",
  Shapes: "Formen",
  "Delete The Shape": "Löschen Sie die Form",
  "Add shapes":
    "Fügen Sie Formen zwischen Layouts hinzu und passen Sie sie an!",
  "Preview unavailable":
    "Komponente Vorschau für die Komponente nicht verfügbar",
  ...
  "Select Font": "Wählen Sie Schriftart",
  "Font Weight": "Schriftgewicht",
  "Font Size": "Schriftgröße",
  "Text Alignment": "Textausrichtung",
  "Left Alignment": "Linksausrichtung",
  "Center Alignment": "Ausrichtung in Zentrum",
  "Right Alignment": "Richtige Ausrichtung",
  "Text Decoration": "Textdekoration",
  Overline: "Überaus",
  "Line Through": "Linie durch",
  Underline: "Unterstreichen",
  "Underline and Overline": "Unterstreichen und überaus",
  "Without Decoration": "Ohne Dekoration",
  Left: "Links",
  Angle: "Winkel",
  Distance: "Distanz",
  Blur: "Verwischen",
  Size: "Größe",
  "Edit individually": "Einzeln bearbeiten",
  "Apply to all corners": "Auf alle Ecken beantragen",
  "Date Box Visual": "Datum Box Visual",
  "One Line": "Eine Zeile",
  "Show Icons": "Ikonen zeigen",
  "Design Settings": "Designeinstellungen",
  "Personalize your editor to match your style and preferences, customize every detail in this settings tab !":
    "Personalisieren Sie Ihren Editor so, dass Sie Ihren Stil und Ihre Einstellungen entsprechen, und passen Sie jedes Detail in dieser Registerkarte dieser Einstellungen an!",
  Divider: "Teiler",
  Ellipse: "Ellipse",
  Rhombus: "Rhombus",
  Heart: "Herz",
  ...
  "Get Tickets Now": "Jetzt Tickets holen",
  "Get Tickets": "Tickets holen",
  "Instant confirmation": "Sofortige Bestätigung",
  "No seats selected": "Keine Plätze ausgewählt",
  "No tickets available for this event.": "Keine Tickets für diese Veranstaltung verfügbar.",
  "No tickets selected": "Keine Tickets ausgewählt",
  "Order Summary": "Bestellübersicht",
  "Payment": "Zahlung",
  "Please enter a valid email": "Bitte geben Sie eine gültige E-Mail ein",
  "Please enter your name": "Bitte geben Sie Ihren Namen ein",
  "Please select at least one seat": "Bitte wählen Sie mindestens einen Platz",
  "Register Now": "Jetzt registrieren",
  "Registration Complete": "Registrierung abgeschlossen",
  "Secure checkout": "Sichere Kasse",
  "Select Tickets": "Tickets auswählen",
  "Select Your Seats": "Wählen Sie Ihre Plätze",
  "Select seats above to continue": "Wählen Sie oben Plätze aus, um fortzufahren",
  "Select tickets above to continue": "Wählen Sie oben Tickets aus, um fortzufahren",
  "Selected Seats": "Ausgewählte Plätze",
  "Service Fee": "Servicegebühr",
  "Subtotal": "Zwischensumme",
  "Total Amount": "Gesamtbetrag",
  "View your ticket": "Ticket ansehen",
  "each": "je",
  "per ticket": "pro Ticket",
  "seat": "Platz",
  "seats": "Plätze",
  ...
  "Your registration was successful.": "Ihre Registrierung war erfolgreich.",
  "Ticket Not Found": "Ticket Nicht Gefunden",
  "Your Ticket": "Ihr Ticket",
  "Loading your ticket...": "Ihr Ticket wird geladen...",
  "Show this QR code at the entrance or": "Zeigen Sie diesen QR-Code am Eingang oder",
  "Show this QR code at the entrance.": "Zeigen Sie diesen QR-Code am Eingang.",
  "Download QR": "QR Herunterladen",
  "Individual Tickets": "Einzelne Tickets",
  "QR Code for All Tickets": "QR-Code für Alle Tickets",
  "Scan this QR for all tickets": "Scannen Sie diesen QR-Code für alle Tickets",
  "Individual ticket": "Einzelticket",
  "All Tickets QR": "Alle Tickets QR",
  "ID": "ID",
  "Unable to load ticket information. Please check the URL and try again.": "Ticketinformationen konnten nicht geladen werden. Bitte überprüfen Sie die URL und versuchen Sie es erneut.",
};
export default de;
