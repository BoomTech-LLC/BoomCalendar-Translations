let pl = {
  "Missing guest ID": "Brak identyfikatora gościa",
  "Failed to fetch guest data": "Nie udało się pobrać danych gościa",
  "Failed to fetch tickets": "Nie udało się pobrać biletów",
  "Failed to load ticket data": "Nie udało się załadować danych biletu",
  "Ticket already bought": "Bilet już kupiony",
  ...
  "You can move your mouse outside the seatmap while dragging - the selection will still apply when you release.": "Podczas przeciągania możesz przesuwać mysz poza mapę miejsc — zaznaczenie nadal będzie obowiązywać po puszczeniu myszy.",
  "Tip:": "Wskazówka:",
  "Use the +/- buttons to zoom in and out": "Użyj przycisków +/-, aby powiększyć lub pomniejszyć",
  "Click and drag the background to pan around the venue": "Kliknij i przeciągnij tło, aby przesuwać widok wokół obiektu",
  "Pan & Zoom": "Przesuwanie i powiększanie",
  "Capacity is shared across all seatmaps for the same event": "Pojemność jest współdzielona na wszystkich planach miejsc na to samo wydarzenie",
  "Use the - button to remove tickets from your selection": "Użyj przycisku -, aby usunąć bilety z wyboru",
  "Use the + button to add tickets to your selection": "Użyj przycisku +, aby dodać bilety do swojego wyboru",
  "Standing areas show the number of tickets remaining": "Miejsca stojące pokazują liczbę pozostałych biletów",
  "Standing Areas": "Miejsca stojące",
  "Remove keyboard focus from seats": "Usuń fokus klawiatury z miejsc",
  "Clear Focus": "Wyraźne skupienie",
  "Toggle the focused seat": "Przełącz wybrane miejsce",
  "Select / Deselect Seat": "Wybierz / Odznacz miejsce",
  "Move between available seats": "Przemieszczaj się między dostępnymi miejscami",
  "Navigate Seats": "Nawiguj po miejscach",
  "Use your keyboard to navigate and select seats without a mouse:": "Użyj klawiatury, aby poruszać się po miejscach i wybierać je bez użycia myszy:",
  "Keyboard Navigation": "Nawigacja za pomocą klawiatury",
  "Click an empty area to deselect all seats": "Kliknij pusty obszar, aby odznaczyć wszystkie miejsca",
  "Drag across multiple seats to toggle-select them": "Przeciągnij przez wiele miejsc, aby je przełączyć i zaznaczyć",
  "Click a selected seat again to deselect it": "Aby odznaczyć wybrane miejsce, kliknij je ponownie",
  "Click a seat to select it": "Kliknij miejsce, aby je wybrać",
  "Selecting Seats": "Wybór miejsc",
  "How to Select Seats": "Jak wybierać miejsca",
  "How to Use": "Jak używać",
  "Pay": "Płacić",
  "Book": "Książka",
  "This promo code has already been used": "Ten kod promocyjny został już wykorzystany",
  "This promo code is not yet active": "Ten kod promocyjny nie jest jeszcze aktywny",
  "This promo code has expired": "Ten kod promocyjny wygasł",
  "Invalid promo code": "Nieprawidłowy kod promocyjny",
  "Credit / Debit Card": "Karta kredytowa/debetowa",
  "Fast & secure checkout": "Szybka i bezpieczna płatność",
  "Secure payment via Wix": "Bezpieczna płatność za pośrednictwem Wix",
  "Pay at the venue": "Zapłać na miejscu",
  "Registration": "Rejestracja",
  "Attendee Information": "Informacje dla uczestników",
  "Your information is secure and will only be used for event registration": "Twoje dane są bezpieczne i zostaną wykorzystane wyłącznie do rejestracji na wydarzenie",
  "Your information is secure and will only be used for ticket delivery": "Twoje dane są bezpieczne i zostaną wykorzystane wyłącznie do dostarczenia biletów",
  "Register": "Rejestr",
  "Event is fully booked": "Wydarzenie jest w pełni zarezerwowane",
  "To Event": "Do wydarzenia",
  "Guest Details": "Szczegóły gościa",
  "Because it was a Draft": "Ponieważ to był projekt",
  "You can't see your event": "Nie możesz zobaczyć swojego wydarzenia",
  "The event is currently happening. If you believe this is an error, please contact the event organizer.": "Wydarzenie jest w trakcie realizacji. Jeśli uważasz, że to błąd, skontaktuj się z organizatorem wydarzenia.",
  "Registration is closed because this event has already started.": "Rejestracja została zamknięta, ponieważ wydarzenie już się rozpoczęło.",
  "Event In Progress": "Wydarzenie w toku",
  "The event organizer is still preparing this event. Please check back later or contact the organizer for more information.": "Organizator wydarzenia wciąż je przygotowuje. Sprawdź później lub skontaktuj się z organizatorem, aby uzyskać więcej informacji.",
  "Event": "Wydarzenie",
  "This event is currently in draft mode and not available for registration yet.": "Wydarzenie jest obecnie w fazie roboczej i rejestracja na nie nie jest jeszcze możliwa.",
  "This event is currently in draft mode and not yet available for viewing.": "To wydarzenie jest obecnie w fazie roboczej i nie jest jeszcze dostępne do obejrzenia.",
  "Event Not Published": "Wydarzenie nieopublikowane",
  "Draft Mode": "Tryb roboczy",
  "Back": "Z powrotem",
  "Go": "Iść",
  "Could not find requested resource": "Nie można znaleźć żądanego zasobu",
  "Not Found 404": "Nie znaleziono 404",
  "Loading...": "Załadunek...",
  "Loading": "Załadunek",
  "Instant confirmation": "Natychmiastowe potwierdzenie",
  "Access to all performances": "Dostęp do wszystkich przedstawień",
  ...
  "Your information is secure and will only be used for ticket delivery": "Twoje dane są bezpieczne i zostaną wykorzystane wyłącznie do dostarczenia biletów",
  "per ticket": "za bilet",
  "Select tickets above to continue": "Aby kontynuować, wybierz bilety powyżej",
  "Select seats above to continue": "Aby kontynuować, wybierz miejsca powyżej",
  ...
  "Sync": "Synchronizacja",
  "Connected": "Połączony",
  "Removes the connection to your Google account. Previously imported events will remain on your calendar.": "Usuwa połączenie z Twoim kontem Google. Wcześniej zaimportowane wydarzenia pozostaną w Twoim kalendarzu.",
  "A wider range means more events to load. If your calendar feels slow, try narrowing the range to match the view you use most (e.g. monthly view needs a shorter range than yearly).": "Szerszy zakres oznacza więcej wydarzeń do załadowania. Jeśli Twój kalendarz działa wolno, spróbuj zawęzić zakres do widoku, którego używasz najczęściej (np. widok miesięczny wymaga krótszego zakresu niż roczny).",
  "Sync Date Range": "Zakres dat synchronizacji",
  "Sync categories": "Synchronizuj kategorie",
  "Hide event description": "Ukryj opis wydarzenia",
  "Hide private events": "Ukryj wydarzenia prywatne",
  "No synchronized calendars yet. Select a calendar above and click Sync to start.": "Brak zsynchronizowanych kalendarzy. Wybierz kalendarz powyżej i kliknij „Synchronizuj”, aby rozpocząć.",
  "Fetches current events so you can add them one by one.": "Pobiera bieżące wydarzenia, dzięki czemu możesz dodawać je jedno po drugim.",
  "Keeps events continuously updated in real time.": "Aktualizuje wydarzenia na bieżąco i na bieżąco.",
  ...
  "Your registration was successful.": "Twoja rejestracja przebiegła pomyślnie.",
  "Ticket Not Found": "Bilet Nie Znaleziony",
  "Your Ticket": "Twój Bilet",
  "Loading your ticket...": "Ładowanie biletu...",
  "Show this QR code at the entrance or": "Pokaż ten kod QR przy wejściu lub",
  "Show this QR code at the entrance.": "Pokaż ten kod QR przy wejściu.",
  "Download QR": "Pobierz QR",
  "Individual Tickets": "Pojedyncze Bilety",
  "QR Code for All Tickets": "Kod QR dla Wszystkich Biletów",
  "Scan this QR for all tickets": "Zeskanuj ten kod QR dla wszystkich biletów",
  "Individual ticket": "Pojedynczy bilet",
  "All Tickets QR": "QR Wszystkich Biletów",
  "ID": "ID",
  "Unable to load ticket information. Please check the URL and try again.": "Nie można załadować informacji o bilecie. Sprawdź URL i spróbuj ponownie.",
};
export default pl;
