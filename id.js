let id = {
  "Missing guest ID": "ID tamu hilang",
  "Failed to fetch guest data": "Gagal mengambil data tamu",
  "Failed to fetch tickets": "Gagal mengambil tiket.",
  "Failed to load ticket data": "Gagal memuat data tiket",
  ...
  "You can move your mouse outside the seatmap while dragging - the selection will still apply when you release.": "Anda dapat menggerakkan mouse keluar dari peta tempat duduk saat menyeret - pilihan akan tetap berlaku saat Anda melepaskannya.",
  "Tip:": "Tip:",
  "Use the +/- buttons to zoom in and out": "Gunakan tombol +/- untuk memperbesar dan memperkecil tampilan.",
  "Click and drag the background to pan around the venue": "Klik dan seret latar belakang untuk menggeser tampilan tempat tersebut.",
  "Pan & Zoom": "Geser & Perbesar",
  "Capacity is shared across all seatmaps for the same event": "Kapasitas dibagi rata di semua denah tempat duduk untuk acara yang sama.",
  "Use the - button to remove tickets from your selection": "Gunakan tombol - untuk menghapus tiket dari pilihan Anda.",
  "Use the + button to add tickets to your selection": "Gunakan tombol + untuk menambahkan tiket ke pilihan Anda",
  "Standing areas show the number of tickets remaining": "Area berdiri menunjukkan jumlah tiket yang tersisa.",
  "Standing Areas": "Area Berdiri",
  "Remove keyboard focus from seats": "Alihkan fokus keyboard dari kursi.",
  "Clear Focus": "Fokus yang Jelas",
  "Toggle the focused seat": "Alihkan kursi yang difokuskan",
  "Select / Deselect Seat": "Pilih / Batalkan Pilihan Kursi",
  "Move between available seats": "Berpindah-pindah antar kursi yang tersedia",
  "Navigate Seats": "Navigasi Kursi",
  "Use your keyboard to navigate and select seats without a mouse:": "Gunakan keyboard Anda untuk bernavigasi dan memilih tempat duduk tanpa menggunakan mouse:",
  "Keyboard Navigation": "Navigasi Keyboard",
  "Click an empty area to deselect all seats": "Klik area kosong untuk membatalkan pilihan semua kursi.",
  "Drag across multiple seats to toggle-select them": "Seret beberapa kursi untuk mengaktifkan/menonaktifkan pemilihan kursi.",
  "Click a selected seat again to deselect it": "Klik kursi yang sudah dipilih lagi untuk membatalkannya.",
  "Click a seat to select it": "Klik kursi untuk memilihnya",
  "Selecting Seats": "Memilih Tempat Duduk",
  "How to Select Seats": "Cara Memilih Tempat Duduk",
  "How to Use": "Cara Penggunaan",
  "Pay": "Membayar",
  "Book": "Buku",
  "This promo code has already been used": "Kode promo ini sudah digunakan.",
  "This promo code is not yet active": "Kode promo ini belum aktif.",
  "This promo code has expired": "Kode promo ini telah kedaluwarsa.",
  "Invalid promo code": "Kode promo tidak valid",
  "Credit / Debit Card": "Kartu Kredit / Debit",
  "Fast & secure checkout": "Proses pembayaran cepat & aman",
  "Secure payment via Wix": "Pembayaran aman melalui Wix",
  "Pay at the venue": "Bayar di tempat acara",
  "Registration": "Pendaftaran",
  "Attendee Information": "Informasi Peserta",
  "Your information is secure and will only be used for event registration": "Informasi Anda aman dan hanya akan digunakan untuk pendaftaran acara.",
  "Your information is secure and will only be used for ticket delivery": "Informasi Anda aman dan hanya akan digunakan untuk pengiriman tiket.",
  "Register": "Daftar",
  "Event is fully booked": "Acara ini sudah penuh dipesan.",
  "To Event": "Ke Acara",
  "Guest Details": "Detail Tamu",
  "Because it was a Draft": "Karena itu adalah sebuah Draf.",
  "You can't see your event": "Anda tidak dapat melihat acara Anda",
  "The event is currently happening. If you believe this is an error, please contact the event organizer.": "Acara sedang berlangsung. Jika Anda yakin ini adalah kesalahan, silakan hubungi penyelenggara acara.",
  "Registration is closed because this event has already started.": "Pendaftaran telah ditutup karena acara ini sudah dimulai.",
  "Event In Progress": "Acara Sedang Berlangsung",
  "The event organizer is still preparing this event. Please check back later or contact the organizer for more information.": "Panitia penyelenggara masih mempersiapkan acara ini. Silakan periksa kembali nanti atau hubungi panitia penyelenggara untuk informasi lebih lanjut.",
  "Event": "Peristiwa",
  "This event is currently in draft mode and not available for registration yet.": "Acara ini saat ini masih dalam tahap draf dan belum tersedia untuk pendaftaran.",
  "This event is currently in draft mode and not yet available for viewing.": "Acara ini saat ini masih dalam tahap draf dan belum tersedia untuk dilihat.",
  "Event Not Published": "Acara Tidak Dipublikasikan",
  "Draft Mode": "Mode Draf",
  "Back": "Kembali",
  "Go": "Pergi",
  "Could not find requested resource": "Sumber daya yang diminta tidak ditemukan.",
  "Not Found 404": "Tidak Ditemukan 404",
  "Loading...": "Memuat...",
  "Loading": "Memuat",
  ...
  "Your information is secure and will only be used for event registration": "Informasi Anda aman dan hanya akan digunakan untuk pendaftaran acara.",
  "Your information is secure and will only be used for ticket delivery": "Informasi Anda aman dan hanya akan digunakan untuk pengiriman tiket.",
  "per ticket": "per tiket",
  "Select tickets above to continue": "Pilih tiket di atas untuk melanjutkan",
  "Select seats above to continue": "Pilih kursi di atas untuk melanjutkan",
  "Select Tickets": "Pilih Tiket",
  "Gallery": "Galeri",
  "Secure checkout": "Pembayaran aman",
  ...
  "Sync Date Range": "Sinkronkan Rentang Tanggal",
  "Sync categories": "Sinkronkan kategori",
  "Hide event description": "Sembunyikan deskripsi acara",
  "Hide private events": "Sembunyikan acara pribadi",
  "No synchronized calendars yet. Select a calendar above and click Sync to start.": "Belum ada kalender yang disinkronkan. Pilih kalender di atas dan klik Sinkronkan untuk memulai.",
  "Fetches current events so you can add them one by one.": "Mengambil data peristiwa terkini sehingga Anda dapat menambahkannya satu per satu.",
  "Keeps events continuously updated in real time.": "Memastikan peristiwa terus diperbarui secara real-time.",
  ...
  "Cross Event Limit": "Batas Acara Lintas",
  "Show events limit": "Tampilkan batas acara",
  "Show tooltip/popup": "Tampilkan tooltip/popup",
  "Bold Monthly Dividers": "Pembagi Bulanan Tebal",
  "Scroll to see more events": "Gulir untuk melihat lebih banyak acara",
  "Show additional date": "Tampilkan tanggal tambahan",
  ...
  "Reset Layouts Dimensions": "Setel ulang dimensi tata letak",
  "Clear": "Jernih",
  "Undo": "Membuka",
  "Redo": "Mengulangi",
  "Code Panel": "Panel kode",
  "Code Panel Notify": "Modifikasi kode secara langsung dapat memecahkan tata letak atau fungsionalitas aplikasi. Hanya edit jika Anda tahu apa yang Anda lakukan!",
  "Clear Editor": "Editor yang jelas",
  "Clear Editor Notify": "Anda yakin ingin membersihkan editor? Semua kemajuan akan hilang!",
  "Nothing to edit": "Tidak ada yang bisa diedit!",
  "Shapes": "Bentuk",
  "Delete The Shape": "Hapus bentuknya",
  "Add shapes": "Tambahkan bentuk antara tata letak dan sesuaikan!",
  "Preview unavailable": "Pratinjau komponen tidak tersedia untuk komponen",
  ...
  "Text Alignment": "Penyelarasan teks",
  "Left Alignment": "Alignment kiri",
  "Center Alignment": "Penyelarasan Pusat",
  "Right Alignment": "Penyelarasan yang benar",
  "Text Decoration": "Dekorasi teks",
  "Overline": "Overline",
  "Line Through": "Berbaris melalui",
  "Underline": "Menggarisbawahi",
  "Underline and Overline": "Garis bawah dan overline",
  "Without Decoration": "Tanpa dekorasi",
  "Left": "Kiri",
  "Angle": "Sudut",
  "Distance": "Jarak",
  "Blur": "Mengaburkan",
  "Size": "Ukuran",
  "Edit individually": "Edit secara individual",
  "Apply to all corners": "Oleskan ke semua sudut",
  "Date Box Visual": "Visual kotak tanggal",
  "One Line": "Satu baris",
  "Show Icons": "Tampilkan ikon",
  "Design Settings": "Pengaturan Desain",
  "Personalize your editor to match your style and preferences, customize every detail in this settings tab !": "Personalisasi editor Anda agar sesuai dengan gaya dan preferensi Anda, sesuaikan setiap detail di tab Pengaturan ini!",
  "Divider": "Pembagi",
  "Ellipse": "Elips",
