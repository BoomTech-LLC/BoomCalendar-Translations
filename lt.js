let lt = {
  ...
  "You can move your mouse outside the seatmap while dragging - the selection will still apply when you release.": "Vilkdami pelę galite perkelti ją už vietų žemėlapio ribų – pasirinkimas išliks ir atleisdami.",
  "Tip:": "Patarimas:",
  "Use the +/- buttons to zoom in and out": "Norėdami priartinti arba atitolinti vaizdą, naudokite mygtukus +/-",
  "Click and drag the background to pan around the venue": "Spustelėkite ir vilkite foną, kad judėtumėte aplink renginio vietą",
  "Pan & Zoom": "Pastūmimas ir priartinimas",
  "Capacity is shared across all seatmaps for the same event": "Talpa tame pačiame renginyje paskirstoma visoms vietų planams",
  "Use the - button to remove tickets from your selection": "Norėdami pašalinti bilietus iš savo pasirinkimo, naudokite mygtuką „-“.",
  "Use the + button to add tickets to your selection": "Norėdami pridėti bilietus prie savo pasirinkimo, naudokite mygtuką +",
  "Standing areas show the number of tickets remaining": "Stovimose zonose rodomas likusių bilietų skaičius",
  "Standing Areas": "Stovimos zonos",
  "Remove keyboard focus from seats": "Pašalinti klaviatūros fokusavimą nuo vietų",
  "Clear Focus": "Aiškus fokusavimas",
  "Toggle the focused seat": "Perjungti sufokusuotą vietą",
  "Select / Deselect Seat": "Pasirinkti / Atšaukti vietos pasirinkimą",
  "Move between available seats": "Pereiti tarp laisvų vietų",
  "Navigate Seats": "Naviguoti sėdynes",
  "Use your keyboard to navigate and select seats without a mouse:": "Norėdami naršyti ir pasirinkti vietas, naudokite klaviatūrą be pelės:",
  "Keyboard Navigation": "Klaviatūros navigacija",
  "Click an empty area to deselect all seats": "Spustelėkite tuščią sritį, kad panaikintumėte visų vietų pasirinkimą",
  "Drag across multiple seats to toggle-select them": "Vilkite per kelias vietas, kad jas pasirinktumėte.",
  "Click a selected seat again to deselect it": "Dar kartą spustelėkite pasirinktą vietą, kad ją panaikintumėte",
  "Click a seat to select it": "Spustelėkite vietą, kad ją pasirinktumėte",
  "Selecting Seats": "Vietų pasirinkimas",
  "How to Select Seats": "Kaip išsirinkti vietas",
  "How to Use": "Kaip naudoti",
  "Pay": "Mokėti",
  "Book": "Knyga",
  "This promo code has already been used": "Šis reklamos kodas jau panaudotas",
  "This promo code is not yet active": "Šis reklamos kodas dar neaktyvus",
  "This promo code has expired": "Šis reklamos kodas nebegalioja",
  "Invalid promo code": "Neteisingas reklamos kodas",
  "Credit / Debit Card": "Kreditinė / debetinė kortelė",
  "Fast & secure checkout": "Greitas ir saugus atsiskaitymas",
  "Secure payment via Wix": "Saugus mokėjimas per „Wix“",
  "Pay at the venue": "Mokėti renginio vietoje",
  "Registration": "Registracija",
  "Attendee Information": "Dalyvio informacija",
  "Your information is secure and will only be used for event registration": "Jūsų informacija yra saugi ir bus naudojama tik renginio registracijai",
  "Your information is secure and will only be used for ticket delivery": "Jūsų informacija yra saugi ir bus naudojama tik bilietų pristatymui",
  "Register": "Registruotis",
  "Event is fully booked": "Renginys visiškai rezervuotas",
  "To Event": "Į renginį",
  "Guest Details": "Svečio duomenys",
  "Because it was a Draft": "Nes tai buvo juodraštis",
  "You can't see your event": "Nematote savo įvykio",
  "The event is currently happening. If you believe this is an error, please contact the event organizer.": "Renginys šiuo metu vyksta. Jei manote, kad tai klaida, susisiekite su renginio organizatoriumi.",
  "Registration is closed because this event has already started.": "Registracija baigta, nes šis renginys jau prasidėjo.",
  "Event In Progress": "Vyksta įvykis",
  "The event organizer is still preparing this event. Please check back later or contact the organizer for more information.": "Renginio organizatorius vis dar ruošia šį renginį. Norėdami gauti daugiau informacijos, patikrinkite vėliau arba susisiekite su organizatoriumi.",
  "Event": "Įvykis",
  "This event is currently in draft mode and not available for registration yet.": "Šis renginys šiuo metu yra juodraščio būsenoje ir registracija dar negalima.",
  "This event is currently in draft mode and not yet available for viewing.": "Šis įvykis šiuo metu yra juodraščio režimu ir dar nepasiekiamas peržiūrai.",
  "Event Not Published": "Įvykis nepaskelbtas",
  "Draft Mode": "Juodraščio režimas",
  "Back": "Atgal",
  "Go": "Eiti",
  "Could not find requested resource": "Nepavyko rasti prašomo ištekliaus",
  "Not Found 404": "Nerasta 404",
  "Loading...": "Kraunama...",
  "Loading": "Kraunama",
  ...
  "Your information is secure and will only be used for event registration": "Jūsų informacija yra saugi ir bus naudojama tik renginio registracijai",
  "Your information is secure and will only be used for ticket delivery": "Jūsų informacija yra saugi ir bus naudojama tik bilietų pristatymui",
  "per ticket": "už bilietą",
  "Select tickets above to continue": "Norėdami tęsti, pasirinkite bilietus aukščiau",
  "Select seats above to continue": "Norėdami tęsti, pasirinkite vietas viršuje",
  "Select Tickets": "Pasirinkite bilietus",
  "Gallery": "Galerija",
  "Secure checkout": "Saugus atsiskaitymas",
  "About This Event": "Apie šį įvykį",
  "Available Spots": "Laisvos vietos",
  "TICKET TYPES": "BILIETŲ TIPAI",
  "TICKET TYPE": "BILIETŲ TIPAS",
  ...
  "Sync Date Range": "Sinchronizavimo datų diapazonas",
  "Sync categories": "Sinchronizuoti kategorijas",
  "Hide event description": "Slėpti įvykio aprašymą",
  "Hide private events": "Slėpti privačius įvykius",
  "No synchronized calendars yet. Select a calendar above and click Sync to start.": "Kol kas nėra sinchronizuotų kalendorių. Pasirinkite kalendorių aukščiau ir spustelėkite „Sinchronizuoti“, kad pradėtumėte.",
  "Fetches current events so you can add them one by one.": "Nuskaito dabartinius įvykius, kad galėtumėte juos pridėti po vieną.",
  "Keeps events continuously updated in real time.": "Nuolat atnaujina įvykius realiuoju laiku.",
  ...
  "Cross Event Limit": "Kryžminis įvykių limitas",
  "Show events limit": "Rodyti įvykių limitą",
  "Show tooltip/popup": "Rodyti patarimą / iššokantįjį langą",
  "Bold Monthly Dividers": "Drąsūs mėnesio skirstytuvai",
  "Scroll to see more events": "Slinkite, kad pamatytumėte daugiau įvykių",
  "Show additional date": "Rodyti papildomą datą",
