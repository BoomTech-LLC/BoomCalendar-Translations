let mk = {
  ...
  "You can move your mouse outside the seatmap while dragging - the selection will still apply when you release.": "Можете да го поместите глувчето надвор од мапата на седиштата додека влечете - изборот ќе се примени и кога ќе го отпуштите.",
  "Tip:": "Совет:",
  "Use the +/- buttons to zoom in and out": "Користете ги копчињата +/- за зумирање и одзумирање",
  "Click and drag the background to pan around the venue": "Кликнете и повлечете ја позадината за да се движите низ местото на одржување",
  "Pan & Zoom": "Панорамирање и зумирање",
  "Capacity is shared across all seatmaps for the same event": "Капацитетот е споделен низ сите мапи на седишта за истиот настан",
  "Use the - button to remove tickets from your selection": "Користете го копчето - за да отстраните билети од вашиот избор",
  "Use the + button to add tickets to your selection": "Користете го копчето + за да додадете билети во вашиот избор",
  "Standing areas show the number of tickets remaining": "Просторите за стоење го прикажуваат бројот на преостанати билети",
  "Standing Areas": "Стоечки области",
  "Remove keyboard focus from seats": "Отстранете го фокусот на тастатурата од седиштата",
  "Clear Focus": "Јасен фокус",
  "Toggle the focused seat": "Вклучи/исклучи го фокусираното седиште",
  "Select / Deselect Seat": "Изберете / Поништете го изборот на седиште",
  "Move between available seats": "Преместување помеѓу достапните седишта",
  "Navigate Seats": "Навигација низ седиштата",
  "Use your keyboard to navigate and select seats without a mouse:": "Користете ја тастатурата за навигација и избирање седишта без глушец:",
  "Keyboard Navigation": "Навигација со тастатура",
  "Click an empty area to deselect all seats": "Кликнете на празен простор за да го поништите изборот на сите седишта",
  "Drag across multiple seats to toggle-select them": "Повлечете низ повеќе седишта за да ги изберете/исклучите",
  "Click a selected seat again to deselect it": "Кликнете повторно на избраното седиште за да го поништите изборот",
  "Click a seat to select it": "Кликнете на седиште за да го изберете",
  "Selecting Seats": "Избор на седишта",
  "How to Select Seats": "Како да изберете седишта",
  "How to Use": "Како да се користи",
  "Pay": "Плати",
  "Book": "Книга",
  "This promo code has already been used": "Овој промотивен код е веќе искористен",
  "This promo code is not yet active": "Овој промотивен код сè уште не е активен",
  "This promo code has expired": "Овој промотивен код е истечен",
  "Invalid promo code": "Неважечки промотивен код",
  "Credit / Debit Card": "Кредитна / Дебитна картичка",
  "Fast & secure checkout": "Брза и безбедна наплата",
  "Secure payment via Wix": "Безбедно плаќање преку Wix",
  "Pay at the venue": "Плаќање на местото на настанот",
  "Registration": "Регистрација",
  "Attendee Information": "Информации за присутните",
  "Your information is secure and will only be used for event registration": "Вашите информации се безбедни и ќе се користат само за регистрација на настанот",
  "Your information is secure and will only be used for ticket delivery": "Вашите информации се безбедни и ќе се користат само за испорака на билети",
  "Register": "Регистрирај се",
  "Event is fully booked": "Настанот е целосно резервиран",
  "To Event": "До настан",
  "Guest Details": "Податоци за гостинот",
  "Because it was a Draft": "Бидејќи беше нацрт",
  "You can't see your event": "Не можете да го видите вашиот настан",
  "The event is currently happening. If you believe this is an error, please contact the event organizer.": "Настанот моментално се одвива. Доколку сметате дека станува збор за грешка, контактирајте го организаторот на настанот.",
  "Registration is closed because this event has already started.": "Регистрацијата е затворена бидејќи овој настан веќе започна.",
  "Event In Progress": "Настан во тек",
  "The event organizer is still preparing this event. Please check back later or contact the organizer for more information.": "Организаторот на настанот сè уште го подготвува овој настан. Ве молиме проверете подоцна или контактирајте го организаторот за повеќе информации.",
  "Event": "Настан",
  "This event is currently in draft mode and not available for registration yet.": "Овој настан моментално е во нацрт-режим и сè уште не е достапен за регистрација.",
  "This event is currently in draft mode and not yet available for viewing.": "Овој настан моментално е во нацрт-режим и сè уште не е достапен за прегледување.",
  "Event Not Published": "Настанот не е објавен",
  "Draft Mode": "Режим на нацрт",
  "Back": "Назад",
  "Go": "Оди",
  "Could not find requested resource": "Не може да се пронајде бараниот ресурс",
  "Not Found 404": "Не е пронајдено 404",
  "Loading...": "Се вчитува...",
  "Loading": "Вчитување",
  ...
  "Your information is secure and will only be used for ticket delivery": "Вашите информации се безбедни и ќе се користат само за испорака на билети",
  "per ticket": "по билет",
  "Select tickets above to continue": "Изберете билети погоре за да продолжите",
  "Select seats above to continue": "Изберете седишта погоре за да продолжите",
  "Select Tickets": "Изберете билети",
  "Gallery": "Галерија",
  "Secure checkout": "Безбедна наплата",
  "About This Event": "За овој настан",
  "Available Spots": "Достапни места",
  "TICKET TYPES": "ВИДОВИ НА БИЛЕТИ",
  "TICKET TYPE": "ТИП НА БИЛЕТ",
  "Sync": "Синхронизирај",
  "Connected": "Поврзано",
  "Removes the connection to your Google account. Previously imported events will remain on your calendar.": "Ја отстранува врската со вашата сметка на Google. Претходно увезените настани ќе останат во вашиот календар.",
  "A wider range means more events to load. If your calendar feels slow, try narrowing the range to match the view you use most (e.g. monthly view needs a shorter range than yearly).": "Поширок опсег значи повеќе настани за вчитување. Ако вашиот календар ви се чини бавен, обидете се да го стесните опсегот за да одговара на приказот што го користите најчесто (на пр., месечниот приказ бара пократок опсег од годишниот).",
  "Sync Date Range": "Синхронизирај опсег на датуми",
  "Sync categories": "Синхронизирај категории",
  "Hide event description": "Сокриј опис на настанот",
  "Hide private events": "Сокриј приватни настани",
  "No synchronized calendars yet. Select a calendar above and click Sync to start.": "Сè уште нема синхронизирани календари. Изберете календар погоре и кликнете Синхронизирај за да започнете.",
  "Fetches current events so you can add them one by one.": "Ги презема тековните настани за да можете да ги додавате еден по еден.",
  "Keeps events continuously updated in real time.": "Ги одржува настаните постојано ажурирани во реално време.",
