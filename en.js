let en = {
  ...
  "You can move your mouse outside the seatmap while dragging - the selection will still apply when you release.": "You can move your mouse outside the seatmap while dragging - the selection will still apply when you release.",
  "Tip:": "Tip:",
  "Use the +/- buttons to zoom in and out": "Use the +/- buttons to zoom in and out",
  "Click and drag the background to pan around the venue": "Click and drag the background to pan around the venue",
  "Pan & Zoom": "Pan & Zoom",
  "Capacity is shared across all seatmaps for the same event": "Capacity is shared across all seatmaps for the same event",
  "Use the - button to remove tickets from your selection": "Use the - button to remove tickets from your selection",
  "Use the + button to add tickets to your selection": "Use the + button to add tickets to your selection",
  "Standing areas show the number of tickets remaining": "Standing areas show the number of tickets remaining",
  "Standing Areas": "Standing Areas",
  "Remove keyboard focus from seats": "Remove keyboard focus from seats",
  "Clear Focus": "Clear Focus",
  "Toggle the focused seat": "Toggle the focused seat",
  "Select / Deselect Seat": "Select / Deselect Seat",
  "Move between available seats": "Move between available seats",
  "Navigate Seats": "Navigate Seats",
  "Use your keyboard to navigate and select seats without a mouse:": "Use your keyboard to navigate and select seats without a mouse:",
  "Keyboard Navigation": "Keyboard Navigation",
  "Click an empty area to deselect all seats": "Click an empty area to deselect all seats",
  "Drag across multiple seats to toggle-select them": "Drag across multiple seats to toggle-select them",
  "Click a selected seat again to deselect it": "Click a selected seat again to deselect it",
  "Click a seat to select it": "Click a seat to select it",
  "Selecting Seats": "Selecting Seats",
  "How to Select Seats": "How to Select Seats",
  "How to Use": "How to Use",
  "Pay": "Pay",
  "Book": "Book",
  "This promo code has already been used": "This promo code has already been used",
  "This promo code is not yet active": "This promo code is not yet active",
  "This promo code has expired": "This promo code has expired",
  "Invalid promo code": "Invalid promo code",
  "Credit / Debit Card": "Credit / Debit Card",
  "Fast & secure checkout": "Fast & secure checkout",
  "Secure payment via Wix": "Secure payment via Wix",
  "Pay at the venue": "Pay at the venue",
  "Registration": "Registration",
  "Attendee Information": "Attendee Information",
  "Your information is secure and will only be used for event registration": "Your information is secure and will only be used for event registration",
  "Your information is secure and will only be used for ticket delivery": "Your information is secure and will only be used for ticket delivery",
  "Register": "Register",
  "Event is fully booked": "Event is fully booked",
  "To Event": "To Event",
  "Guest Details": "Guest Details",
  "Because it was a Draft": "Because it was a Draft",
  "You can't see your event": "You can't see your event",
  "The event is currently happening. If you believe this is an error, please contact the event organizer.": "The event is currently happening. If you believe this is an error, please contact the event organizer.",
  "Registration is closed because this event has already started.": "Registration is closed because this event has already started.",
  "Event In Progress": "Event In Progress",
  "The event organizer is still preparing this event. Please check back later or contact the organizer for more information.": "The event organizer is still preparing this event. Please check back later or contact the organizer for more information.",
  "Event": "Event",
  "This event is currently in draft mode and not available for registration yet.": "This event is currently in draft mode and not available for registration yet.",
  "This event is currently in draft mode and not yet available for viewing.": "This event is currently in draft mode and not yet available for viewing.",
  "Event Not Published": "Event Not Published",
  ...
  "Select tickets above to continue": "Select tickets above to continue",
  "Select seats above to continue": "Select seats above to continue",
  ...
  "Sync": "Sync",
  "Connected": "Connected",
  "Removes the connection to your Google account. Previously imported events will remain on your calendar.": "Removes the connection to your Google account. Previously imported events will remain on your calendar.",
  "A wider range means more events to load. If your calendar feels slow, try narrowing the range to match the view you use most (e.g. monthly view needs a shorter range than yearly).": "A wider range means more events to load. If your calendar feels slow, try narrowing the range to match the view you use most (e.g. monthly view needs a shorter range than yearly).",
  "Sync Date Range": "Sync Date Range",
  "Sync categories": "Sync categories",
  "Hide event description": "Hide event description",
  "Hide private events": "Hide private events",
  "No synchronized calendars yet. Select a calendar above and click Sync to start.": "No synchronized calendars yet. Select a calendar above and click Sync to start.",
  "Fetches current events so you can add them one by one.": "Fetches current events so you can add them one by one.",
  "Keeps events continuously updated in real time.": "Keeps events continuously updated in real time.",
  "Your Api Key": "Your Api Key",
  "Fahrenheit": "Fahrenheit",
  "Celsius": "Celsius",
  "Select the city from the suggestions": "Select the city from the suggestions",
  "Weather Forecast": "Weather Forecast",
  "Cross Event Limit": "Cross Event Limit",
  "Show events limit": "Show events limit",
  "Show tooltip/popup": "Show tooltip/popup",
  "Bold Monthly Dividers": "Bold Monthly Dividers",
  "Scroll to see more events": "Scroll to see more events",
  "Show additional date": "Show additional date",
  ...
  "Limit": "Limit",
  "Export": "Export",
  "You are about to change the details of your event. Once changed, your guest list will be lost.": "You are about to change the details of your event. Once changed, your guest list will be lost.",
  ...
  "Accept": "Accept",
  "Reject": "Reject",
  "See guest list": "See guest list",
  "Submit Date": "Submit Date",
  "Total guests": "Total guests",
  "Do you really want to delete selected user? Once removed, cannot be undone.": "Do you really want to delete selected user? Once removed, cannot be undone.",
  "Delete Guest": "Delete Guest",
  "Invoice number": "Invoice number",
  "Status": "Status",
  "Payment type": "Payment type",
  "Select payment method to receive fees through tickets": "Select payment method to receive fees through tickets",
  "Add Code": "Add Code",
  "Add End Time": "Add End Time",
  "Discount": "Discount",
  "Promo codes for the sales": "Promo codes for the sales",
  "Promo codes": "Promo codes",
  "Add Ticket": "Add Ticket",
  "Limit type": "Limit type",
  "Paid": "Paid",
  "Participation tickets for your event": "Participation tickets for your event",
  "Show the ticket limit": "Show the ticket limit",
  "Show limit": "Show limit",
  "Show the price on ticket": "Show the price on ticket",
  "Enable and configure your ticketing system": "Enable and configure your ticketing system",
  "Stop repeating here": "Stop repeating here",
  "Limited": "Limited",
  "Unlimited": "Unlimited",
  ...
  "Texts": "Texts",
  "Modify the displayed texts": "Modify the displayed texts",
  "Thank you message body": "Thank you message body",
  "Notify the user when the registration is canceled": "Notify the user when the registration is canceled",
  "Cancellation email": "Cancellation email",
  "Send a reminder to the user one day prior to the event": "Send a reminder to the user one day prior to the event",
  "Reminder email": "Reminder email",
  "Send an instant email to the user once registration is completed": "Send an instant email to the user once registration is completed",
  "Notification email": "Notification email",
  "Reminder email about the event": "Reminder email about the event",
  "Email notifications to users": "Email notifications to users",
  "Click on the toggle buttons next to each field to add it to your registration form. If you want to make the field required, click on the asterisk (*).": "Click on the toggle buttons next to each field to add it to your registration form. If you want to make the field required, click on the asterisk (*).",
  "Form Fields": "Form Fields",
  "Enter your form description": "Enter your form description",
  "Form Title": "Form Title",
  "Enter your form title": "Enter your form title",
  "Form Details": "Form Details",
  "Configure your registration form fields": "Configure your registration form fields",
  "Show guest limit": "Show guest limit",
  "Enable Registration": "Enable Registration",
  "Click to activate registration on this event": "Click to activate registration on this event",
  "Customize the general settings of registration": "Customize the general settings of registration",
  "Enter URL": "Enter URL",
  "Page URL": "Page URL",
  "Close registration when the event starts": "Close registration when the event starts",
  "Redirect to a different website": "Redirect to a different website",
  "Where users can register": "Where users can register",
  "Open event registration landing page": "Open event registration landing page",
  "It must have taken you plenty of preparation to get ready for your event. Now is the time to sit back and relax till your guests gather around! As soon as a new registration is made, the information about your guest will appear here. Come back later to keep track of your event attendees.": "It must have taken you plenty of preparation to get ready for your event. Now is the time to sit back and relax till your guests gather around! As soon as a new registration is made, the information about your guest will appear here. Come back later to keep track of your event attendees.",
  "You have no guests at the moment.": "You have no guests at the moment.",
  "List of people who are registered to your event": "List of people who are registered to your event",
  ...
  "Do you really want to delete selected event? Once removed, cannot be undone": "Do you really want to delete selected event? Once removed, cannot be undone",
  "There are no categories yet": "There are no categories yet",
  "Making Changes to your synced calendar with the following links. Please review your changes carefully.": "Making Changes to your synced calendar with the following links. Please review your changes carefully.",
  ...
  "Show your Wix Bookings or Events on Calendar": "Show your Wix Bookings or Events on Calendar",
  "Choose Auto for automatic display of all services and sessions on the calendar, or Manual for manual selection.": "Choose Auto for automatic display of all services and sessions on the calendar, or Manual for manual selection.",
  "Show cancelled events": "Show cancelled events",
  "Event Color": "Event Color",
  "Choose Auto for automatic display of all events on the calendar, or Manual for manual selection.": "Choose Auto for automatic display of all events on the calendar, or Manual for manual selection.",
  "Auto": "Auto",
  ...
  "Showcase the category filter at the top or at the bottom of the calendar. The settings applies to Agenda, Cross, Timeline and Card views only": "Showcase the category filter at the top or at the bottom of the calendar. The settings applies to Agenda, Cross, Timeline and Card views only",
  ...
  "Reset Layouts Dimensions": "Reset Layouts Dimensions",
  "Clear": "Clear",
  "Undo": "Undo",
  "Redo": "Redo",
  "Code Panel": "Code Panel",
  "Code Panel Notify": "Modifying code directly may break the layout or app functionality. Only edit if you know what you’re doing !",
  "Clear Editor": "Clear Editor",
  "Clear Editor Notify": "Are you sure you want to clear the editor? All progress will be lost !",
  "Nothing to edit": "There is nothing to edit !",
  "Shapes": "Shapes",
  "Delete The Shape": "Delete The Shape",
  "Add shapes": "Add shapes between layouts and customize !",
  "Preview unavailable": "Component Preview unavailable for component",
  ...
  "Underline": "Underline",
  "Underline and Overline": "Underline and Overline",
  "Without Decoration": "Without Decoration",
  "Left": "Left",
  "Angle": "Angle",
  "Distance": "Distance",
  "Blur": "Blur",
  "Size": "Size",
  "Edit individually": "Edit individually",
  "Apply to all corners": "Apply to all corners",
  "Date Box Visual": "Date Box Visual",
  "One Line": "One Line",
  "Show Icons": "Show Icons",
  "Design Settings": "Design Settings",
  "Personalize your editor to match your style and preferences, customize every detail in this settings tab !": "Personalize your editor to match your style and preferences, customize every detail in this settings tab !",
  "Divider": "Divider",
  "Ellipse": "Ellipse",
  "Rhombus": "Rhombus",
  "Heart": "Heart",
  ...
  "No tickets available for this event.": "No tickets available for this event.",
  "No tickets selected": "No tickets selected",
  "Order Summary": "Order Summary",
  "Payment": "Payment",
  ...
  "Loading your ticket...": "Loading your ticket...",
  "Show this QR code at the entrance or": "Show this QR code at the entrance or",
  "Show this QR code at the entrance.": "Show this QR code at the entrance.",
  "Download QR": "Download QR",
  "Individual Tickets": "Individual Tickets",
  "QR Code for All Tickets": "QR Code for All Tickets",
  "Scan this QR for all tickets": "Scan this QR for all tickets",
  "Individual ticket": "Individual ticket",
  "All Tickets QR": "All Tickets QR",
  "ID": "ID",
  "Unable to load ticket information. Please check the URL and try again.": "Unable to load ticket information. Please check the URL and try again.",
};
export default en;
