let hr = {
  ...
  "You can move your mouse outside the seatmap while dragging - the selection will still apply when you release.": "Tijekom povlačenja možete pomicati miš izvan plana sjedala - odabir će i dalje važiti kada otpustite.",
  "Tip:": "Savjet:",
  "Use the +/- buttons to zoom in and out": "Pomoću tipki +/- možete zumirati",
  "Click and drag the background to pan around the venue": "Kliknite i povucite pozadinu za pomicanje po mjestu događaja",
  "Pan & Zoom": "Pomicanje i zumiranje",
  "Capacity is shared across all seatmaps for the same event": "Kapacitet se dijeli na svim mapama sjedala za isti događaj",
  "Use the - button to remove tickets from your selection": "Pomoću gumba - uklonite karte iz svog odabira",
  "Use the + button to add tickets to your selection": "Pomoću gumba + dodajte ulaznice u svoj odabir",
  "Standing areas show the number of tickets remaining": "Stajališta pokazuju broj preostalih ulaznica",
  "Standing Areas": "Stajaća mjesta",
  "Remove keyboard focus from seats": "Ukloni fokus tipkovnice sa sjedala",
  "Clear Focus": "Jasan fokus",
  "Toggle the focused seat": "Uključi/isključi fokusirano sjedalo",
  "Select / Deselect Seat": "Odaberi / Poništi odabir sjedala",
  "Move between available seats": "Premještanje između dostupnih sjedala",
  "Navigate Seats": "Navigacija sjedala",
  "Use your keyboard to navigate and select seats without a mouse:": "Za navigaciju i odabir sjedala bez miša koristite tipkovnicu:",
  "Keyboard Navigation": "Navigacija tipkovnicom",
  "Click an empty area to deselect all seats": "Kliknite prazno područje da biste poništili odabir svih sjedala",
  "Drag across multiple seats to toggle-select them": "Povucite preko više sjedala da biste ih naizmjenično odabrali",
  "Click a selected seat again to deselect it": "Ponovno kliknite odabrano sjedalo da biste ga poništili",
  "Click a seat to select it": "Kliknite sjedalo da biste ga odabrali",
  "Selecting Seats": "Odabir sjedala",
  "How to Select Seats": "Kako odabrati sjedala",
  "How to Use": "Kako koristiti",
  "Pay": "Platiti",
  "Book": "Rezervirati",
  "This promo code has already been used": "Ovaj promotivni kod je već iskorišten",
  "This promo code is not yet active": "Ovaj promotivni kod još nije aktivan",
  "This promo code has expired": "Ovaj promotivni kod je istekao",
  "Invalid promo code": "Nevažeći promotivni kod",
  "Credit / Debit Card": "Kreditna/debitna kartica",
  "Fast & secure checkout": "Brza i sigurna naplata",
  "Secure payment via Wix": "Sigurno plaćanje putem Wixa",
  "Pay at the venue": "Plaćanje na mjestu događaja",
  "Registration": "Registracija",
  "Attendee Information": "Informacije o sudionicima",
  "Your information is secure and will only be used for event registration": "Vaši podaci su sigurni i koristit će se samo za registraciju na događaj",
  "Your information is secure and will only be used for ticket delivery": "Vaši podaci su sigurni i koristit će se samo za dostavu ulaznica",
  "Register": "Registar",
  "Event is fully booked": "Događaj je potpuno rezerviran",
  "To Event": "Do događaja",
  "Guest Details": "Podaci o gostu",
  "Because it was a Draft": "Jer je to bio Nacrt",
  "You can't see your event": "Ne možete vidjeti svoj događaj",
  "The event is currently happening. If you believe this is an error, please contact the event organizer.": "Događaj je trenutno u tijeku. Ako smatrate da je riječ o pogrešci, obratite se organizatoru događaja.",
  "Registration is closed because this event has already started.": "Registracija je zatvorena jer je ovaj događaj već započeo.",
  "Event In Progress": "Događaj u tijeku",
  "The event organizer is still preparing this event. Please check back later or contact the organizer for more information.": "Organizator događaja još uvijek priprema ovaj događaj. Molimo provjerite kasnije ili kontaktirajte organizatora za više informacija.",
  "Event": "Događaj",
  "This event is currently in draft mode and not available for registration yet.": "Ovaj događaj je trenutno u fazi nacrta i još nije dostupan za registraciju.",
  "This event is currently in draft mode and not yet available for viewing.": "Ovaj događaj je trenutno u nacrtu i još nije dostupan za pregled.",
  "Event Not Published": "Događaj nije objavljen",
  "Draft Mode": "Nacrt načina",
  "Back": "Nazad",
  "Go": "Ići",
  "Could not find requested resource": "Nije moguće pronaći traženi resurs",
  "Not Found 404": "Nije pronađeno 404",
  "Loading...": "Učitavanje...",
  "Loading": "Učitavanje",
  ...
  "Your information is secure and will only be used for event registration": "Vaši podaci su sigurni i koristit će se samo za registraciju na događaj",
  "Your information is secure and will only be used for ticket delivery": "Vaši podaci su sigurni i koristit će se samo za dostavu ulaznica",
  "per ticket": "po ulaznici",
  "Select tickets above to continue": "Odaberite karte iznad za nastavak",
  "Select seats above to continue": "Odaberite sjedala iznad za nastavak",
  "Select Tickets": "Odaberite ulaznice",
  "Gallery": "Galerija",
  "Secure checkout": "Sigurna naplata",
  "About This Event": "O ovom događaju",
  "Available Spots": "Dostupna mjesta",
  "TICKET TYPES": "VRSTE ULAZNICA",
  "TICKET TYPE": "VRSTA ULAZNICE",
  "Sync": "Sinkronizacija",
  "Connected": "Povezano",
  "Removes the connection to your Google account. Previously imported events will remain on your calendar.": "Uklanja vezu s vašim Google računom. Prethodno uvezeni događaji ostat će u vašem kalendaru.",
  "A wider range means more events to load. If your calendar feels slow, try narrowing the range to match the view you use most (e.g. monthly view needs a shorter range than yearly).": "Širi raspon znači više događaja za učitavanje. Ako vam se kalendar čini sporim, pokušajte suziti raspon kako bi odgovarao prikazu koji najčešće koristite (npr. mjesečni prikaz treba kraći raspon od godišnjeg).",
  "Sync Date Range": "Raspon datuma sinkronizacije",
  "Sync categories": "Sinkronizacija kategorija",
  "Hide event description": "Sakrij opis događaja",
  "Hide private events": "Sakrij privatne događaje",
  "No synchronized calendars yet. Select a calendar above and click Sync to start.": "Još nema sinkroniziranih kalendara. Odaberite kalendar iznad i kliknite Sinkroniziraj za početak.",
  "Fetches current events so you can add them one by one.": "Dohvaća trenutne događaje kako biste ih mogli dodavati jedan po jedan.",
  "Keeps events continuously updated in real time.": "Neprestano ažurira događaje u stvarnom vremenu.",
