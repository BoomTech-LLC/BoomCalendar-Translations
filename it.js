let it = {
  "Missing guest ID": "ID ospite mancante",
  "Failed to fetch guest data": "Impossibile recuperare i dati dell'ospite",
  "Failed to fetch tickets": "Impossibile recuperare i biglietti",
  "Failed to load ticket data": "Impossibile caricare i dati del ticket",
  "Ticket already bought": "Biglietto già acquistato",
  "Select Your Seats": "Seleziona i tuoi posti",
  "Ticket Details": "Dettagli del biglietto",
  "Per-Ticket QR Codes": "Codici QR per ogni biglietto",
  "each": "ogni",
  "Service Fee": "Costo del servizio",
  "Subtotal": "Subtotale",
  "Email Address": "Indirizzo e-mail",
  "Find your printable e-tickets attached to the confirmation email": "Troverete i vostri biglietti elettronici stampabili allegati all'email di conferma.",
  "Thank you for your purchase!": "Grazie per il tuo acquisto!",
  "You can move your mouse outside the seatmap while dragging - the selection will still apply when you release.": "È possibile spostare il mouse al di fuori della mappa dei posti a sedere durante il trascinamento: la selezione rimarrà comunque attiva al rilascio.",
  "Tip:": "Mancia:",
  "Use the +/- buttons to zoom in and out": "Utilizza i pulsanti +/- per ingrandire e ridurre lo zoom.",
  "Click and drag the background to pan around the venue": "Fai clic e trascina lo sfondo per spostarti all'interno della location",
  "Pan & Zoom": "Panoramica e zoom",
  "Capacity is shared across all seatmaps for the same event": "La capacità è condivisa tra tutte le configurazioni dei posti per lo stesso evento.",
  "Use the - button to remove tickets from your selection": "Utilizza il pulsante - per rimuovere i biglietti dalla selezione",
  "Use the + button to add tickets to your selection": "Utilizza il pulsante + per aggiungere i biglietti alla tua selezione",
  "Standing areas show the number of tickets remaining": "Le aree in piedi indicano il numero di biglietti rimanenti",
  "Standing Areas": "Aree in piedi",
  "Remove keyboard focus from seats": "Rimuovere il focus della tastiera dai posti",
  "Clear Focus": "Messa a fuoco nitida",
  "Toggle the focused seat": "Attiva/disattiva il sedile focalizzato",
  "Select / Deselect Seat": "Seleziona/Deseleziona il posto",
  "Move between available seats": "Spostarsi tra i posti disponibili",
  "Navigate Seats": "Naviga tra i posti",
  "Use your keyboard to navigate and select seats without a mouse:": "Utilizza la tastiera per navigare e selezionare i posti senza usare il mouse:",
  "Keyboard Navigation": "Navigazione tastiera",
  "Click an empty area to deselect all seats": "Fai clic su un'area vuota per deselezionare tutti i posti",
  "Drag across multiple seats to toggle-select them": "Trascina il mouse su più sedili per selezionarli/attivarli.",
  "Click a selected seat again to deselect it": "Fai nuovamente clic sul posto selezionato per deselezionarlo.",
  "Click a seat to select it": "Fai clic su un posto per selezionarlo",
  "Selecting Seats": "Selezione dei posti",
  "How to Select Seats": "Come scegliere i posti",
  "How to Use": "Come usare",
  "Pay": "Paga",
  "Book": "Libro",
  "This promo code has already been used": "Questo codice promozionale è già stato utilizzato",
  "This promo code is not yet active": "Questo codice promozionale non è ancora attivo",
  "This promo code has expired": "Questo codice promozionale è scaduto.",
  "Invalid promo code": "Codice promozionale non valido",
  "Credit / Debit Card": "Carta di credito/debito",
  "Fast & secure checkout": "Pagamento rapido e sicuro",
  "Secure payment via Wix": "Pagamento sicuro tramite Wix",
  "Pay at the venue": "Pagamento in loco",
  "Registration": "Registrazione",
  "Attendee Information": "Informazioni per i partecipanti",
  "Your information is secure and will only be used for event registration": "Le tue informazioni sono al sicuro e verranno utilizzate esclusivamente per la registrazione all'evento.",
  "Your information is secure and will only be used for ticket delivery": "Le tue informazioni sono al sicuro e verranno utilizzate esclusivamente per la consegna dei biglietti.",
  "Register": "Registro",
  "Event is fully booked": "L'evento è al completo.",
  "To Event": "All'evento",
  "Guest Details": "Dettagli dell'ospite",
  "Because it was a Draft": "Perché era una bozza",
  "You can't see your event": "Non riesci a visualizzare il tuo evento",
  "The event is currently happening. If you believe this is an error, please contact the event organizer.": "L'evento è attualmente in corso. Se ritieni che si tratti di un errore, contatta l'organizzatore dell'evento.",
  "Registration is closed because this event has already started.": "Le iscrizioni sono chiuse perché l'evento è già iniziato.",
  "Event In Progress": "Evento in corso",
  "The event organizer is still preparing this event. Please check back later or contact the organizer for more information.": "L'organizzatore dell'evento sta ancora preparando l'evento. Si prega di ricontrollare più tardi o di contattare l'organizzatore per ulteriori informazioni.",
  "Event": "Evento",
  "This event is currently in draft mode and not available for registration yet.": "Questo evento è attualmente in fase di bozza e non è ancora possibile registrarsi.",
  "This event is currently in draft mode and not yet available for viewing.": "Questo evento è attualmente in modalità bozza e non è ancora disponibile per la visualizzazione.",
  "Event Not Published": "Evento non pubblicato",
  "Draft Mode": "Modalità bozza",
  "Back": "Indietro",
  "Go": "Andare",
  "Could not find requested resource": "Impossibile trovare la risorsa richiesta",
  ...
  "Your information is secure and will only be used for event registration": "Le tue informazioni sono al sicuro e verranno utilizzate esclusivamente per la registrazione all'evento.",
  "Your information is secure and will only be used for ticket delivery": "Le tue informazioni sono al sicuro e verranno utilizzate esclusivamente per la consegna dei biglietti.",
  "per ticket": "per biglietto",
  "Select tickets above to continue": "Seleziona i biglietti qui sopra per continuare",
  "Select seats above to continue": "Seleziona i posti qui sopra per continuare",
  "Select Tickets": "Seleziona i biglietti",
  "Gallery": "Galleria",
  "Secure checkout": "Pagamento sicuro",
  "About This Event": "Informazioni su questo evento",
  "Available Spots": "Posti disponibili",
  "TICKET TYPES": "TIPOLOGIA DI BIGLIETTO",
  "TICKET TYPE": "TIPO DI BIGLIETTO",
  "Sync": "Sincronizzazione",
  "Connected": "Collegato",
  "Removes the connection to your Google account. Previously imported events will remain on your calendar.": "Rimuove la connessione al tuo account Google. Gli eventi importati in precedenza rimarranno nel tuo calendario.",
  "A wider range means more events to load. If your calendar feels slow, try narrowing the range to match the view you use most (e.g. monthly view needs a shorter range than yearly).": "Un intervallo più ampio significa più eventi da caricare. Se il tuo calendario ti sembra lento, prova a restringere l'intervallo in modo che corrisponda alla visualizzazione che usi più spesso (ad esempio, la visualizzazione mensile richiede un intervallo più breve rispetto a quella annuale).",
  "Sync Date Range": "Sincronizza intervallo di date",
  "Sync categories": "Sincronizza categorie",
  "Hide event description": "Nascondi la descrizione dell'evento",
  "Hide private events": "Nascondi eventi privati",
  "No synchronized calendars yet. Select a calendar above and click Sync to start.": "Nessun calendario sincronizzato. Seleziona un calendario qui sopra e clicca su Sincronizza per iniziare.",
  "Fetches current events so you can add them one by one.": "Recupera gli eventi attuali in modo da poterli aggiungere uno alla volta.",
  "Keeps events continuously updated in real time.": "Mantiene gli eventi costantemente aggiornati in tempo reale.",
  ...
  "Cross Event Limit": "Limite di eventi incrociati",
  "Show events limit": "Mostra limite eventi",
  "Show tooltip/popup": "Mostra suggerimento/popup",
  "Bold Monthly Dividers": "Divisori mensili in grassetto",
  "Scroll to see more events": "Scorri per vedere altri eventi",
  "Show additional date": "Mostra data aggiuntiva",
  ...
  "Reset Layouts Dimensions": "Ripristina le dimensioni dei layout",
  "Clear": "Chiaro",
  "Undo": "Disfare",
  "Redo": "Rifare",
  "Code Panel": "Pannello di codice",
  "Code Panel Notify": "La modifica del codice direttamente può rompere il layout o la funzionalità dell'app. Modifica solo se sai cosa stai facendo!",
  "Clear Editor": "Editor chiaro",
  "Clear Editor Notify": "Sei sicuro di voler cancellare l'editor? Tutti i progressi andranno persi!",
  "Nothing to edit": "Non c'è niente da modificare!",
  "Shapes": "Forme",
  "Delete The Shape": "Elimina la forma",
  "Add shapes": "Aggiungi forme tra layout e personalizza!",
  "Preview unavailable": "Anteprima del componente non disponibile per il componente",
  ...
  "Height": "Altezza",
  "Font Family": "Famiglia dei caratteri",
  ...
  "Left Alignment": "Allineamento a sinistra",
  "Center Alignment": "Allineamento centrale",
  "Right Alignment": "Allineamento giusto",
  "Text Decoration": "Decorazione di testo",
  "Overline": "Overline",
  "Line Through": "Allineare attraverso",
  "Underline": "Sottolineare",
  "Underline and Overline": "Sottolinea e sovraline",
  "Without Decoration": "Senza decorazione",
  "Left": "Sinistra",
  "Angle": "Angolo",
  "Distance": "Distanza",
  "Blur": "Sfocatura",
  "Size": "Misurare",
  "Edit individually": "Modificare individualmente",
  "Apply to all corners": "Applicare a tutti gli angoli",
  "Date Box Visual": "Date Box Visual",
  "One Line": "Una riga",
  "Show Icons": "Mostra icone",
  "Design Settings": "Impostazioni di design",
  "Personalize your editor to match your style and preferences, customize every detail in this settings tab !": "Personalizza il tuo editor per abbinare il tuo stile e le tue preferenze, personalizza ogni dettaglio in questa scheda Impostazioni!",
  "Divider": "Divisore",
  "Ellipse": "Ellisse",
  "Rhombus": "Rombo",
  "Heart": "Cuore",
  ...
  "Get Tickets Now": "Ottieni biglietti ora",
  "Get Tickets": "Ottieni biglietti",
  "Instant confirmation": "Conferma istantanea",
  "No seats selected": "Nessun posto selezionato",
  "No tickets available for this event.": "Nessun biglietto disponibile per questo evento.",
  "No tickets selected": "Nessun biglietto selezionato",
  ...
  "Please select at least one seat": "Seleziona almeno un posto",
  "Register Now": "Registrati ora",
  "Registration Complete": "Registrazione completata",
  "Secure checkout": "Pagamento sicuro",
  "Select Tickets": "Seleziona biglietti",
  "Select Your Seats": "Seleziona i tuoi posti",
  "Select seats above to continue": "Seleziona i posti sopra per continuare",
  "Select tickets above to continue": "Seleziona i biglietti sopra per continuare",
  "Selected Seats": "Posti selezionati",
  ...
  "Gallery": "Galleria",
  "Thank You!": "Grazie!",
  "Your registration was successful.": "La tua registrazione è avvenuta con successo.",
  "Ticket Not Found": "Biglietto Non Trovato",
  "Your Ticket": "Il Tuo Biglietto",
  "Loading your ticket...": "Caricamento del tuo biglietto...",
  "Show this QR code at the entrance or": "Mostra questo codice QR all'ingresso o",
  "Show this QR code at the entrance.": "Mostra questo codice QR all'ingresso.",
  "Download QR": "Scarica QR",
  "Individual Tickets": "Biglietti Individuali",
  "QR Code for All Tickets": "Codice QR per Tutti i Biglietti",
  "Scan this QR for all tickets": "Scansiona questo QR per tutti i biglietti",
  "Individual ticket": "Biglietto individuale",
  "All Tickets QR": "QR di Tutti i Biglietti",
  "ID": "ID",
  "Unable to load ticket information. Please check the URL and try again.": "Impossibile caricare le informazioni del biglietto. Controlla l'URL e riprova.",
};
export default it;
