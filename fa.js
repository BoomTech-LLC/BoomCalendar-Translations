let fa = {
  ...
  "You can move your mouse outside the seatmap while dragging - the selection will still apply when you release.": "می‌توانید هنگام کشیدن، ماوس خود را به خارج از نقشه صندلی ببرید - وقتی ماوس را رها می‌کنید، انتخاب همچنان اعمال می‌شود.",
  "Tip:": "نکته:",
  "Use the +/- buttons to zoom in and out": "برای بزرگنمایی و کوچکنمایی از دکمه‌های +/- استفاده کنید",
  "Click and drag the background to pan around the venue": "برای جابجایی در اطراف محل برگزاری، روی پس‌زمینه کلیک کرده و آن را بکشید",
  "Pan & Zoom": "پان و زوم",
  "Capacity is shared across all seatmaps for the same event": "ظرفیت در تمام نقشه‌های صندلی برای یک رویداد مشترک است",
  "Use the - button to remove tickets from your selection": "برای حذف بلیط از انتخاب خود، از دکمه - استفاده کنید",
  "Use the + button to add tickets to your selection": "برای اضافه کردن بلیط به انتخاب خود، از دکمه + استفاده کنید",
  "Standing areas show the number of tickets remaining": "قسمت‌های ایستاده تعداد بلیط‌های باقی‌مانده را نشان می‌دهند",
  "Standing Areas": "مناطق ایستاده",
  "Remove keyboard focus from seats": "فوکوس کیبورد را از روی صندلی‌ها بردارید",
  "Clear Focus": "فوکوس واضح",
  "Toggle the focused seat": "صندلی متمرکز را تغییر دهید",
  "Select / Deselect Seat": "انتخاب/لغو انتخاب صندلی",
  "Move between available seats": "بین صندلی‌های موجود جابجا شوید",
  "Navigate Seats": "صندلی‌ها را پیمایش کنید",
  "Use your keyboard to navigate and select seats without a mouse:": "از صفحه کلید خود برای حرکت و انتخاب صندلی‌ها بدون ماوس استفاده کنید:",
  "Keyboard Navigation": "پیمایش صفحه کلید",
  "Click an empty area to deselect all seats": "برای لغو انتخاب همه صندلی‌ها، روی یک قسمت خالی کلیک کنید",
  "Drag across multiple seats to toggle-select them": "برای انتخاب چند صندلی، آنها را روی هم بکشید (درگ کنید)",
  "Click a selected seat again to deselect it": "برای لغو انتخاب صندلی، دوباره روی آن کلیک کنید",
  "Click a seat to select it": "برای انتخاب صندلی، روی آن کلیک کنید",
  "Selecting Seats": "انتخاب صندلی",
  "How to Select Seats": "نحوه انتخاب صندلی",
  "How to Use": "نحوه استفاده",
  "Pay": "پرداخت",
  "Book": "کتاب",
  "This promo code has already been used": "این کد تخفیف قبلاً استفاده شده است",
  "This promo code is not yet active": "این کد تخفیف هنوز فعال نشده است",
  "This promo code has expired": "این کد تخفیف منقضی شده است",
  "Invalid promo code": "کد تخفیف نامعتبر است",
  "Credit / Debit Card": "کارت اعتباری / بدهی",
  "Fast & secure checkout": "پرداخت سریع و امن",
  "Secure payment via Wix": "پرداخت امن از طریق Wix",
  "Pay at the venue": "پرداخت در محل",
  "Registration": "ثبت نام",
  "Attendee Information": "اطلاعات شرکت‌کنندگان",
  "Your information is secure and will only be used for event registration": "اطلاعات شما محفوظ است و فقط برای ثبت نام رویداد استفاده خواهد شد",
  "Your information is secure and will only be used for ticket delivery": "اطلاعات شما محفوظ است و فقط برای ارسال بلیط استفاده خواهد شد.",
  "Register": "ثبت نام",
  "Event is fully booked": "ظرفیت رویداد تکمیل شده است",
  "To Event": "به رویداد",
  "Guest Details": "جزئیات مهمان",
  "Because it was a Draft": "چون پیش نویس بود",
  "You can't see your event": "شما نمی‌توانید رویدادتان را ببینید",
  "The event is currently happening. If you believe this is an error, please contact the event organizer.": "این رویداد در حال حاضر در حال برگزاری است. اگر فکر می‌کنید این یک خطا است، لطفاً با برگزارکننده رویداد تماس بگیرید.",
  "Registration is closed because this event has already started.": "ثبت نام به دلیل شروع این رویداد متوقف شده است.",
  "Event In Progress": "رویداد در حال انجام",
  "The event organizer is still preparing this event. Please check back later or contact the organizer for more information.": "برگزارکننده رویداد هنوز در حال آماده‌سازی این رویداد است. لطفاً برای اطلاعات بیشتر بعداً مراجعه کنید یا با برگزارکننده تماس بگیرید.",
  "Event": "رویداد",
  "This event is currently in draft mode and not available for registration yet.": "این رویداد در حال حاضر در حالت پیش‌نویس است و هنوز برای ثبت‌نام در دسترس نیست.",
  "This event is currently in draft mode and not yet available for viewing.": "این رویداد در حال حاضر در حالت پیش‌نویس است و هنوز برای مشاهده در دسترس نیست.",
  "Event Not Published": "رویداد منتشر نشده است",
  "Draft Mode": "حالت پیش نویس",
  "Back": "برگشت",
  "Go": "برو",
  "Could not find requested resource": "منبع درخواستی پیدا نشد",
  "Not Found 404": "۴۰۴ پیدا نشد",
  ...
  "Your information is secure and will only be used for event registration": "اطلاعات شما محفوظ است و فقط برای ثبت نام رویداد استفاده خواهد شد",
  "Your information is secure and will only be used for ticket delivery": "اطلاعات شما محفوظ است و فقط برای ارسال بلیط استفاده خواهد شد.",
  "per ticket": "به ازای هر بلیط",
  "Select tickets above to continue": "برای ادامه، بلیط‌های بالا را انتخاب کنید",
  "Select seats above to continue": "برای ادامه، صندلی‌های بالا را انتخاب کنید",
  "Select Tickets": "بلیط‌ها را انتخاب کنید",
  "Gallery": "گالری",
  "Secure checkout": "پرداخت امن",
  "About This Event": "درباره این رویداد",
  "Available Spots": "نقاط موجود",
  ...
  "Sync Date Range": "محدوده تاریخ همگام‌سازی",
  "Sync categories": "دسته بندی های همگام سازی",
  "Hide event description": "پنهان کردن توضیحات رویداد",
  "Hide private events": "پنهان کردن رویدادهای خصوصی",
  "No synchronized calendars yet. Select a calendar above and click Sync to start.": "هنوز هیچ تقویمی همگام‌سازی نشده است. یک تقویم از بالا انتخاب کنید و برای شروع، روی همگام‌سازی کلیک کنید.",
  "Fetches current events so you can add them one by one.": "رویدادهای جاری را دریافت می‌کند تا بتوانید آنها را یکی یکی اضافه کنید.",
  "Keeps events continuously updated in real time.": "رویدادها را به طور مداوم و در لحظه به‌روزرسانی می‌کند.",
  ...
  "Cross Event Limit": "عبور از حد رویداد",
  "Show events limit": "نمایش محدودیت رویدادها",
  "Show tooltip/popup": "نمایش راهنمای ابزار/بازشو",
  "Bold Monthly Dividers": "تقسیم کننده های ماهانه پررنگ",
  "Scroll to see more events": "برای دیدن رویدادهای بیشتر ورق بزنید",
  "Show additional date": "نمایش تاریخ اضافی",
  ...
  "Making Changes to your synced calendar with the following links. Please review your changes carefully.": "ایجاد تغییرات در تقویم همگام‌سازی شده با پیوندهای زیر. لطفا تغییرات خود را با دقت بررسی کنید.",
  "occurrences": "ظهور",
  ...
  "Reset Layouts Dimensions": "تنظیم مجدد ابعاد",
  "Clear": "پاک کردن",
  "Undo": "خنثی کردن",
  "Redo": "مجدداً",
  "Code Panel": "تابلو رمز",
  "Code Panel Notify": "اصلاح کد به طور مستقیم ممکن است طرح یا عملکرد برنامه را بشکند. فقط اگر می دانید چه کاری انجام می دهید ویرایش کنید!",
  "Clear Editor": "ویراستار پاک",
  "Clear Editor Notify": "آیا مطمئن هستید که می خواهید ویرایشگر را پاک کنید؟ همه پیشرفت ها از بین می روند!",
  "Nothing to edit": "چیزی برای ویرایش وجود ندارد!",
  "Shapes": "شکل",
  "Delete The Shape": "شکل را حذف کنید",
  "Add shapes": "شکل ها را بین طرح بندی اضافه کرده و سفارشی سازی کنید!",
  "Preview unavailable": "پیش نمایش مؤلفه برای مؤلفه در دسترس نیست",
  ...
  "Select Font": "فونت را انتخاب کنید",
  "Font Weight": "وزن قلم",
  "Font Size": "اندازه قلم",
  "Text Alignment": "تراز متن",
  "Left Alignment": "تراز سمت چپ",
  "Center Alignment": "هم ترازی مرکز",
  "Right Alignment": "تراز",
  "Text Decoration": "دکوراسیون متن",
  "Overline": "خط سر",
  "Line Through": "از طریق خط",
  "Underline": "زیر خط",
  "Underline and Overline": "زیر خط و overline",
  "Without Decoration": "بدون دکوراسیون",
  "Left": "چپ",
  "Angle": "زاویه",
  "Distance": "فاصله",
  "Blur": "مبهم",
  "Size": "اندازه",
  "Edit individually": "به صورت جداگانه ویرایش کنید",
  "Apply to all corners": "روی همه گوشه ها اعمال کنید",
  "Date Box Visual": "جعبه تاریخ بصری",
  "One Line": "یک خط",
  "Show Icons": "نمادها",
  "Design Settings": "تنظیمات طراحی",
  "Personalize your editor to match your style and preferences, customize every detail in this settings tab !": "ویرایشگر خود را شخصی سازی کنید تا با سبک و ترجیحات خود مطابقت داشته باشید ، هر جزئیات را در این برگه تنظیمات سفارشی کنید!",
  "Divider": "تقسیم کننده",
  "Ellipse": "بیضی",
  "Rhombus": "رومی",
  "Heart": "قلب",
  ...
  "Event Details": "جزئیات رویداد",
  "Free admission": "ورود رایگان",
  "Get Tickets Now": "همین حالا بلیت بگیرید",
  "Get Tickets": "بلیت بگیرید",
  "Instant confirmation": "تأیید فوری",
  "No seats selected": "صندلی انتخاب نشده",
  "No tickets available for this event.": "بلیتی برای این رویداد موجود نیست.",
  "No tickets selected": "بلیتی انتخاب نشده",
  "Order Summary": "خلاصه سفارش",
  "Payment": "پرداخت",
  "Please enter a valid email": "لطفاً یک ایمیل معتبر وارد کنید",
  "Please enter your name": "لطفاً نام خود را وارد کنید",
  "Please select at least one seat": "لطفاً حداقل یک صندلی انتخاب کنید",
  "Register Now": "همین حالا ثبت‌نام کنید",
  "Registration Complete": "ثبت‌نام کامل شد",
  "Secure checkout": "پرداخت امن",
  "Select Tickets": "انتخاب بلیت",
  "Select Your Seats": "صندلی‌های خود را انتخاب کنید",
  "Select seats above to continue": "برای ادامه صندلی‌ها را از بالا انتخاب کنید",
  "Select tickets above to continue": "برای ادامه بلیت‌ها را از بالا انتخاب کنید",
  "Selected Seats": "صندلی‌های انتخاب شده",
  "Service Fee": "هزینه خدمات",
  "Subtotal": "جمع فرعی",
  "Total Amount": "مبلغ کل",
  "View your ticket": "مشاهده بلیت خود",
  "each": "هر کدام",
  "per ticket": "به ازای هر بلیت",
  "seat": "صندلی",
  "seats": "صندلی‌ها",
  "selected": "انتخاب شده",
  "ticket": "بلیت",
