let fr = {
  ...
  "You can move your mouse outside the seatmap while dragging - the selection will still apply when you release.": "Vous pouvez déplacer votre souris en dehors du plan de siège pendant le glissement ; la sélection sera toujours appliquée lorsque vous relâcherez le bouton.",
  "Tip:": "Conseil:",
  "Use the +/- buttons to zoom in and out": "Utilisez les boutons +/- pour zoomer et dézoomer.",
  "Click and drag the background to pan around the venue": "Cliquez et faites glisser l'arrière-plan pour vous déplacer dans la salle.",
  "Pan & Zoom": "Panoramique et zoom",
  "Capacity is shared across all seatmaps for the same event": "La capacité est partagée entre tous les plans de salle pour un même événement.",
  "Use the - button to remove tickets from your selection": "Utilisez le bouton - pour supprimer des billets de votre sélection",
  "Use the + button to add tickets to your selection": "Utilisez le bouton + pour ajouter des billets à votre sélection",
  "Standing areas show the number of tickets remaining": "Les zones debout indiquent le nombre de billets restants",
  "Standing Areas": "Zones debout",
  "Remove keyboard focus from seats": "Retirer le focus clavier des sièges",
  "Clear Focus": "Concentration claire",
  "Toggle the focused seat": "Basculer le siège focalisé",
  "Select / Deselect Seat": "Sélectionner/Désélectionner le siège",
  "Move between available seats": "Déplacez-vous entre les sièges disponibles",
  "Navigate Seats": "Navigation des sièges",
  "Use your keyboard to navigate and select seats without a mouse:": "Utilisez votre clavier pour naviguer et sélectionner les sièges sans souris :",
  "Keyboard Navigation": "Navigation au clavier",
  "Click an empty area to deselect all seats": "Cliquez sur une zone vide pour désélectionner tous les sièges",
  "Drag across multiple seats to toggle-select them": "Faites glisser le curseur sur plusieurs sièges pour les sélectionner simultanément.",
  "Click a selected seat again to deselect it": "Cliquez à nouveau sur le siège sélectionné pour le désélectionner.",
  "Click a seat to select it": "Cliquez sur un siège pour le sélectionner.",
  "Selecting Seats": "Choisir ses sièges",
  "How to Select Seats": "Comment choisir ses places",
  "How to Use": "Comment utiliser",
  "Pay": "Payer",
  "Book": "Livre",
  "This promo code has already been used": "Ce code promo a déjà été utilisé.",
  "This promo code is not yet active": "Ce code promotionnel n'est pas encore actif.",
  "This promo code has expired": "Ce code promotionnel a expiré.",
  "Invalid promo code": "Code promotionnel invalide",
  "Credit / Debit Card": "Carte de crédit/débit",
  "Fast & secure checkout": "Paiement rapide et sécurisé",
  "Secure payment via Wix": "Paiement sécurisé via Wix",
  "Pay at the venue": "Payez sur place",
  "Registration": "Inscription",
  "Attendee Information": "Informations destinées aux participants",
  "Your information is secure and will only be used for event registration": "Vos informations sont sécurisées et ne seront utilisées que pour l'inscription à l'événement.",
  "Your information is secure and will only be used for ticket delivery": "Vos informations sont sécurisées et ne seront utilisées que pour la livraison des billets.",
  "Register": "Registre",
  "Event is fully booked": "L'événement affiche complet.",
  "To Event": "À l'événement",
  "Guest Details": "Détails du client",
  "Because it was a Draft": "Parce que c'était un brouillon",
  "You can't see your event": "Vous ne pouvez pas voir votre événement",
  "The event is currently happening. If you believe this is an error, please contact the event organizer.": "L'événement est en cours. Si vous pensez qu'il s'agit d'une erreur, veuillez contacter l'organisateur.",
  "Registration is closed because this event has already started.": "Les inscriptions sont closes car cet événement a déjà commencé.",
  "Event In Progress": "Événement en cours",
  "The event organizer is still preparing this event. Please check back later or contact the organizer for more information.": "L'organisateur est en train de préparer cet événement. Veuillez consulter cette page ultérieurement ou contacter l'organisateur pour plus d'informations.",
  "Event": "Événement",
  "This event is currently in draft mode and not available for registration yet.": "Cet événement est actuellement en phase de brouillon et les inscriptions ne sont pas encore ouvertes.",
  "This event is currently in draft mode and not yet available for viewing.": "Cet événement est actuellement en mode brouillon et n'est pas encore disponible à la consultation.",
  "Event Not Published": "Événement non publié",
  "Draft Mode": "Mode brouillon",
  "Back": "Dos",
  "Go": "Aller",
  "Could not find requested resource": "Ressource demandée introuvable",
  ...
  "Select tickets above to continue": "Sélectionnez vos billets ci-dessus pour continuer",
  "Select seats above to continue": "Sélectionnez des sièges ci-dessus pour continuer",
  ...
  "Connected": "Connecté",
  "Removes the connection to your Google account. Previously imported events will remain on your calendar.": "Supprime la connexion à votre compte Google. Les événements précédemment importés resteront dans votre calendrier.",
  "A wider range means more events to load. If your calendar feels slow, try narrowing the range to match the view you use most (e.g. monthly view needs a shorter range than yearly).": "Une plage de dates plus large signifie plus d'événements à charger. Si votre calendrier est lent, essayez de réduire cette plage pour qu'elle corresponde à l'affichage que vous utilisez le plus (par exemple, l'affichage mensuel nécessite une plage plus courte que l'affichage annuel).",
  "Sync Date Range": "Plage de dates de synchronisation",
  "Sync categories": "Catégories de synchronisation",
  "Hide event description": "Masquer la description de l'événement",
  "Hide private events": "Masquer les événements privés",
  "No synchronized calendars yet. Select a calendar above and click Sync to start.": "Aucun calendrier synchronisé pour le moment. Sélectionnez un calendrier ci-dessus et cliquez sur Synchroniser pour démarrer.",
  "Fetches current events so you can add them one by one.": "Permet de récupérer les événements en cours afin de les ajouter un par un.",
  "Keeps events continuously updated in real time.": "Maintient les événements à jour en temps réel.",
  "Your Api Key": "Votre clé API",
  "Fahrenheit": "Fahrenheit",
  "Celsius": "Celsius",
  "Select the city from the suggestions": "Sélectionnez la ville parmi les suggestions",
  "Weather Forecast": "Prévisions météorologiques",
  "Cross Event Limit": "Limite d'événements croisés",
  "Show events limit": "Afficher la limite des événements",
  "Show tooltip/popup": "Afficher l'info-bulle/la fenêtre contextuelle",
  "Bold Monthly Dividers": "Intercalaires mensuels en gras",
  "Scroll to see more events": "Faites défiler pour voir plus d'événements",
  "Show additional date": "Afficher la date supplémentaire",
  ...
  "Reset Layouts Dimensions": "Réinitialiser les dimensions de disposition",
  "Clear": "Clair",
  "Undo": "Défaire",
  "Redo": "Refaire",
  "Code Panel": "Panneau de code",
  "Code Panel Notify": "La modification du code peut dire directement la mise en page ou la fonctionnalité de l'application. Éditez uniquement si vous savez ce que vous faites!",
  "Clear Editor": "Éditeur clair",
  "Clear Editor Notify": "Êtes-vous sûr de vouloir effacer l'éditeur? Tous les progrès seront perdus!",
  "Nothing to edit": "Il n'y a rien à modifier!",
  "Shapes": "Formes",
  "Delete The Shape": "Supprimer la forme",
  "Add shapes": "Ajoutez des formes entre les dispositions et personnalisez!",
  "Preview unavailable": "Aperçu du composant indisponible pour le composant",
  ...
  "Left Alignment": "Alignement gauche",
  "Center Alignment": "Alignement central",
  "Right Alignment": "Alignement droit",
  "Text Decoration": "Décoration de texte",
  "Overline": "Surmonter",
  "Line Through": "Se précipiter",
  "Underline": "Souligner",
  "Underline and Overline": "Souligner et surmonter",
  ...
  "Blur": "Se brouiller",
  "Size": "Taille",
  "Edit individually": "Modifier individuellement",
  "Apply to all corners": "Appliquer à tous les coins",
  "Date Box Visual": "Visuelle de la boîte de date",
  "One Line": "Une ligne",
  "Show Icons": "Icônes de montre",
  "Design Settings": "Paramètres de conception",
  "Personalize your editor to match your style and preferences, customize every detail in this settings tab !": "Personnalisez votre éditeur pour correspondre à votre style et vos préférences, personnalisez chaque détail de cet onglet Paramètres!",
  "Divider": "Diviseur",
  "Ellipse": "Ellipse",
  "Rhombus": "Rhombe",
  "Heart": "Cœur",
  ...
  "Get Tickets Now": "Obtenir des billets maintenant",
  "Get Tickets": "Obtenir des billets",
  "Instant confirmation": "Confirmation instantanée",
  "No seats selected": "Aucun siège sélectionné",
  "No tickets available for this event.": "Aucun billet disponible pour cet événement.",
  "No tickets selected": "Aucun billet sélectionné",
  "Order Summary": "Résumé de la commande",
  "Payment": "Paiement",
  "Please enter a valid email": "Veuillez entrer un e-mail valide",
  "Please enter your name": "Veuillez entrer votre nom",
  "Please select at least one seat": "Veuillez sélectionner au moins un siège",
  "Register Now": "S'inscrire maintenant",
  "Registration Complete": "Inscription terminée",
  "Secure checkout": "Paiement sécurisé",
  "Select Tickets": "Sélectionner des billets",
  "Select Your Seats": "Sélectionnez vos sièges",
  "Select seats above to continue": "Sélectionnez des sièges ci-dessus pour continuer",
  "Select tickets above to continue": "Sélectionnez des billets ci-dessus pour continuer",
