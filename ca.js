let ca = {
  ...
  "You can move your mouse outside the seatmap while dragging - the selection will still apply when you release.": "Pots moure el ratolí fora del mapa de seients mentre arrossegues; la selecció es continuarà aplicant quan deixis anar.",
  "Tip:": "Consell:",
  "Use the +/- buttons to zoom in and out": "Feu servir els botons +/- per ampliar i reduir",
  "Click and drag the background to pan around the venue": "Feu clic i arrossegueu el fons per desplaçar-vos per l'espai",
  "Pan & Zoom": "Panoràmica i zoom",
  "Capacity is shared across all seatmaps for the same event": "La capacitat es comparteix entre tots els mapes de seients per al mateix esdeveniment",
  "Use the - button to remove tickets from your selection": "Feu servir el botó - per eliminar entrades de la vostra selecció",
  "Use the + button to add tickets to your selection": "Feu servir el botó + per afegir entrades a la vostra selecció",
  "Standing areas show the number of tickets remaining": "Les zones de peu mostren el nombre d'entrades restants",
  "Standing Areas": "Zones de peu",
  "Remove keyboard focus from seats": "Treure el focus del teclat dels seients",
  "Clear Focus": "Focus clar",
  "Toggle the focused seat": "Activa/desactiva el seient enfocat",
  "Select / Deselect Seat": "Selecciona / Desselecciona el seient",
  "Move between available seats": "Mou-te entre els seients disponibles",
  "Navigate Seats": "Navega pels seients",
  "Use your keyboard to navigate and select seats without a mouse:": "Feu servir el teclat per navegar i seleccionar seients sense ratolí:",
  "Keyboard Navigation": "Navegació amb teclat",
  "Click an empty area to deselect all seats": "Feu clic a una àrea buida per desseleccionar tots els seients",
  "Drag across multiple seats to toggle-select them": "Arrossega per diversos seients per seleccionar-los",
  "Click a selected seat again to deselect it": "Feu clic de nou en un seient seleccionat per desseleccionar-lo",
  "Click a seat to select it": "Feu clic a un seient per seleccionar-lo",
  "Selecting Seats": "Selecció de seients",
  "How to Select Seats": "Com seleccionar seients",
  "How to Use": "Com utilitzar",
  "Pay": "Pagar",
  "Book": "Llibre",
  "This promo code has already been used": "Aquest codi promocional ja s'ha utilitzat",
  "This promo code is not yet active": "Aquest codi promocional encara no està actiu",
  "This promo code has expired": "Aquest codi promocional ha caducat",
  "Invalid promo code": "Codi promocional no vàlid",
  "Credit / Debit Card": "Targeta de crèdit/dèbit",
  "Fast & secure checkout": "Pagament ràpid i segur",
  "Secure payment via Wix": "Pagament segur a través de Wix",
  "Pay at the venue": "Pagar al lloc",
  "Registration": "Registre",
  "Attendee Information": "Informació dels assistents",
  "Your information is secure and will only be used for event registration": "La teva informació està segura i només s'utilitzarà per al registre de l'esdeveniment",
  "Your information is secure and will only be used for ticket delivery": "La teva informació està segura i només s'utilitzarà per a l'enviament de bitllets",
  "Register": "Registra't",
  "Event is fully booked": "L'esdeveniment està complet",
  "To Event": "A l'esdeveniment",
  "Guest Details": "Detalls del client",
  "Because it was a Draft": "Perquè era un esborrany",
  "You can't see your event": "No pots veure el teu esdeveniment",
  "The event is currently happening. If you believe this is an error, please contact the event organizer.": "L'esdeveniment està en curs actualment. Si creieu que es tracta d'un error, poseu-vos en contacte amb l'organitzador de l'esdeveniment.",
  "Registration is closed because this event has already started.": "Les inscripcions estan tancades perquè aquest esdeveniment ja ha començat.",
  "Event In Progress": "Esdeveniment en curs",
  "The event organizer is still preparing this event. Please check back later or contact the organizer for more information.": "L'organitzador de l'esdeveniment encara està preparant aquest esdeveniment. Si us plau, torneu-ho a comprovar més tard o poseu-vos en contacte amb l'organitzador per obtenir més informació.",
  "Event": "Esdeveniment",
  "This event is currently in draft mode and not available for registration yet.": "Aquest esdeveniment està actualment en mode esborrany i encara no està disponible per a inscripcions.",
  "This event is currently in draft mode and not yet available for viewing.": "Aquest esdeveniment està actualment en mode esborrany i encara no està disponible per a la visualització.",
  "Event Not Published": "Esdeveniment no publicat",
  "Draft Mode": "Mode esborrany",
  "Back": "Enrere",
  "Go": "Anar",
  "Could not find requested resource": "No s'ha pogut trobar el recurs sol·licitat",
  "Not Found 404": "No s'ha trobat 404",
  ...
  "Your information is secure and will only be used for event registration": "La teva informació està segura i només s'utilitzarà per al registre de l'esdeveniment",
  "Your information is secure and will only be used for ticket delivery": "La teva informació està segura i només s'utilitzarà per a l'enviament de bitllets",
  "per ticket": "per bitllet",
  "Select tickets above to continue": "Seleccioneu les entrades a dalt per continuar",
  "Select seats above to continue": "Seleccioneu els seients a dalt per continuar",
  "Select Tickets": "Selecciona entrades",
  "Gallery": "Galeria",
  "Secure checkout": "Pagament segur",
  "About This Event": "Sobre aquest esdeveniment",
  "Available Spots": "Places disponibles",
  "TICKET TYPES": "TIPUS D'ENTREGA",
  "TICKET TYPE": "TIPUS DE BITLLET",
  "Sync": "Sincronització",
  "Connected": "Connectat",
