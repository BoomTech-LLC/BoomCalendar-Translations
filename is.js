let is = {
  ...
  "You can move your mouse outside the seatmap while dragging - the selection will still apply when you release.": "Þú getur fært músina út fyrir sætiskortið á meðan þú dregur - valið gildir enn þegar þú sleppir.",
  "Tip:": "Ábending:",
  "Use the +/- buttons to zoom in and out": "Notið +/- hnappana til að stækka og minnka aðdráttinn",
  "Click and drag the background to pan around the venue": "Smelltu og dragðu bakgrunninn til að hreyfa þig um vettvanginn",
  "Pan & Zoom": "Fletta og stækka",
  "Capacity is shared across all seatmaps for the same event": "Sætarými er sameiginlegt öllum sætakortum fyrir sama viðburð",
  "Use the - button to remove tickets from your selection": "Notaðu - hnappinn til að fjarlægja miða úr valinu þínu",
  "Use the + button to add tickets to your selection": "Notaðu + hnappinn til að bæta miðum við valið þitt",
  "Standing areas show the number of tickets remaining": "Stöðusvæði sýna fjölda miða sem eftir eru",
  "Standing Areas": "Standandi svæði",
  "Remove keyboard focus from seats": "Fjarlægja lyklaborðsfókus frá sætum",
  "Clear Focus": "Skýr fókus",
  "Toggle the focused seat": "Skipta um fókussæti",
  "Select / Deselect Seat": "Velja / Afvelja sæti",
  "Move between available seats": "Færa sig á milli lausra sæta",
  "Navigate Seats": "Sigla í gegnum sæti",
  "Use your keyboard to navigate and select seats without a mouse:": "Notaðu lyklaborðið til að vafra og velja sæti án músar:",
  "Keyboard Navigation": "Lyklaborðsflakk",
  "Click an empty area to deselect all seats": "Smelltu á autt svæði til að afvelja öll sæti",
  "Drag across multiple seats to toggle-select them": "Dragðu yfir mörg sæti til að velja þau af og á",
  "Click a selected seat again to deselect it": "Smelltu aftur á valið sæti til að afvelja það",
  "Click a seat to select it": "Smelltu á sæti til að velja það",
  "Selecting Seats": "Að velja sæti",
  "How to Select Seats": "Hvernig á að velja sæti",
  "How to Use": "Hvernig á að nota",
  "Pay": "Borga",
  "Book": "Bók",
  "This promo code has already been used": "Þessi kynningarkóði hefur þegar verið notaður",
  "This promo code is not yet active": "Þessi kynningarkóði er ekki enn virkur",
  "This promo code has expired": "Þessi kynningarkóði er útrunninn",
  "Invalid promo code": "Ógildur kynningarkóði",
  "Credit / Debit Card": "Kredit-/debetkort",
  "Fast & secure checkout": "Hröð og örugg greiðsla",
  "Secure payment via Wix": "Örugg greiðsla í gegnum Wix",
  "Pay at the venue": "Greiða á staðnum",
  "Registration": "Skráning",
  "Attendee Information": "Upplýsingar um þátttakendur",
  "Your information is secure and will only be used for event registration": "Upplýsingar þínar eru öruggar og verða eingöngu notaðar til skráningar á viðburði",
  "Your information is secure and will only be used for ticket delivery": "Upplýsingar þínar eru öruggar og verða eingöngu notaðar til að senda miða",
  "Register": "Skráning",
  "Event is fully booked": "Viðburðurinn er fullbókaður",
  "To Event": "Til viðburðar",
  "Guest Details": "Upplýsingar um gesti",
  "Because it was a Draft": "Vegna þess að þetta var drög",
  "You can't see your event": "Þú getur ekki séð viðburðinn þinn",
  "The event is currently happening. If you believe this is an error, please contact the event organizer.": "Viðburðurinn er í gangi núna. Ef þú telur að þetta sé villa, vinsamlegast hafðu samband við skipuleggjanda viðburðarins.",
  "Registration is closed because this event has already started.": "Skráning er lokuð þar sem þessi viðburður er þegar hafinn.",
  "Event In Progress": "Viðburður í gangi",
  "The event organizer is still preparing this event. Please check back later or contact the organizer for more information.": "Skipuleggjandi viðburðarins er enn að undirbúa þennan viðburð. Vinsamlegast kíkið aftur síðar eða hafið samband við skipuleggjanda til að fá frekari upplýsingar.",
  "Event": "Viðburður",
  "This event is currently in draft mode and not available for registration yet.": "Þessi viðburður er í drögum og ekki er hægt að skrá sig enn.",
  "This event is currently in draft mode and not yet available for viewing.": "Þessi viðburður er í drögum og ekki enn hægt að skoða hann.",
  "Event Not Published": "Viðburður ekki birtur",
  "Draft Mode": "Dröghamur",
  "Back": "Til baka",
  "Go": "Fara",
  "Could not find requested resource": "Ekki tókst að finna umbeðna auðlind",
  "Not Found 404": "Ekki fundið 404",
  "Loading...": "Hleður...",
  "Loading": "Hleður",
  ...
  "Your information is secure and will only be used for ticket delivery": "Upplýsingar þínar eru öruggar og verða eingöngu notaðar til að senda miða",
  "per ticket": "á miða",
  "Select tickets above to continue": "Veldu miða hér að ofan til að halda áfram",
  "Select seats above to continue": "Veldu sæti að ofan til að halda áfram",
  "Select Tickets": "Veldu miða",
  "Gallery": "Myndasafn",
  "Secure checkout": "Örugg greiðsla",
  "About This Event": "Um þennan viðburð",
  "Available Spots": "Laus pláss",
  "TICKET TYPES": "MIÐATEGUNDIR",
  "TICKET TYPE": "MIÐATEGUND",
  "Sync": "Samstilling",
  "Connected": "Tengt",
  ...
  "Sync Date Range": "Samstillingartímabil",
  "Sync categories": "Samstilla flokka",
  "Hide event description": "Fela lýsingu á viðburði",
  "Hide private events": "Fela einkaviðburði",
  "No synchronized calendars yet. Select a calendar above and click Sync to start.": "Engin samstillt dagatöl ennþá. Veldu dagatal hér að ofan og smelltu á Samstilla til að byrja.",
  "Fetches current events so you can add them one by one.": "Sækir núverandi atburði svo þú getir bætt þeim við einn í einu.",
  "Keeps events continuously updated in real time.": "Heldur viðburðum stöðugt uppfærðum í rauntíma.",
  ...
  "Show events limit": "Sýna takmörk viðburða",
  "Show tooltip/popup": "Sýna tól/sprettiglugga",
  "Bold Monthly Dividers": "Djörf mánaðarskil",
  "Scroll to see more events": "Skrunaðu til að sjá fleiri viðburði",
  "Show additional date": "Sýna viðbótardagsetningu",
  ...
  "Reset Layouts Dimensions": "Endurstilla skipulag mál",
  "Clear": "Tær",
  "Undo": "Afturkalla",
  "Redo": "Endurtaka",
  "Code Panel": "Kóðaspjald",
  "Code Panel Notify": "Að breyta kóða beint getur brotið skipulag eða virkni appsins. Aðeins breyttu ef þú veist hvað þú ert að gera!",
  "Clear Editor": "Skýr ritstjóri",
  "Clear Editor Notify": "Ertu viss um að þú viljir hreinsa ritstjórann? Allar framfarir tapast!",
  "Nothing to edit": "Það er ekkert að breyta!",
  "Shapes": "Form",
  "Delete The Shape": "Eyða löguninni",
  "Add shapes": "Bættu við formum á milli skipulags og aðlaga!",
  "Preview unavailable": "Forskoðun íhluta er ekki tiltæk fyrir hluti",
  ...
  "Height": "Hæð",
  "Font Family": "Leturfjölskylda",
  "Select Font": "Veldu letur",
  "Font Weight": "Leturþyngd",
  "Font Size": "Leturstærð",
  "Text Alignment": "Texti röðun",
  "Left Alignment": "Vinstri röðun",
  "Center Alignment": "Center röðun",
  "Right Alignment": "Rétt röðun",
  "Text Decoration": "Textaskraut",
  "Overline": "Overline",
  "Line Through": "Lína í gegnum",
  "Underline": "Undirstrika",
  "Underline and Overline": "Undirstrikaðu og yfirlínu",
  "Without Decoration": "Án skreytingar",
  "Left": "Vinstri",
  "Angle": "Horn",
  "Distance": "Fjarlægð",
  "Blur": "Þoka",
  "Size": "Stærð",
  "Edit individually": "Breyta hver fyrir sig",
  "Apply to all corners": "Eiga við um öll horn",
  "Date Box Visual": "Date Box Visual",
  "One Line": "Ein lína",
  "Show Icons": "Sýna tákn",
  "Design Settings": "Hönnunarstillingar",
  "Personalize your editor to match your style and preferences, customize every detail in this settings tab !": "Sérsníddu ritstjórann þinn til að passa þinn stíl og óskir, aðlaga hvert smáatriði í þessum flipanum Stillingar!",
  "Divider": "Skipting",
  "Ellipse": "Ellipse",
  "Rhombus": "Rhombus",
  "Heart": "Hjarta",
