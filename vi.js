let vi = {
  ...
  "You can move your mouse outside the seatmap while dragging - the selection will still apply when you release.": "Bạn có thể di chuyển chuột ra ngoài sơ đồ chỗ ngồi trong khi kéo - vùng chọn vẫn sẽ được giữ nguyên khi bạn thả chuột.",
  "Tip:": "Mẹo:",
  "Use the +/- buttons to zoom in and out": "Sử dụng các nút +/- để phóng to và thu nhỏ.",
  "Click and drag the background to pan around the venue": "Nhấp chuột và kéo hình nền để di chuyển xung quanh địa điểm.",
  "Pan & Zoom": "Di chuyển và thu phóng",
  "Capacity is shared across all seatmaps for the same event": "Sức chứa được chia đều cho tất cả các sơ đồ chỗ ngồi của cùng một sự kiện.",
  "Use the - button to remove tickets from your selection": "Sử dụng nút "-" để xóa vé khỏi lựa chọn của bạn.",
  "Use the + button to add tickets to your selection": "Sử dụng nút + để thêm vé vào lựa chọn của bạn.",
  "Standing areas show the number of tickets remaining": "Khu vực đứng hiển thị số lượng vé còn lại.",
  "Standing Areas": "Khu vực đứng",
  "Remove keyboard focus from seats": "Di chuyển con trỏ bàn phím khỏi ghế ngồi",
  "Clear Focus": "Tiêu điểm rõ nét",
  "Toggle the focused seat": "Chuyển đổi chế độ ghế tập trung",
  "Select / Deselect Seat": "Chọn/Bỏ chọn ghế",
  "Move between available seats": "Di chuyển giữa các chỗ ngồi có sẵn.",
  "Navigate Seats": "Điều hướng chỗ ngồi",
  "Use your keyboard to navigate and select seats without a mouse:": "Sử dụng bàn phím để điều hướng và chọn chỗ ngồi mà không cần chuột:",
  "Keyboard Navigation": "Điều hướng bằng bàn phím",
  "Click an empty area to deselect all seats": "Nhấp vào vùng trống để bỏ chọn tất cả các chỗ ngồi.",
  "Drag across multiple seats to toggle-select them": "Kéo chuột qua nhiều chỗ ngồi để chọn chúng.",
  "Click a selected seat again to deselect it": "Nhấp chuột lại vào chỗ ngồi đã chọn để bỏ chọn chỗ ngồi đó.",
  "Click a seat to select it": "Nhấp chuột vào chỗ ngồi để chọn.",
  "Selecting Seats": "Chọn chỗ ngồi",
  "How to Select Seats": "Cách chọn chỗ ngồi",
  "How to Use": "Cách sử dụng",
  "Pay": "Chi trả",
  "Book": "Sách",
  "This promo code has already been used": "Mã khuyến mãi này đã được sử dụng.",
  "This promo code is not yet active": "Mã khuyến mãi này chưa được kích hoạt.",
  "This promo code has expired": "Mã khuyến mãi này đã hết hạn",
  "Invalid promo code": "Mã khuyến mãi không hợp lệ",
  "Credit / Debit Card": "Thẻ tín dụng/thẻ ghi nợ",
  "Fast & secure checkout": "Thanh toán nhanh chóng và an toàn",
  "Secure payment via Wix": "Thanh toán an toàn qua Wix",
  "Pay at the venue": "Thanh toán tại địa điểm",
  "Registration": "Sự đăng ký",
  "Attendee Information": "Thông tin người tham dự",
  "Your information is secure and will only be used for event registration": "Thông tin của bạn được bảo mật và chỉ được sử dụng cho mục đích đăng ký sự kiện.",
  "Your information is secure and will only be used for ticket delivery": "Thông tin của bạn được bảo mật và chỉ được sử dụng cho việc giao vé.",
  "Register": "Đăng ký",
  "Event is fully booked": "Sự kiện đã kín chỗ.",
  "To Event": "Đến sự kiện",
  "Guest Details": "Thông tin khách mời",
  "Because it was a Draft": "Vì đó là bản nháp",
  "You can't see your event": "Bạn không thể xem sự kiện của mình",
  "The event is currently happening. If you believe this is an error, please contact the event organizer.": "Sự kiện hiện đang diễn ra. Nếu bạn cho rằng đây là lỗi, vui lòng liên hệ với người tổ chức sự kiện.",
  "Registration is closed because this event has already started.": "Việc đăng ký đã đóng vì sự kiện đã bắt đầu.",
  "Event In Progress": "Sự kiện đang diễn ra",
  "The event organizer is still preparing this event. Please check back later or contact the organizer for more information.": "Ban tổ chức sự kiện vẫn đang chuẩn bị cho sự kiện này. Vui lòng quay lại sau hoặc liên hệ với ban tổ chức để biết thêm thông tin.",
  "Event": "Sự kiện",
  "This event is currently in draft mode and not available for registration yet.": "Sự kiện này hiện đang ở chế độ dự thảo và chưa cho phép đăng ký.",
  "This event is currently in draft mode and not yet available for viewing.": "Sự kiện này hiện đang ở chế độ dự thảo và chưa thể xem được.",
  "Event Not Published": "Sự kiện chưa được công bố",
  "Draft Mode": "Chế độ bản nháp",
  "Back": "Mặt sau",
  "Go": "Đi",
  "Could not find requested resource": "Không tìm thấy tài nguyên được yêu cầu.",
  ...
  "Your information is secure and will only be used for ticket delivery": "Thông tin của bạn được bảo mật và chỉ được sử dụng cho việc giao vé.",
  "per ticket": "mỗi vé",
  "Select tickets above to continue": "Chọn vé ở trên để tiếp tục.",
  "Select seats above to continue": "Chọn chỗ ngồi phía trên để tiếp tục.",
  "Select Tickets": "Chọn vé",
  "Gallery": "Phòng trưng bày",
  "Secure checkout": "Thanh toán an toàn",
  "About This Event": "Thông tin về sự kiện này",
  "Available Spots": "Số chỗ còn trống",
  ...
  "Sync Date Range": "Phạm vi ngày đồng bộ",
  "Sync categories": "Danh mục đồng bộ",
  "Hide event description": "Ẩn mô tả sự kiện",
  "Hide private events": "Ẩn các sự kiện riêng tư",
  "No synchronized calendars yet. Select a calendar above and click Sync to start.": "Chưa có lịch nào được đồng bộ hóa. Chọn một lịch ở trên và nhấp vào Đồng bộ hóa để bắt đầu.",
  "Fetches current events so you can add them one by one.": "Tải về các sự kiện hiện tại để bạn có thể thêm chúng từng cái một.",
  "Keeps events continuously updated in real time.": "Cập nhật liên tục các sự kiện theo thời gian thực.",
  "Your Api Key": "Khóa API của bạn",
  "Fahrenheit": "độ F",
  "Celsius": "độ C",
  "Select the city from the suggestions": "Chọn thành phố từ các gợi ý",
  "Weather Forecast": "Dự báo thời tiết",
  "Cross Event Limit": "Giới hạn sự kiện chéo",
  "Show events limit": "Hiển thị giới hạn sự kiện",
  "Show tooltip/popup": "Hiển thị chú giải công cụ/cửa sổ bật lên",
  "Bold Monthly Dividers": "Chia hàng tháng đậm",
  "Scroll to see more events": "Cuộn để xem thêm sự kiện",
  "Show additional date": "Hiển thị ngày bổ sung",
  ...
  "Reset Layouts Dimensions": "Đặt lại bố cục kích thước",
  "Clear": "Thông thoáng",
  "Undo": "Hoàn tác",
  "Redo": "Làm lại",
  "Code Panel": "Bảng mã",
  "Code Panel Notify": "Sửa đổi mã trực tiếp có thể phá vỡ chức năng bố cục hoặc ứng dụng. Chỉ chỉnh sửa nếu bạn biết bạn đang làm gì!",
  "Clear Editor": "Biên tập viên rõ ràng",
  "Clear Editor Notify": "Bạn có chắc là bạn muốn xóa trình chỉnh sửa? Tất cả các tiến bộ sẽ bị mất!",
  "Nothing to edit": "Không có gì để chỉnh sửa!",
  "Shapes": "Hình dạng",
  "Delete The Shape": "Xóa hình dạng",
  "Add shapes": "Thêm hình dạng giữa bố cục và tùy chỉnh!",
  "Preview unavailable": "Xem trước thành phần không có sẵn cho thành phần",
  ...
  "Height": "Chiều cao",
  "Font Family": "Gia đình phông chữ",
  ...
  "Left Alignment": "Căn chỉnh trái",
  "Center Alignment": "Liên kết trung tâm",
  "Right Alignment": "Liên kết đúng",
  "Text Decoration": "Trang trí văn bản",
  "Overline": "Trên đường",
  "Line Through": "Hàng xuyên qua",
  "Underline": "Gạch chân",
  "Underline and Overline": "Gạch chân và liên kết",
  "Without Decoration": "Không trang trí",
  "Left": "Bên trái",
  "Angle": "Góc",
  "Distance": "Khoảng cách",
  "Blur": "Mờ",
  "Size": "Kích cỡ",
  "Edit individually": "Chỉnh sửa riêng lẻ",
  "Apply to all corners": "Áp dụng cho tất cả các góc",
  "Date Box Visual": "Hộp ngày trực quan",
  "One Line": "Một dòng",
  "Show Icons": "Hiển thị biểu tượng",
  "Design Settings": "Cài đặt thiết kế",
  "Personalize your editor to match your style and preferences, customize every detail in this settings tab !": "Cá nhân hóa trình soạn thảo của bạn để phù hợp với phong cách và sở thích của bạn, tùy chỉnh mọi chi tiết trong tab Cài đặt này!",
  "Divider": "Vách ngăn",
  "Ellipse": "Hình elip",
  "Rhombus": "Hình thoi",
  "Heart": "Trái tim",
  ...
  "Get Tickets Now": "Nhận vé ngay",
  "Get Tickets": "Nhận vé",
  "Instant confirmation": "Xác nhận tức thì",
  "No seats selected": "Chưa chọn ghế",
  "No tickets available for this event.": "Không có vé cho sự kiện này.",
  "No tickets selected": "Chưa chọn vé",
  "Order Summary": "Tóm tắt đơn hàng",
  "Payment": "Thanh toán",
  "Please enter a valid email": "Vui lòng nhập email hợp lệ",
  "Please enter your name": "Vui lòng nhập tên của bạn",
  "Please select at least one seat": "Vui lòng chọn ít nhất một ghế",
  "Register Now": "Đăng ký ngay",
  "Registration Complete": "Đăng ký hoàn tất",
  "Secure checkout": "Thanh toán an toàn",
  "Select Tickets": "Chọn vé",
  "Select Your Seats": "Chọn ghế của bạn",
  "Select seats above to continue": "Chọn ghế ở trên để tiếp tục",
  "Select tickets above to continue": "Chọn vé ở trên để tiếp tục",
