let et = {
  ...
  "You can move your mouse outside the seatmap while dragging - the selection will still apply when you release.": "Lohistamise ajal saate hiirt istmekaardist väljapoole liigutada – valik jääb kehtima ka pärast vabastamist.",
  "Tip:": "Näpunäide:",
  "Use the +/- buttons to zoom in and out": "Suumimiseks kasutage nuppe +/-",
  "Click and drag the background to pan around the venue": "Koha ümber panoraamimiseks klõpsa ja lohista tausta",
  "Pan & Zoom": "Panoraamimine ja suumimine",
  "Capacity is shared across all seatmaps for the same event": "Sama ürituse istekohtade arv jagatakse kõigi istekohtade vahel.",
  "Use the - button to remove tickets from your selection": "Piletite valikust eemaldamiseks kasutage nuppu -",
  "Use the + button to add tickets to your selection": "Piletite lisamiseks valikusse kasutage nuppu +",
  "Standing areas show the number of tickets remaining": "Seisualad näitavad järelejäänud piletite arvu",
  "Standing Areas": "Seisualad",
  "Remove keyboard focus from seats": "Eemalda klaviatuuri fookus istmetelt",
  "Clear Focus": "Selge fookus",
  "Toggle the focused seat": "Fookuses oleva istme sisse/välja lülitamine",
  "Select / Deselect Seat": "Vali / Tühista istekoht",
  "Move between available seats": "Liikuge saadaolevate istekohtade vahel",
  "Navigate Seats": "Istmete navigeerimine",
  "Use your keyboard to navigate and select seats without a mouse:": "Kasutage hiireta istekohtade valimiseks ja navigeerimiseks klaviatuuri:",
  "Keyboard Navigation": "Klaviatuuri navigeerimine",
  "Click an empty area to deselect all seats": "Kõigi istekohtade valiku tühistamiseks klõpsake tühjal alal",
  "Drag across multiple seats to toggle-select them": "Lohistage üle mitme istme, et neid valida",
  "Click a selected seat again to deselect it": "Valitud istme valiku tühistamiseks klõpsake sellel uuesti",
  "Click a seat to select it": "Istme valimiseks klõpsake sellel",
  "Selecting Seats": "Istekohtade valimine",
  "How to Select Seats": "Kuidas istekohti valida",
  "How to Use": "Kuidas kasutada",
  "Pay": "Maksa",
  "Book": "Raamat",
  "This promo code has already been used": "See sooduskood on juba kasutatud",
  "This promo code is not yet active": "See sooduskood pole veel aktiivne",
  "This promo code has expired": "See sooduskood on aegunud",
  "Invalid promo code": "Kehtetu sooduskood",
  "Credit / Debit Card": "Krediit-/deebetkaart",
  "Fast & secure checkout": "Kiire ja turvaline kassasse minek",
  "Secure payment via Wix": "Turvaline makse Wixi kaudu",
  "Pay at the venue": "Maksa kohapeal",
  "Registration": "Registreerimine",
  "Attendee Information": "Osaleja teave",
  "Your information is secure and will only be used for event registration": "Teie andmed on kaitstud ja neid kasutatakse ainult üritusele registreerimiseks.",
  "Your information is secure and will only be used for ticket delivery": "Teie andmed on kaitstud ja neid kasutatakse ainult piletite kohaletoimetamiseks.",
  "Register": "Registreeru",
  "Event is fully booked": "Üritus on täielikult broneeritud",
  "To Event": "Üritusele",
  "Guest Details": "Külalise andmed",
  "Because it was a Draft": "Sest see oli mustand",
  "You can't see your event": "Sa ei näe oma sündmust",
  "The event is currently happening. If you believe this is an error, please contact the event organizer.": "Üritus toimub praegu. Kui arvate, et see on viga, võtke palun ühendust ürituse korraldajaga.",
  "Registration is closed because this event has already started.": "Registreerimine on lõppenud, kuna see üritus on juba alanud.",
  "Event In Progress": "Sündmus pooleli",
  "The event organizer is still preparing this event. Please check back later or contact the organizer for more information.": "Ürituse korraldaja valmistab seda üritust alles ette. Palun vaadake hiljem uuesti või võtke lisateabe saamiseks korraldajaga ühendust.",
  "Event": "Sündmus",
  "This event is currently in draft mode and not available for registration yet.": "See üritus on hetkel mustandifaasis ja registreerimine pole veel võimalik.",
  "This event is currently in draft mode and not yet available for viewing.": "See sündmus on hetkel mustandirežiimis ja pole veel vaatamiseks saadaval.",
  "Event Not Published": "Sündmust pole avaldatud",
  "Draft Mode": "Mustandirežiim",
  "Back": "Tagasi",
  "Go": "Mine",
  "Could not find requested resource": "Taotletud ressurssi ei leitud",
  "Not Found 404": "Ei leitud 404",
  "Loading...": "Laadimine...",
  "Loading": "Laadimine",
  ...
  "Your information is secure and will only be used for event registration": "Teie andmed on kaitstud ja neid kasutatakse ainult üritusele registreerimiseks.",
  "Your information is secure and will only be used for ticket delivery": "Teie andmed on kaitstud ja neid kasutatakse ainult piletite kohaletoimetamiseks.",
  "per ticket": "pileti kohta",
  "Select tickets above to continue": "Jätkamiseks valige ülalolevad piletid",
  "Select seats above to continue": "Jätkamiseks valige ülalolevad istekohad",
  "Select Tickets": "Valige piletid",
  "Gallery": "Galerii",
  "Secure checkout": "Turvaline kassasse minek",
  "About This Event": "Selle sündmuse kohta",
  "Available Spots": "Saadaval olevad kohad",
  "TICKET TYPES": "PILETITÜÜBID",
  "TICKET TYPE": "PILETITÜÜP",
  "Sync": "Sünkroonimine",
  "Connected": "Ühendatud",
  ...
  "Sync Date Range": "Sünkroonimise kuupäevavahemik",
  "Sync categories": "Sünkrooni kategooriad",
  "Hide event description": "Peida sündmuse kirjeldus",
  "Hide private events": "Peida privaatsed sündmused",
  "No synchronized calendars yet. Select a calendar above and click Sync to start.": "Sünkroniseeritud kalendreid pole veel. Valige ülalpool kalender ja klõpsake alustamiseks nuppu „Sünkrooni”.",
  "Fetches current events so you can add them one by one.": "Laadib alla praegused sündmused, et saaksite neid ükshaaval lisada.",
  "Keeps events continuously updated in real time.": "Hoiab sündmusi pidevalt reaalajas ajakohasena.",
  ...
  "Cross Event Limit": "Sündmuste vaheline piirang",
  "Show events limit": "Näita sündmuste limiiti",
  "Show tooltip/popup": "Kuva tööriistaspikker/hüpik",
  "Bold Monthly Dividers": "Julged igakuised jagajad",
  "Scroll to see more events": "Kerige, et näha rohkem sündmusi",
  "Show additional date": "Näita täiendavat kuupäeva",
  ...
  "Reset Layouts Dimensions": "Lähtestage paigutuste mõõtmed",
  "Clear": "Selge",
  "Undo": "Tühistama",
  "Redo": "Uuesti tegema",
  "Code Panel": "Koodipaneel",
  "Code Panel Notify": "Koodi otse muutmine võib paigutuse või rakenduse funktsionaalsuse rikkuda. Redigeerige ainult siis, kui teate, mida teete!",
  "Clear Editor": "Selge toimetaja",
  "Clear Editor Notify": "Kas olete kindel, et soovite toimetaja tühjendada? Kõik edusammud kaovad!",
  "Nothing to edit": "Pole midagi redigeerida!",
  "Shapes": "Kujundid",
  "Delete The Shape": "Kustuta kuju",
  "Add shapes": "Lisage paigutuste vahel kuju ja kohandage!",
  "Preview unavailable": "Komponendi eelvaade on komponendi jaoks saadaval",
  ...
  "Height": "Kõrgus",
  "Font Family": "Fondiperekond",
  "Select Font": "Valige font",
  "Font Weight": "Fondi kaal",
  "Font Size": "Fondi suurus",
  "Text Alignment": "Teksti joondamine",
  "Left Alignment": "Vasak joondamine",
  "Center Alignment": "Keskpunkti joondamine",
  "Right Alignment": "Õige joondamine",
  "Text Decoration": "Tekstide kaunistamine",
  "Overline": "Üleliinimine",
  "Line Through": "Läbi joondama",
  "Underline": "Rõhutama",
  "Underline and Overline": "Alla joonda ja ülejoon",
  "Without Decoration": "Ilma dekoratsioonita",
  "Left": "Vasakul",
  "Angle": "Nurk",
  "Distance": "Kaugus",
  "Blur": "Hägusus",
  "Size": "Suurus",
  "Edit individually": "Redigeerige individuaalselt",
  "Apply to all corners": "Kandke kõigisse nurkadesse",
  "Date Box Visual": "Kuupäevakasti visuaal",
  "One Line": "Üks rida",
  "Show Icons": "Näita ikoone",
  "Design Settings": "Disainiseaded",
  "Personalize your editor to match your style and preferences, customize every detail in this settings tab !": "Isikupärastage oma stiili ja eelistustega oma toimetaja, kohandage vahekaardil Selle seadete kõiki detaile!",
  "Divider": "Jagaja",
  "Ellipse": "Ellipse",
  "Rhombus": "Romb",
  "Heart": "Süda",
